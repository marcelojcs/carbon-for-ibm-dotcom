 ...
 */ let g,
  ...
  P = (function (e) {
    return (
      (e.DEFAULT = 'double-curved'),
      (e.SINGLE_CURVED = 'single-curved'),
      (e.SINGLE_ANGLE = 'single-angle'),
      (e.DOUBLE_ANGLE = 'double-angle'),
      (e.LOW_HIGH_REVERSED_DOUBLE_CURVED = 'low-high-reversed-double-curved'),
      (e.CORNER_BRACKET = 'corner-bracket'),
      e
    );
  })({}),
  D = (function (e) {
  ...
  var e = {
    ...
    initializeClassElements: function (e, o) {
      ...
      ['method', 'field'].forEach(function (r) {
        o.forEach(function (o) {
          var i = o.placement;
          if (o.kind === r && ('static' === i || 'prototype' === i)) {
            var n = 'static' === i ? e : t;
            this.defineClassElement(n, o);
          }
        }, this);
      }, this);
    },
    ...
    decorateClass: function (e, o) {
      ...
      if (
        ...
        e.forEach(function (e) {
          if (!O(e)) return t.push(e);
          var o = this.decorateElement(e, i);
          t.push(o.element),
      ...
      var n = this.decorateConstructor(t, o);
    ...
    decorateElement: function (e, o) {
      for (
        var t = [], r = [], i = e.decorators, n = i.length - 1;
        n >= 0;
        n--
      ) {
        var s = o[e.placement];
        ...
        var c = this.fromElementDescriptor(e),
          d = this.toElementFinisherExtras((0, i[n])(c) || c);
        (e = d.element),
    ...
    decorateConstructor: function (e, o) {
      for (var t = [], r = o.length - 1; r >= 0; r--) {
        var i = this.fromClassDescriptor(e),
          n = this.toClassDescriptor((0, o[r])(i) || i);
        if (
          (void 0 !== n.finisher && t.push(n.finisher), void 0 !== n.elements)
        ) {
          e = n.elements;
          for (var s = 0; s < e.length - 1; s++)
            for (var c = s + 1; c < e.length; c++)
              if (e[s].key === e[c].key && e[s].placement === e[c].placement)
...
const { prefix: L, stablePrefix: M } = r,
  N = {
...
let U,
  G = (function (e, o, t, r) {
      ...
      c = i.decorateClass(
        (function (e) {
          for (
            ...
            var i,
              n = e[r];
            if ('method' === n.kind && (i = o.find(t)))
              if (F(n.descriptor) || F(i.descriptor)) {
                if (O(n) || O(i))
    ...
    return (
      i.initializeClassElements(s.F, c.elements),
      i.runClassFinishers(s.F, c.finishers)
    );
  })(
    [c(`${M}-quote`)],
    function (e, r) {
      ...
      return {
        ...
        d: [
          {
            kind: 'field',
            decorators: [o({ reflect: !0, attribute: 'mark-type' })],
            key: 'markType',
            value: () => P.DEFAULT,
          },
          {
            kind: 'field',
            decorators: [o({ reflect: !0, attribute: 'lang' })],
            key: 'lc',
            value: void 0,
          },
          {
            kind: 'field',
            decorators: [o({ reflect: !0, attribute: 'appearance' })],
            key: 'appearance',
            value: () => D.DEFAULT,
          },
          { kind: 'field', key: '_hasSourceHeading', value: () => !1 },
          { kind: 'field', key: '_hasSourceCopy', value: () => !1 },
          { kind: 'field', key: '_hasSourceBottomCopy', value: () => !1 },
          { kind: 'field', key: '_hasFooter', value: () => !1 },
          {
            kind: 'field',
            decorators: [n()],
            key: '_isMobile',
          ...
          },
          {
            ...
            value: function () {
              !(function (e, o, t, r) {
                var i = I(B(1 & r ? e.prototype : e), o, t);
          ...
          },
          {
            ...
            value: function () {
              switch (this.markType) {
                case P.SINGLE_CURVED:
                  return { open: '‘', close: '’' };
                case P.DOUBLE_ANGLE:
                  return { open: '«', close: '»' };
                case P.SINGLE_ANGLE:
                  return { open: '‹', close: '›' };
                case P.LOW_HIGH_REVERSED_DOUBLE_CURVED:
                  return { open: '„', close: '“' };
                case P.CORNER_BRACKET:
                  return { open: '「', close: '」' };
                case P.DEFAULT:
                default:
                  return {
          ...
          `),
                ...
                'bubble-quote' === this.appearance
              ) {
                const e = this._getQuoteMarks();
                return t(
                  w ||
                    (w = C`
        <span class="${0}--quote__mark" part="mark mark--opening">
      ...
      `),
              ...
              `)
                  ...
                  L,
                  e.close,
                  this._isMobile && 'card' == this.appearance
                    ? t(
                        _ || (_ = C` ${0} ${0} `),
                        this._renderSource(),
                        this._renderFooter()
    ...
    `),
          ...
          },
          {
            ...
            key: '_renderFooter',
            value: function () {
              const { _hasFooter: e, _handleSlotChange: o } = this;
              return t(
                E ||
                  (E = C`
      <div
      ...
      (function (e) {
        for (
          ...
          var i,
            n = e[r];
          if ('method' === n.kind && (i = o.find(t)))
            if (W(n.descriptor) || W(i.descriptor)) {
              if (K(n) || K(i))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
  ...
  function (e, r) {
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [o({ reflect: !0 })],
          key: 'slot',
          value: () => 'source-bottom-copy',
        },
        {
          kind: 'method',
          key: 'render',
          value: function () {
            return t(U || (U = H` <slot></slot> `));
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => v },
      ],
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return le(e, o);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
      ...
      (function (e) {
        for (
          ...
          var i,
            n = e[r];
          if ('method' === n.kind && (i = o.find(t)))
            if (ce(n.descriptor) || ce(i.descriptor)) {
              if (se(n) || se(i))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return we(e, o);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
      ...
      (function (e) {
        for (
          ...
          var i,
            n = e[r];
          if ('method' === n.kind && (i = o.find(t)))
            if (be(n.descriptor) || be(i.descriptor)) {
              if (fe(n) || fe(i))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return Te(e, o);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
  ...
  return (
    (Oe =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, o, t) {
            var r = (function (e, o) {
              for (; !{}.hasOwnProperty.call(e, o) && null !== (e = Fe(e)); );
              return e;
            })(e, o);
            if (r) {
              var i = Object.getOwnPropertyDescriptor(r, o);
...
!(function (e, o, t, r) {
  ...
  function (o, t) {
      ...
      d: [
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${je}--quote-link-with-icon`;
          },
        },
        {
          kind: 'get',
    ...
    `),
              (function (e, o, t, r) {
                var i = Oe(Fe(1 & r ? e.prototype : e), o, t);
                return 2 & r && 'function' == typeof i
                  ? function (e) {
                      return i.apply(t, e);
                    }
