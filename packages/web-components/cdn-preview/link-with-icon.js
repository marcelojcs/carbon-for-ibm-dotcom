  ...
  var o = {
    ...
    initializeClassElements: function (o, e) {
      ...
      ['method', 'field'].forEach(function (c) {
        e.forEach(function (e) {
          var s = e.placement;
          if (e.kind === c && ('static' === s || 'prototype' === s)) {
            var d = 'static' === s ? o : t;
    ...
    defineClassElement: function (o, e) {
      ...
      if ('field' === e.kind) {
        ...
        t = {
          ...
          value: void 0 === c ? void 0 : c.call(o),
        };
      }
    ...
    decorateClass: function (o, e) {
      ...
      if (
        (o.forEach(function (o) {
          this.addElementPlacement(o, s);
        }, this),
        o.forEach(function (o) {
          if (!y(o)) return t.push(o);
          var e = this.decorateElement(o, s);
          t.push(e.element),
            t.push.apply(t, e.extras),
            c.push.apply(c, e.finishers);
        }, this),
        !e)
      )
        return { elements: t, finishers: c };
      var d = this.decorateConstructor(t, e);
      return c.push.apply(c, d.finishers), (d.finishers = c), d;
    },
    addElementPlacement: function (o, e, t) {
      var c = e[o.placement];
      if (!t && -1 !== c.indexOf(o.key))
        throw new TypeError('Duplicated element (' + o.key + ')');
      c.push(o.key);
    },
    decorateElement: function (o, e) {
      for (
        var t = [], c = [], s = o.decorators, d = s.length - 1;
        d >= 0;
        d--
      ) {
        var n = e[o.placement];
        n.splice(n.indexOf(o.key), 1);
        var i = this.fromElementDescriptor(o),
          r = this.toElementFinisherExtras((0, s[d])(i) || i);
        (o = r.element),
          this.addElementPlacement(o, e),
          r.finisher && c.push(r.finisher);
        var a = r.extras;
        if (a) {
          for (var l = 0; l < a.length; l++) this.addElementPlacement(a[l], e);
          t.push.apply(t, a);
        }
      }
      return { element: o, finishers: c, extras: t };
    },
    decorateConstructor: function (o, e) {
      for (var t = [], c = e.length - 1; c >= 0; c--) {
        var s = this.fromClassDescriptor(o),
          d = this.toClassDescriptor((0, e[c])(s) || s);
        if (
          ...
          for (var n = 0; n < o.length - 1; n++)
            for (var i = n + 1; i < o.length; i++)
              if (o[n].key === o[i].key && o[n].placement === o[i].placement)
                throw new TypeError('Duplicated element (' + o[n].key + ')');
        }
      }
...
function b(o) {
  ...
  return (
    o.decorators && (c.decorators = o.decorators),
    'field' === o.kind && (c.initializer = o.value),
    c
  );
}
function f(o, e) {
...
function w(o, e) {
  ...
  for (var t = 0, c = Array(e); t < e; t++) c[t] = o[t];
  return c;
}
function z() {
  return (
    (z =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (o, e, t) {
            var c = (function (o, e) {
              for (; !{}.hasOwnProperty.call(o, e) && null !== (o = E(o)); );
              return o;
            })(o, e);
            if (c) {
              var s = Object.getOwnPropertyDescriptor(c, e);
              return s.get ? s.get.call(arguments.length < 3 ? o : t) : s.value;
            }
          }),
...
const { prefix: C, stablePrefix: P } = c;
let T = (function (o, e, t, c) {
  var s = h();
  if (c) for (var d = 0; d < c.length; d++) s = c[d](s);
  var n = e(function (o) {
      s.initializeInstanceElements(o, i.elements);
    }, t),
    i = s.decorateClass(
      (function (o) {
        for (
          ...
          var s,
            d = o[c];
          if ('method' === d.kind && (s = e.find(t)))
            if (k(d.descriptor) || k(s.descriptor)) {
              if (y(d) || y(s))
                throw new ReferenceError(
                  'Duplicated methods (' + d.key + ") can't be decorated."
                );
              s.descriptor = d.descriptor;
            } else {
              if (y(d)) {
                if (y(s))
                  throw new ReferenceError(
  ...
  return (
    s.initializeClassElements(n.F, i.elements),
    s.runClassFinishers(n.F, i.finishers)
  );
})(
  [r(`${P}-link-with-icon`)],
  function (o, c) {
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [e({ attribute: 'icon-placement', reflect: !0 })],
          key: 'iconPlacement',
          value: () => n.RIGHT,
        },
        {
          kind: 'field',
          decorators: [e({ type: Boolean })],
          key: 'iconInline',
          value: () => !0,
        },
        { kind: 'field', decorators: [e()], key: 'size', value: () => 'lg' },
        {
          kind: 'field',
          decorators: [s()],
          key: '_hasContent',
        ...
        },
        {
          ...
          value: function ({ target: o }) {
            this._hasContent = o.assignedNodes().some((o) => {
              var e;
              return (
                o.nodeType !== Node.COMMENT_NODE &&
                (o.nodeType !== Node.TEXT_NODE ||
                  (null === (e = o.nodeValue) || void 0 === e
                    ? void 0
                    : e.trim()))
              );
            });
        ...
        },
        {
          ...
          key: '_renderContent',
          value: function () {
            const { ctaType: o, _hasContent: e } = this;
            if (o !== l.VIDEO)
              return t(m || (m = u`<span part="span"><slot></slot></span>`));
            const {
                videoDuration: c,
                videoName: s,
                formatVideoCaption: d,
                formatVideoDuration: n,
              } = this,
              i = e
                ? void 0
                : d({ duration: n({ duration: c ? 1e3 * c : c }), name: s });
            return t(
              v ||
                (v = u`
      <span
    ...
    `),
        ...
        },
        {
          ...
          value: function (o) {
            !(function (o, e, t, c) {
              var s = z(E(1 & c ? o.prototype : o), e, t);
              return 2 & c && 'function' == typeof s
                ? function (o) {
                    return s.apply(t, o);
                  }
                : s;
            ...
            const { iconInline: e, iconPlacement: t, _linkNode: c } = this;
            c &&
              (c.classList.add(`${C}--link-with-icon`),
              c.classList.toggle(
                `${C}--link-with-icon__icon-${n.LEFT}`,
                t === n.LEFT
              ),
              c.classList.toggle(
                `${C}--link-with-icon__icon-${n.RIGHT}`,
                t === n.RIGHT
              ),
              e &&
                t === n.RIGHT &&
                c.classList.add(`${C}--link-with-icon--inline-icon`));
          },
        },
        {
          kind: 'get',
