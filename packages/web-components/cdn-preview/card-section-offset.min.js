...
import { i as c, x as e, s as d } from './query-assigned-elements.js';
    ...
    toElementDescriptors: function (c) {
      if (void 0 !== c)
        ...
        (function (c) {
          ...
          (function (c, e) {
            if (c) {
              if ('string' == typeof c) return b(c, e);
...
const { prefix: k, stablePrefix: _ } = d;
!(function (c, e, d, t) {
  var s = l();
      ...
      (function (c) {
        for (
          ...
          if ('method' === o.kind && (s = e.find(d)))
            if (m(o.descriptor) || m(s.descriptor)) {
              if (h(o) || h(s))
  ...
  function (d, t) {
    ...
    return {
      ...
      d: [
        {
          kind: 'method',
          key: '_handleSlotChangeCardGroup',
          value: function (c) {
            c.target.assignedNodes().filter((c) => {
              if (
                c.matches(this.constructor.cardGroupSelector) &&
                3 === c.querySelectorAll(`${_}-card-group-item`).length
              ) {
                var e;
                const c = document.createElement(`${_}-card-group-item`);
                return (
                  c.setAttribute('empty', ''),
                  null === (e = this.querySelector(`${_}-card-group`)) ||
                    void 0 === e ||
                    e.prepend(c),
                  !0
                );
              }
              return (this.querySelector(`${_}-card-group`).innerHTML = ''), !1;
            });
          },
        },
        {
    ...
    `),
              k,
              this._renderHeading(),
              this._handleSlotChangeCardGroup
            );
          },
        },
        {
