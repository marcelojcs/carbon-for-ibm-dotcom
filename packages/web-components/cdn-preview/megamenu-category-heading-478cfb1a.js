...
let process = { env: {} };
import { h as C4DMegaMenuHeading, j as svgResultCarbonIcon, k as svgResultCarbonIcon$1, n, s as styles, c as carbonElement, a as settings } from './index-5becb925.js';
 ...
 */
let C4DMegaMenuCategoryHeading = _decorate([carbonElement(`${c4dPrefix}-megamenu-category-heading`)], function (_initialize, _C4DMegaMenuHeading) {
  class C4DMegaMenuCategoryHeading extends _C4DMegaMenuHeading {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
  ...
  return {
    F: C4DMegaMenuCategoryHeading,
    d: [{
      kind: "get",
      key: "_arrowIcon",
      value: function () {
        const isRTL = document.dir.toLowerCase() === 'rtl';
        return isRTL ? svgResultCarbonIcon({
          part: 'l0-arrow-cat-heading'
        }) : svgResultCarbonIcon$1({
          part: 'l0-arrow-cat-heading'
        });
      }
    }, {
...
export { C4DMegaMenuCategoryHeading as default };
