...
let o, t, e, s, n;
import { _ as c } from './objectSpread2.js';
import { _ as d } from './decorate.js';
import { o as r } from './class-map.js';
import { l as i } from './if-defined.js';
import { i as a, n as p, x as l, a as b } from './query-assigned-elements.js';
import { p as v } from './settings.js';
import { F as h } from './focus.js';
import { H as u } from './host-listener.js';
 ...
 */ !(function (o) {
  (o.PRIMARY = 'primary'),
    ...
    (o.GHOST = 'ghost'),
    (o.DANGER = 'danger'),
    (o.DANGER_PRIMARY = 'danger-primary'),
    (o.DANGER_TERTIARY = 'danger-tertiary'),
    (o.DANGER_GHOST = 'danger-ghost');
})(o || (o = {})),
  (function (o) {
  ...
  (function (o) {
    (o.SMALL = 'sm'),
      ...
      (o.LARGE = 'lg'),
      (o.EXTRA_LARGE = 'xl'),
      (o.EXTRA_EXTRA_LARGE = '2xl');
  })(e || (e = {})),
  (function (o) {
    (o.START = 'left'), (o.CENTER = ''), (o.END = 'right');
  })(s || (s = {})),
  (function (o) {
    (o.TOP = 'top'),
      (o.RIGHT = 'right'),
      ...
      return {
        ...
        d: [
          { kind: 'field', key: '_hasIcon', value: () => !1 },
          {
            ...
            value: function ({ target: o }) {
              ...
              (this['icon' === t ? '_hasIcon' : 'hasMainContent'] = e),
                this.requestUpdate();
            },
          },
          {
            kind: 'method',
            decorators: [u('click', { capture: !0 })],
          ...
          {
            kind: 'field',
            decorators: [p({ type: Boolean, reflect: !0 })],
            key: 'autofocus',
            value: () => !1,
          },
          {
            kind: 'field',
            decorators: [
              p({ type: Boolean, reflect: !0, attribute: 'batch-action' }),
            ],
            key: 'batchAction',
            value: () => !1,
          },
          {
            kind: 'field',
            decorators: [p({ reflect: !0, attribute: 'button-class-name' })],
            key: 'buttonClassName',
            value: void 0,
          },
          {
            kind: 'field',
            decorators: [p({ reflect: !0, attribute: 'danger-descriptor' })],
          ...
          },
          {
            kind: 'field',
            decorators: [
              p({ reflect: !0, attribute: 'has-main-content', type: Boolean }),
            ],
            key: 'hasMainContent',
            value: () => !1,
          },
          ...
          {
            kind: 'field',
            decorators: [p({ attribute: 'link-role' })],
            key: 'linkRole',
            value: () => 'button',
          },
          {
            kind: 'field',
            decorators: [p({ type: Boolean })],
            key: 'openTooltip',
            value: () => !1,
          },
          {
          ...
          {
            kind: 'field',
            decorators: [p({ reflect: !0, attribute: 'tooltip-alignment' })],
            key: 'tooltipAlignment',
            value: () => s.CENTER,
          },
          {
            kind: 'field',
            decorators: [p({ reflect: !0, attribute: 'tooltip-position' })],
            key: 'tooltipPosition',
            value: () => n.TOP,
          },
          {
            kind: 'field',
            decorators: [p({ reflect: !0, attribute: 'tooltip-text' })],
            key: 'tooltipText',
            value: void 0,
          },
          {
        ...
        `),
                    ...
                    C
                      ? l(
                          _ ||
                            (_ = w`<span class="${0}--visually-hidden"
                  >${0}</span
                >`),
                          v,
                          e
          ...
          },
          {
            ...
            value: () =>
              c(c({}, b.shadowRootOptions), {}, { delegatesFocus: !0 }),
          },
