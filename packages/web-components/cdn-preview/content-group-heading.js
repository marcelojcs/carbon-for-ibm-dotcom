      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            ...
            (e.innerHTML = `<h3>${this.innerHTML.trim()}</h3>`),
              (this.innerHTML = '');
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${w}--content-group__heading`;
          },
        },
