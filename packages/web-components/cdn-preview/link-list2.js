...
import { n as t, x as r, s as i, a as n } from './query-assigned-elements.js';
import { t as o } from './state.js';
import { S as s } from './stable-selector.js';
import { s as l } from './link-list.js';
 ...
 */ let c,
  ...
  f = (function (e) {
    return (e.DEFAULT = 'default'), (e.END = 'end'), e;
  })({}),
  p = (e) => e;
function u() {
  u = function () {
      ...
      for (var r = [], i = t.length - 1; i >= 0; i--) {
        ...
        if (
          ...
          for (var s = 0; s < e.length - 1; s++)
            for (var l = s + 1; l < e.length; l++)
              if (e[s].key === e[l].key && e[s].placement === e[l].placement)
  ...
  return (
    (g =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, t, r) {
            var i = (function (e, t) {
              for (; !{}.hasOwnProperty.call(e, t) && null !== (e = w(e)); );
              return e;
            })(e, t);
            if (i) {
...
const { stablePrefix: _ } = i;
let T = (function (e) {
  return (
    (e.DEFAULT = 'default'),
    (e.TWO_COLUMNS = 'two-columns'),
    (e.THREE_COLUMNS = 'three-columns'),
    e
  );
})({});
!(function (e, t, r, i) {
  ...
  n.initializeClassElements(s.F, l.elements),
    n.runClassFinishers(s.F, l.finishers);
})(
  [a(`${_}-link-list`)],
  function (i, n) {
    class s extends n {
      ...
      d: [
        ...
        },
        {
          ...
          value: function (e) {
            ...
            (this._childItems = e.target
              .assignedNodes({ flatten: !0 })
              .filter(
                (e) =>
                  e.nodeType === Node.ELEMENT_NODE &&
                  (null == e ? void 0 : e.matches(t))
              )),
              this._childItems.length > 3
                ? this._childItems.length < 7
                  ? (this._endTypeLayout = T.TWO_COLUMNS)
                  : (this._endTypeLayout = T.THREE_COLUMNS)
                : (this._endTypeLayout = T.DEFAULT),
              this.type === d.END &&
        ...
        },
        {
          ...
          value: function () {
            !(function (e, t, r, i) {
              var n = g(w(1 & i ? e.prototype : e), t, r);
        ...
        },
        {
          ...
          key: 'render',
          value: function () {
            const { type: t, _endTypeLayout: i } = this,
              n = e({
                [`${_}-ce--link-list__heading__wrapper`]: !0,
                [`${_}-ce--link-list__heading--split`]:
                  t === d.END && i === T.TWO_COLUMNS,
              }),
              o = {
                [d.HORIZONTAL]: `${_}--link-list__list--horizontal`,
                [d.VERTICAL]: `${_}--link-list__list--vertical`,
                [d.END]: `${_}-ce--link-list__list--end`,
                [d.DEFAULT]: `${_}--link-list__list`,
              }[t],
              s = e({
                [o]: !0,
                [`${_}-ce--link-list__list--split`]:
                  t === d.END && i === T.TWO_COLUMNS,
                [`${_}-ce--link-list__list--three-columns`]:
                  t === d.END && i === T.THREE_COLUMNS,
              });
            return r(
              c ||
                (c = p`
    ...
    `),
        ...
        },
        {
          ...
          key: 'updated',
          value: function () {
            (this.type !== d.HORIZONTAL && this.type !== d.VERTICAL) ||
              this._childItems.forEach((e) => {
                e.iconInline = !0;
              });
          },
        },
        {
          ...
          key: 'selectorItem',
          value: function () {
            return `${_}-link-list-item, ${_}-link-list-item-cta`;
          },
        },
        {
          kind: 'get',
