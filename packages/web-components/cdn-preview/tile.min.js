...
import { o as c } from './class-map.js';
import { c as d } from './carbon-element.js';
import { l as a } from './if-defined.js';
import { C as l } from './cta.js';
import { V as p } from './video.js';
import { C as v } from './formatVideoCaption.js';
import './directive.js';
import './spread.js';
import './20.js';
  ...
  var e = {
    ...
    initializeClassElements: function (e, o) {
      ...
      ['method', 'field'].forEach(function (r) {
        o.forEach(function (o) {
          var s = o.placement;
          if (o.kind === r && ('static' === s || 'prototype' === s)) {
            var n = 'static' === s ? e : t;
    ...
    decorateClass: function (e, o) {
      ...
      if (
        ...
        e.forEach(function (e) {
          ...
          var o = this.decorateElement(e, s);
          t.push(o.element),
    ...
    decorateElement: function (e, o) {
      for (
        var t = [], r = [], s = e.decorators, n = s.length - 1;
        n >= 0;
        n--
      ) {
        var i = o[e.placement];
        ...
        var c = this.fromElementDescriptor(e),
          d = this.toElementFinisherExtras((0, s[n])(c) || c);
        (e = d.element),
    ...
    decorateConstructor: function (e, o) {
      for (var t = [], r = o.length - 1; r >= 0; r--) {
        var s = this.fromClassDescriptor(e),
          n = this.toClassDescriptor((0, o[r])(s) || s);
        if (
          (void 0 !== n.finisher && t.push(n.finisher), void 0 !== n.elements)
        ) {
          e = n.elements;
          for (var i = 0; i < e.length - 1; i++)
            for (var c = i + 1; c < e.length; c++)
              if (e[i].key === e[c].key && e[i].placement === e[c].placement)
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return w(e, o);
...
!(function (e, o, t, r) {
  ...
  var i = o(function (e) {
      s.initializeInstanceElements(e, c.elements);
    }, t),
    c = s.decorateClass(
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = o.find(t)))
            if (x(n.descriptor) || x(s.descriptor)) {
              if (k(n) || k(s))
  ...
  s.initializeClassElements(i.F, c.elements),
    s.runClassFinishers(i.F, c.finishers);
})(
  [d(`${E}-tile`)],
  function (e, r) {
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [o({ attribute: 'label' })],
          key: 'label',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [o({ attribute: 'cta-type', reflect: !0 })],
          key: 'ctaType',
          value: () => v.LOCAL,
        },
        {
          kind: 'field',
          decorators: [o({ attribute: 'href' })],
          key: 'href',
          value: void 0,
        },
        {
        ...
        { kind: 'field', decorators: [n()], key: 'slotName', value: () => '' },
        {
          kind: 'field',
          decorators: [n()],
          key: 'slotContent',
        ...
        },
        {
          kind: 'field',
          decorators: [
            o({ type: Boolean, reflect: !0, attribute: 'align-with-content' }),
          ],
        ...
        },
        {
          kind: 'field',
          decorators: [
            o({ type: Boolean, reflect: !0, attribute: 'double-tile' }),
          ],
          key: 'doubleTile',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [o({ attribute: 'target', reflect: !0 })],
          key: 'target',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [i(`.${E}-tile__action`)],
          key: '_linkNode',
          value: void 0,
        },
        {
          ...
          value: function (e) {
            const { target: o } = e;
            (this.slotName = o.name),
              (this.slotContent = o.assignedElements()),
              'image' === this.slotName && 1 === this.slotContent.length
                ? (this.slottedImages = !0)
                : 'image' === this.slotName &&
                  0 === this.slotContent.length &&
                  (this.slottedImages = !1),
              'pictogram' === this.slotName && 1 === this.slotContent.length
                ? (this.slottedPictogram = !0)
                : 'pictogram' === this.slotName &&
                  0 === this.slotContent.length &&
                  (this.slottedPictogram = !1);
          },
        },
        {
          kind: 'method',
          ...
          value: function () {
            const {
              ...
              p = c({
                [`${E}-tile__footer-placement`]: d,
                [`${E}-tile__action`]: !0,
              }),
              v = c({
                [`${E}-tile__image-double`]: l,
                [`${E}-tile__image`]: !0,
              });
            return t(
              h ||
