...
import { s as e } from './query-assigned-elements.js';
import { c as r } from './carbon-element.js';
import { C as t } from './card-heading.js';
import { s as i } from './card-link.js';
function n() {
  n = function () {
    return e;
  };
...
const { stablePrefix: p } = e;
!(function (e, r, t, i) {
  var c = n();
  if (i) for (var d = 0; d < i.length; d++) c = i[d](c);
  var f = r(function (e) {
      c.initializeInstanceElements(e, p.elements);
    }, t),
    p = c.decorateClass(
      (function (e) {
        for (
  ...
  c.initializeClassElements(f.F, p.elements),
    c.runClassFinishers(f.F, p.finishers);
})(
  [r(`${p}-card-link-heading`)],
  function (e, r) {
    return {
      F: class extends r {
        constructor(...r) {
