...
import { H as n } from './host-listener.js';
import { M as a } from './modal-render.js';
import { V as s, c as l, d } from './video-player-container.js';
import './expressive-modal.js';
import './expressive-modal-close-button.js';
import { s as c } from './striptags.js';
import { f as u, a as p } from './formatVideoCaption.js';
import { C as f, s as h } from './lightbox-image-viewer.js';
import { c as m } from './carbon-element.js';
var v = /\n|\s{2,}|&([a-zA-Z]+);/g;
function y(e) {
      ...
      (function (e) {
        for (
          ...
          if ('method' === n.kind && (o = t.find(r)))
            if (x(n.descriptor) || x(o.descriptor)) {
              if (D(n) || D(o))
  ...
  function (r, i) {
    ...
    `),
        ...
        },
        {
          ...
          key: '_renderTitle',
          value: function () {
            const { duration: t, formatCaption: r, name: i } = this;
            let o = '';
            if (null != t) {
              ...
              o =
                r > 0
                  ? `${r}:${String(i).padStart(2, '0')}:${String(n).padStart(
                      2,
                      '0'
                    )}`
    ...
    `),
        ...
        },
        {
          ...
          key: 'updated',
          value: function (e) {
            e.has('name') && this.setAttribute('aria-label', this.name);
          },
        },
        {
          kind: 'method',
          ...
          value: function () {
            ...
            this.setAttribute('role', 'dialog'),
              ...
              (t = 'connectedCallback'),
              (r = this),
              (n = T(_(1 & (i = 3) ? e.prototype : e), t, r)),
              2 & i && 'function' == typeof n
                ? function (e) {
                    return n.apply(r, e);
                  }
                : n)([]);
        ...
        { kind: 'field', decorators: [t()], key: 'name', value: () => '' },
      ],
    };
  },
  f
...
function U(e, t, r, i) {
  var o = W(G(1 & i ? e.prototype : e), t, r);
...
let Z = (function (e, t, r, i) {
  ...
  [m(`${X}-lightbox-video-player-composite`)],
  function (r, a) {
    class d extends a {
      constructor(...e) {
        super(...e), r(this);
    ...
    return {
      ...
      d: [
        ...
        {
          kind: 'field',
          key: '_handleAriaAndHiddenState',
          value() {
            return () => {
              const { _videoPlayer: e } = this,
                t = null == e ? void 0 : e.querySelector('iframe');
              try {
                var r, i;
                if (this.open)
                  null == t ||
                    ...
                    void 0 === r ||
                    null ===
                      (r = r.document.querySelector('.topBarContainer')) ||
                    void 0 === r ||
                  ...
                  null == t ||
                    ...
                    void 0 === i ||
                    null ===
                      (i = i.document.querySelector('.topBarContainer')) ||
                    void 0 === i ||
                    i.setAttribute('aria-hidden', 'true');
              } catch (e) {
                throw (console.log('Failed to access element in iframe'), e);
              }
              const { selectorEmbeddedVideoContainer: o } = this.constructor;
              Array.prototype.slice
                .call(null == e ? void 0 : e.querySelectorAll(o))
                .forEach((e) => {
                  e.toggleAttribute(
                    'hidden',
                    e.dataset.videoId !== this.videoId
                  );
                });
            };
          },
        },
        {
          ...
          value() {
            return () => {
              const { embeddedVideos: e = {}, videoId: t } = this,
                { [t]: r } = e;
              if ((r && r.pause(), this.ctaElement)) {
                const e = document.querySelector(
                  `c4d-video-player-container-v7[video-id="${t}"]`
                );
                e && 'function' == typeof e._returnCTA && e._returnCTA(),
                  (this.ctaElement = null);
              }
              (this.open = !1), this._handleAriaAndHiddenState();
            };
          },
        },
        {
        ...
        {
          kind: 'field',
          decorators: [n('document:eventContentStateChange')],
          ...
          value() {
            return (e) => {
              const {
                ...
                videoId: i,
                name: o,
                customVideoDescription: n,
                ctaElement: a,
              } = e.detail;
              if (!1 === this.videoCtaLightBox) {
                this.videoId = i;
                const { videoId: e } = this;
                t === s.VIDEO &&
                  e === i &&
                  r === l.LIGHTBOX &&
                  ((this.customVideoName = o),
                  (this.customVideoDescription = n),
                  (this.ctaElement = a),
                  (this.open = !0));
              }
            };
        ...
        },
        {
          ...
          value: function () {
            var e, t;
            const { selectorVideoPlayer: r } = this.constructor;
            return null === (e = this.modalRenderRoot) ||
              void 0 === e ||
        ...
        {
          kind: 'field',
          decorators: [t({ attribute: 'custom-video-name' })],
          key: 'customVideoName',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'custom-video-description' })],
          key: 'customVideoDescription',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [t({ type: Boolean, attribute: 'video-cta-lightbox' })],
          key: 'videoCtaLightBox',
          value: () => !1,
        },
        {
          kind: 'field',
        ...
        },
        {
          ...
          value: function () {
            this._hCloseModal &&
              ...
              U(d, 'disconnectedCallback', this, 3)([]);
          },
        },
        {
          kind: 'method',
          key: 'updated',
          value: function (e) {
            if (e.has('open') || e.has('videoId')) {
              const { open: e, videoId: i } = this;
              var t, r;
              if ((this._activateEmbeddedVideo(e ? i : ''), i))
                if (
                  ...
                  null === (r = this._embedMedia) ||
                    ...
                    this.ctaElement &&
                      requestAnimationFrame(() => {
                        var e;
                        const t =
                          null === (e = this.modalRenderRoot) || void 0 === e
                            ? void 0
                            : e.querySelector('c4d-lightbox-video-player');
                        t &&
                          this.ctaElement &&
                          (this.ctaElement.setAttribute('slot', 'cta'),
                          t.appendChild(this.ctaElement));
                      });
            }
          },
        },
        ...
        },
        {
          ...
          value: function () {
            const {
              ...
              { [l]: c = {} } = s,
              { description: u, duration: p, name: f } = c,
              h = i || f;
            return e(
              I ||
                (I = M`
    ...
    `),
        ...
        },
        {
          ...
          value: function () {
            return `${X}-lightbox-video-player`;
          },
        },
        {
          kind: 'get',
          ...
          key: 'eventCloseModal',
          value: function () {
            return `${X}-expressive-modal-closed`;
          },
        },
        {
          kind: 'get',
          static: !0,
          key: 'selectorEmbeddedVideoContainer',
          value: function () {
