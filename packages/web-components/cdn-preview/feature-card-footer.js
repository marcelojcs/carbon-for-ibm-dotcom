...
import { C as r } from './card-footer.js';
import { s as i } from './feature-card.js';
function n() {
  n = function () {
    return e;
  };
...
const { prefix: m, stablePrefix: h } = e;
let y = (function (e, t, r, i) {
  var c = n();
  if (i) for (var f = 0; f < i.length; f++) c = i[f](c);
  var d = t(function (e) {
  ...
  return (
    ...
    c.runClassFinishers(d.F, p.finishers)
  );
})(
  [t(`${h}-feature-card-footer`)],
  function (e, t) {
    class r extends t {
      constructor(...t) {
        super(...t), e(this);
      ...
      d: [
        {
          ...
          value: function (e) {
            ...
            (i = 'updated'),
            (n = this),
            (s = p(u(1 & (o = 3) ? t.prototype : t), i, n)),
            2 & o && 'function' == typeof s
              ? function (e) {
                  return s.apply(n, e);
                }
              : s)([e]);
            const { _linkNode: a } = this;
            a && a.classList.remove(`${m}--link-with-icon`);
          },
        },
