...
import { s as a } from './content-item2.js';
...
const { prefix: _, stablePrefix: S } = r,
  P = { media: '_hasMedia', statistic: '_hasStatistic', footer: '_hasFooter' };
let C = (function (e, t, r, i) {
  ...
  function (r, i) {
    return {
      ...
      d: [
        { kind: 'field', decorators: [o()], key: '_hasLogo', value: () => !1 },
        { kind: 'field', decorators: [o()], key: '_hasMedia', value: () => !1 },
        {
          kind: 'field',
          decorators: [o()],
          key: '_hasPictogram',
        ...
        },
        {
          ...
          value: function ({ target: e }) {
            ...
            if (
              ((this[P[i] || '_hasStatistic'] = n),
              null !== (t = e.assignedNodes()[0]) &&
              void 0 !== t &&
              null !== (r = t.matches) &&
              void 0 !== r &&
              r.call(t, this.constructor.selectorImageLogo)
                ? (this._hasLogo = !0)
                : (this._hasLogo = !1),
        ...
        },
        {
          ...
          value: function () {
            const { _hasStatistic: e, _handleSlotChange: r } = this;
            return t(
              c ||
                (c = p`
      <div
    ...
    `),
        ...
        },
        {
          ...
          key: '_renderMedia',
          value: function () {
            const { _hasMedia: e, _handleSlotChange: r } = this;
            return t(
              d ||
                (d = p`
      <div
    ...
    `),
        ...
        },
        {
          ...
          value: function () {
            var e, t;
            this._hasFooter
              ? null === (e = this.querySelector(`${S}-content-item-copy`)) ||
                void 0 === e ||
                e.setAttribute('has-cta', '')
              : null === (t = this.querySelector(`${S}-content-item-copy`)) ||
                void 0 === t ||
                t.removeAttribute('has-cta');
          },
        },
        {
          kind: 'method',
          key: 'render',
          value: function () {
            const { horizontal: e, _hasStatistic: r, _hasLogo: i } = this,
              o = n({ [`${S}--content-item__horizontal`]: e && !r && !i });
            return t(
              h ||
                (h = p`
    ...
    `),
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${S}--content-item`;
          },
        },
        {
          kind: 'get',
          static: !0,
          key: 'selectorImageLogo',
          value: function () {
            return `${S}-image-logo`;
          },
        },
