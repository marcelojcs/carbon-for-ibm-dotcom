...
const { prefix: T, stablePrefix: C } = c;
  ...
  function (e, l) {
      ...
      d: [
        {
          kind: 'field',
          decorators: [
            t({ type: String, attribute: 'aria-hidden', reflect: !0 }),
          ],
          key: 'ariaHidden',
          value: () => 'true',
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'back-button-text' })],
          key: 'backButtonText',
          value: () => 'Back',
        },
        {
        ...
        {
          kind: 'field',
          decorators: [t({ type: String, attribute: 'section-id' })],
          key: 'sectionId',
          value: () => '',
        },
        {
        ...
        {
          kind: 'field',
          decorators: [t({ type: Boolean, attribute: 'is-submenu' })],
          key: 'isSubmenu',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [
            t({ type: Boolean, reflect: !0, attribute: 'show-back-button' }),
          ],
          key: 'showBackBtn',
          value: () => !1,
        },
        { kind: 'field', decorators: [t()], key: 'title', value: () => '' },
        { kind: 'field', decorators: [t()], key: 'titleUrl', value: () => '' },
        {
          kind: 'method',
          ...
          value: async function (e) {
            if (
              ...
              if (e) {
                ...
                else e = this.getRootNode().querySelector(i.selectorNavItems);
                e &&
    ...
    `),
        ...
        },
        {
          ...
          key: 'eventToggle',
          value: function () {
            return `${C}-left-nav-menu-toggled`;
          },
        },
        {
          kind: 'get',
        ...
        },
        {
          ...
          value: function () {
            return [s, `${C}-left-nav-menu`, `${C}-left-nav-menu-item`].join(
              ','
            );
          },
        },
