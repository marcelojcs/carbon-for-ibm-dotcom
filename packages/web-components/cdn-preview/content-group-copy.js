...
import { x as e, s as t, a as r, n as i } from './query-assigned-elements.js';
import { S as n } from './stable-selector.js';
import { C as o } from './markdown.js';
import { s } from './content-group2.js';
...
function C(e, t, r, i) {
  var n = x(O(1 & i ? e.prototype : e), t, r);
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${b}--content-group-paragraph`;
          },
        },
      ...
      d: [
        {
          ...
          key: '_customTags',
          value: function () {
            const e = new Set(C(r, '_customTags', this, 1));
            return e.add(`${j}-content-group-paragraph`), e;
          },
        },
        {
          kind: 'get',
          key: '_renderer',
          value: function () {
            return Object.assign(C(r, '_renderer', this, 1), {
              paragraph: (e) =>
                `<${j}-content-group-paragraph part="paragraph">${e}</${j}-content-group-paragraph>`,
            });
          },
        },
        {
          ...
          value: function () {
            this.childNodes.forEach((e) => {
              e.nodeType === Node.TEXT_NODE && this.removeChild(e);
            });
          },
        },
        {
