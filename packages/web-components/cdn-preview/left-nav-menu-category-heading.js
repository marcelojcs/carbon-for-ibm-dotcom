...
import { a as e, n as t, x as r, s as i } from './query-assigned-elements.js';
import { t as o } from './state.js';
import { o as n } from './class-map.js';
import { s, a } from './20.js';
import { c as l } from './carbon-element.js';
import { s as c } from './masthead-container.js';
import './directive.js';
import './spread.js';
import './pickBy.js';
import './toNumber.js';
...
const { prefix: w, stablePrefix: E } = i;
let P = (function (e, t, r, i) {
  ...
  [l(`${E}-left-nav-menu-category-heading`)],
  function (e, i) {
    return {
      F: class extends i {
        constructor(...t) {
      ...
      d: [
        {
          kind: 'field',
          decorators: [t({ attribute: 'title' })],
          key: 'headingText',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'url' })],
          key: 'url',
          value: void 0,
        },
        { kind: 'field', decorators: [o()], key: 'boostSize', value: void 0 },
        {
          kind: 'method',
          key: 'updated',
          value: function (e) {
            e.has('boostSize') &&
              this.classList.toggle(
                `${w}--left-nav-menu-category__heading-large`,
                this.boostSize
              );
          },
        },
        {
          ...
          key: '_renderHeading',
          value: function () {
            const { headingText: e, url: t } = this,
              i = 'rtl' === document.dir.toLowerCase(),
              o = {
                [`${w}--side-nav__menu-section-title`]: this.boostSize || !1,
                [`${w}--side-nav__heading-title`]: !t,
              };
            return t
              ? r(
                  d ||
