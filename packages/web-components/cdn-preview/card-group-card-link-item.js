...
import { n as e, s as r } from './query-assigned-elements.js';
import { c as t } from './carbon-element.js';
import { C as i } from './card-link-cta.js';
import { s as n } from './card-group-item.js';
function o() {
  o = function () {
    return e;
  };
...
const { stablePrefix: u } = r;
!(function (e, r, t, i) {
  var n = o();
  if (i) for (var d = 0; d < i.length; d++) n = i[d](n);
  var f = r(function (e) {
  ...
  n.initializeClassElements(f.F, p.elements),
    n.runClassFinishers(f.F, p.finishers);
})(
  [t(`${u}-card-group-card-link-item`)],
  function (r, t) {
    return {
      F: class extends t {
        constructor(...e) {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${u}--card-group-card-link-item`;
          },
        },
        {
          kind: 'get',
  ...
  console.warn(
    'The card-group-card-link-item component has been deprecated in favor of default card or with content-item. See card-group documentation for more information.'
  );
