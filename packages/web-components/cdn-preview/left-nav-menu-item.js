...
import { a as t, n as r, x as i, s as n } from './query-assigned-elements.js';
import { e as o, s, f as a, g as l } from './masthead-container.js';
import { _ as c } from './objectSpread2.js';
import { _ as d } from './decorate.js';
import { _ as p, a as f } from './get.js';
import { p as u } from './settings.js';
import { F as m } from './focus.js';
import { c as h } from './carbon-element.js';
import './directive.js';
import './pickBy.js';
import './toNumber.js';
import './store.js';
  ...
  w = d(
    ...
    function (n, s) {
      ...
      return {
        ...
        d: [
          ...
          { kind: 'field', decorators: [r()], key: 'href', value: () => '' },
          { kind: 'field', decorators: [r()], key: 'title', value: void 0 },
          {
            kind: 'method',
            key: 'shouldUpdate',
            value: function (e) {
              if (e.has('active') && this.active) {
                const { selectorMenu: e } = this.constructor,
                  t = this.closest(e);
                t && (t.active = !0);
              }
              return !0;
          ...
          },
          {
            ...
            value: function () {
              this.hasAttribute('role') || this.setAttribute('role', 'button'),
                (function (e, t, r, i) {
                  var n = p(f(1 & i ? e.prototype : e), t, r);
                  return 2 & i
                    ? function (e) {
                        return n.apply(r, e);
                      }
          ...
          },
          {
            ...
            key: 'render',
            value: function () {
              const { active: t, href: r, title: n } = this,
                o = e({
                  [`${u}--side-nav__link`]: !0,
                  [`${u}--side-nav__link--current`]: t,
                });
              return i(
                y ||
                  (y = v`
    ...
    `),
          ...
          },
          {
            ...
            value: () =>
              c(c({}, t.shadowRootOptions), {}, { delegatesFocus: !0 }),
          },
...
const { prefix: T, stablePrefix: S } = n;
      ...
      (function (e) {
        for (
          ...
          if ('method' === o.kind && (n = t.find(r)))
            if (_(o.descriptor) || _(n.descriptor)) {
              if (A(o) || A(n))
  ...
  function (t, n) {
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [r({ attribute: 'is-heading' })],
          key: 'isHeading',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [r({ attribute: 'is-view-all' })],
          key: 'isViewAll',
          value: void 0,
        },
        {
          ...
          value: function (e) {
            !(function (e, t, r, i) {
              var n = C(O(1 & i ? e.prototype : e), t, r);
              ...
              e.has('isHeading') &&
                this.classList.toggle(
                  `${T}--side-nav__group-header`,
                  this.isHeading
                ),
              e.has('isViewAll') &&
                this.classList.toggle(
                  `${T}--side-nav__group-view-all`,
                  this.isViewAll
                );
          },
        },
        {
          ...
          value: function () {
            const {
              ...
              c = 'rtl' === document.dir.toLowerCase() ? a : l,
              d = e({
                [`${T}--side-nav__link`]: !0,
                [`${T}--side-nav__link--current`]: t,
              });
            return r
              ? i(
                  k ||
