...
import { s } from './stripHTML.js';
import { S as a } from './stable-selector.js';
import { s as l } from './content-block2.js';
  ...
  function (i, n) {
    ...
    return {
      ...
      d: [
        ...
        { kind: 'field', decorators: [o()], key: 'content', value: () => '' },
        {
          kind: 'method',
          ...
          value: function () {
            this.hasAttribute('role') || this.setAttribute('role', 'heading'),
              ...
              (function (e, t, r, i) {
                var n = g(E(1 & i ? e.prototype : e), t, r);
        ...
        },
        {
          ...
          key: 'firstUpdated',
          value: function () {
            (this.content = s(this.innerHTML)),
              t(r(d || (d = p`<h2 part="h2">${0}</h2>`), this.content), this);
          },
        },
        {
          kind: 'method',
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${P}--content-block__heading`;
          },
        },
