 ...
 */
let C4DMegaMenuCategoryHeading = _decorate(
  [carbonElement(`${c4dPrefix}-megamenu-category-heading`)],
  function (_initialize, _C4DMegaMenuHeading) {
