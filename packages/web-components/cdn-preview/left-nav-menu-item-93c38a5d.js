...
import {
  ...
  s as styles$1,
  a as settings,
  D as svgResultCarbonIcon,
  E as svgResultCarbonIcon$1,
 ...
 */
let CDSSideNavMenuItem = _decorate$1(
  [carbonElement(`${prefix$1}-side-nav-menu-item`)],
 ...
 */
let C4DLeftNavMenuItem = _decorate(
  [carbonElement(`${c4dPrefix}-left-nav-menu-item`)],
  function (_initialize, _CDSSideNavMenuItem) {
