...
import { t as e } from './objectSpread2.js';
function r(e, r) {
...
function i(e, r, t, i) {
  var c = n();
  if (i) for (var d = 0; d < i.length; d++) c = i[d](c);
  var p = r(function (e) {
      c.initializeInstanceElements(e, f.elements);
    }, t),
    f = c.decorateClass(
      (function (e) {
        for (
  ...
  return (
    c.initializeClassElements(p.F, f.elements),
    c.runClassFinishers(p.F, f.finishers)
  );
}
function n() {
  n = function () {
  ...
  var r = {
    ...
    initializeClassElements: function (e, r) {
      ...
      ['method', 'field'].forEach(function (i) {
        r.forEach(function (r) {
          var n = r.placement;
          if (r.kind === i && ('static' === n || 'prototype' === n)) {
            var o = 'static' === n ? e : t;
            this.defineClassElement(o, r);
          }
        }, this);
      }, this);
    },
    ...
    decorateClass: function (e, r) {
      ...
      if (
        ...
        e.forEach(function (e) {
          if (!a(e)) return t.push(e);
          var r = this.decorateElement(e, n);
          t.push(r.element),
      ...
      var o = this.decorateConstructor(t, r);
    ...
    decorateElement: function (e, r) {
      for (
        var t = [], i = [], n = e.decorators, o = n.length - 1;
        o >= 0;
        o--
      ) {
        var s = r[e.placement];
    ...
    decorateConstructor: function (e, r) {
      for (var t = [], i = r.length - 1; i >= 0; i--) {
        var n = this.fromClassDescriptor(e),
          o = this.toClassDescriptor((0, r[i])(n) || n);
        if (
    ...
    toElementDescriptor: function (r) {
      ...
      var o = r.descriptor;
      this.disallowProperty(r, 'elements', 'An element descriptor');
      var s = {
        kind: t,
        key: i,
        placement: n,
      ...
      return (
        'field' !== t
          ? this.disallowProperty(r, 'initializer', 'A method descriptor')
...
function o(r) {
  var t,
    i = e(r.key);
  'method' === r.kind
    ? (t = { value: r.value, writable: !0, configurable: !0, enumerable: !1 })
    : 'get' === r.kind
    ? (t = { get: r.value, configurable: !0, enumerable: !1 })
    : 'set' === r.kind
    ? (t = { set: r.value, configurable: !0, enumerable: !1 })
    : 'field' === r.kind &&
      (t = { configurable: !0, writable: !0, enumerable: !0 });
  var n = {
    kind: 'field' === r.kind ? 'field' : 'method',
    key: i,
    placement: r.static ? 'static' : 'field' === r.kind ? 'own' : 'prototype',
    descriptor: t,
  };
  return (
    r.decorators && (n.decorators = r.decorators),
    'field' === r.kind && (n.initializer = r.value),
    n
  );
}
function s(e, r) {
