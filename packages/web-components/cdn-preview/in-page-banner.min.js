 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let i,r=function(s){return s.REGULAR="regular",s.LAYER="layer",s.CYAN="cyan",s.PURPLE="purple",s}({}),l=s=>s;function a(){a=function(){return s};var s={elementsDefinitionOrder:[["method"],["field"]],initializeInstanceElements:function(s,n){["method","field"].forEach((function(c){n.forEach((function(n){n.kind===c&&"own"===n.placement&&this.defineClassElement(s,n)}),this)}),this)},initializeClassElements:function(s,n){var c=s.prototype;["method","field"].forEach((function(d){n.forEach((function(n){var t=n.placement;if(n.kind===d&&("static"===t||"prototype"===t)){var o="static"===t?s:c;this.defineClassElement(o,n)}}),this)}),this)},defineClassElement:function(s,n){var c=n.descriptor;if("field"===n.kind){var d=n.initializer;c={enumerable:c.enumerable,writable:c.writable,configurable:c.configurable,value:void 0===d?void 0:d.call(s)}}Object.defineProperty(s,n.key,c)},decorateClass:function(s,n){var c=[],d=[],t={static:[],prototype:[],own:[]};if(s.forEach((function(s){this.addElementPlacement(s,t)}),this),s.forEach((function(s){if(!u(s))return c.push(s);var n=this.decorateElement(s,t);c.push(n.element),c.push.apply(c,n.extras),d.push.apply(d,n.finishers)}),this),!n)return{elements:c,finishers:d};var o=this.decorateConstructor(c,n);return d.push.apply(d,o.finishers),o.finishers=d,o},addElementPlacement:function(s,n,c){var d=n[s.placement];if(!c&&-1!==d.indexOf(s.key))throw new TypeError("Duplicated element ("+s.key+")");d.push(s.key)},decorateElement:function(s,n){for(var c=[],d=[],t=s.decorators,o=t.length-1;o>=0;o--){var e=n[s.placement];e.splice(e.indexOf(s.key),1);var i=this.fromElementDescriptor(s),r=this.toElementFinisherExtras((0,t[o])(i)||i);s=r.element,this.addElementPlacement(s,n),r.finisher&&d.push(r.finisher);var l=r.extras;if(l){for(var a=0;a<l.length;a++)this.addElementPlacement(l[a],n);c.push.apply(c,l)}}return{element:s,finishers:d,extras:c}},decorateConstructor:function(s,n){for(var c=[],d=n.length-1;d>=0;d--){var t=this.fromClassDescriptor(s),o=this.toClassDescriptor((0,n[d])(t)||t);if(void 0!==o.finisher&&c.push(o.finisher),void 0!==o.elements){s=o.elements;for(var e=0;e<s.length-1;e++)for(var i=e+1;i<s.length;i++)if(s[e].key===s[i].key&&s[e].placement===s[i].placement)throw new TypeError("Duplicated element ("+s[e].key+")")}}return{elements:s,finishers:c}},fromElementDescriptor:function(s){var n={kind:s.kind,key:s.key,placement:s.placement,descriptor:s.descriptor};return Object.defineProperty(n,Symbol.toStringTag,{value:"Descriptor",configurable:!0}),"field"===s.kind&&(n.initializer=s.initializer),n},toElementDescriptors:function(s){if(void 0!==s)return(n=s,function(s){if(Array.isArray(s))return s}(n)||function(s){if("undefined"!=typeof Symbol&&null!=s[Symbol.iterator]||null!=s["@@iterator"])return Array.from(s)}(n)||function(s,n){if(s){if("string"==typeof s)return f(s,n);var c={}.toString.call(s).slice(8,-1);return"Object"===c&&s.constructor&&(c=s.constructor.name),"Map"===c||"Set"===c?Array.from(s):"Arguments"===c||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c)?f(s,n):void 0}}(n)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()).map((function(s){var n=this.toElementDescriptor(s);return this.disallowProperty(s,"finisher","An element descriptor"),this.disallowProperty(s,"extras","An element descriptor"),n}),this);var n},toElementDescriptor:function(s){var n=s.kind+"";if("method"!==n&&"field"!==n)throw new TypeError('An element descriptor\'s .kind property must be either "method" or "field", but a decorator created an element descriptor with .kind "'+n+'"');var c=y(s.key),d=s.placement+"";if("static"!==d&&"prototype"!==d&&"own"!==d)throw new TypeError('An element descriptor\'s .placement property must be one of "static", "prototype" or "own", but a decorator created an element descriptor with .placement "'+d+'"');var t=s.descriptor;this.disallowProperty(s,"elements","An element descriptor");var o={kind:n,key:c,placement:d,descriptor:Object.assign({},t)};return"field"!==n?this.disallowProperty(s,"initializer","A method descriptor"):(this.disallowProperty(t,"get","The property descriptor of a field descriptor"),this.disallowProperty(t,"set","The property descriptor of a field descriptor"),this.disallowProperty(t,"value","The property descriptor of a field descriptor"),o.initializer=s.initializer),o},toElementFinisherExtras:function(s){return{element:this.toElementDescriptor(s),finisher:h(s,"finisher"),extras:this.toElementDescriptors(s.extras)}},fromClassDescriptor:function(s){var n={kind:"class",elements:s.map(this.fromElementDescriptor,this)};return Object.defineProperty(n,Symbol.toStringTag,{value:"Descriptor",configurable:!0}),n},toClassDescriptor:function(s){var n=s.kind+"";if("class"!==n)throw new TypeError('A class descriptor\'s .kind property must be "class", but a decorator created a class descriptor with .kind "'+n+'"');this.disallowProperty(s,"key","A class descriptor"),this.disallowProperty(s,"placement","A class descriptor"),this.disallowProperty(s,"descriptor","A class descriptor"),this.disallowProperty(s,"initializer","A class descriptor"),this.disallowProperty(s,"extras","A class descriptor");var c=h(s,"finisher");return{elements:this.toElementDescriptors(s.elements),finisher:c}},runClassFinishers:function(s,n){for(var c=0;c<n.length;c++){var d=(0,n[c])(s);if(void 0!==d){if("function"!=typeof d)throw new TypeError("Finishers must return a constructor.");s=d}}return s},disallowProperty:function(s,n,c){if(void 0!==s[n])throw new TypeError(c+" can't have a ."+n+" property.")}};return s}function m(s){var n,c=y(s.key);"method"===s.kind?n={value:s.value,writable:!0,configurable:!0,enumerable:!1}:"get"===s.kind?n={get:s.value,configurable:!0,enumerable:!1}:"set"===s.kind?n={set:s.value,configurable:!0,enumerable:!1}:"field"===s.kind&&(n={configurable:!0,writable:!0,enumerable:!0});var d={kind:"field"===s.kind?"field":"method",key:c,placement:s.static?"static":"field"===s.kind?"own":"prototype",descriptor:n};return s.decorators&&(d.decorators=s.decorators),"field"===s.kind&&(d.initializer=s.value),d}function g(s,n){void 0!==s.descriptor.get?n.descriptor.get=s.descriptor.get:n.descriptor.set=s.descriptor.set}function u(s){return s.decorators&&s.decorators.length}function p(s){return void 0!==s&&!(void 0===s.value&&void 0===s.writable)}function h(s,n){var c=s[n];if(void 0!==c&&"function"!=typeof c)throw new TypeError("Expected '"+n+"' to be a function");return c}function y(s){var n=function(s,n){if("object"!=typeof s||!s)return s;var c=s[Symbol.toPrimitive];if(void 0!==c){var d=c.call(s,n||"default");if("object"!=typeof d)return d;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===n?String:Number)(s)}(s,"string");return"symbol"==typeof n?n:n+""}function f(s,n){(null==n||n>s.length)&&(n=s.length);for(var c=0,d=Array(n);c<n;c++)d[c]=s[c];return d}function b(){return b="undefined"!=typeof Reflect&&Reflect.get?Reflect.get.bind():function(s,n,c){var d=function(s,n){for(;!{}.hasOwnProperty.call(s,n)&&null!==(s=x(s)););return s}(s,n);if(d){var t=Object.getOwnPropertyDescriptor(d,n);return t.get?t.get.call(arguments.length<3?s:c):t.value}},b.apply(null,arguments)}function x(s){return x=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(s){return s.__proto__||Object.getPrototypeOf(s)},x(s)}const{stablePrefix:v}=c;!function(s,n,c,d){var t=a();if(d)for(var o=0;o<d.length;o++)t=d[o](t);var e=n((function(s){t.initializeInstanceElements(s,i.elements)}),c),i=t.decorateClass(function(s){for(var n=[],c=function(s){return"method"===s.kind&&s.key===o.key&&s.placement===o.placement},d=0;d<s.length;d++){var t,o=s[d];if("method"===o.kind&&(t=n.find(c)))if(p(o.descriptor)||p(t.descriptor)){if(u(o)||u(t))throw new ReferenceError("Duplicated methods ("+o.key+") can't be decorated.");t.descriptor=o.descriptor}else{if(u(o)){if(u(t))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+o.key+").");t.decorators=o.decorators}g(o,t)}else n.push(o)}return n}(e.d.map(m)),s);t.initializeClassElements(e.F,i.elements),t.runClassFinishers(e.F,i.finishers)}([o(`${v}-in-page-banner`)],(function(c,d){class t extends d{constructor(...s){super(...s),c(this)}}return{F:t,d:[{kind:"field",decorators:[n({attribute:"color-scheme",reflect:!0})],key:"colorScheme",value:()=>r.REGULAR},{kind:"get",static:!0,key:"stableSelector",value:function(){return`${v}--in-page-banner`}},{kind:"get",static:!0,key:"styles",value:function(){return s(i||(i=l`
      ${0}${0}
    `),(n=t,c="styles",d=this,r=b(x(1&o?n.prototype:n),c,d),2&o&&"function"==typeof r?function(s){return r.apply(d,s)}:r),e);var n,c,d,o,r}}]}}),d(t));
