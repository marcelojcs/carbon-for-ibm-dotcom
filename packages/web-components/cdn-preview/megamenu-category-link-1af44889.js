 ...
 */
let C4DMegaMenuCategoryLink = _decorate(
  [carbonElement(`${c4dPrefix}-megamenu-category-link`)],
  function (_initialize, _CDSLink) {
        ...
        },
        {
          ...
          value:
            ...
            function _renderIcon() {
              ...
              return _targetMap.has(target)
                ? _targetMap.get(target)
                : undefined;
            },
    ...
    `),
        ...
        },
        {
          ...
          value: function connectedCallback() {
            ...
            this.layout =
              megamenu === null || megamenu === void 0
                ? void 0
                : megamenu.getAttribute('layout');
            _superPropGet(
              C4DMegaMenuCategoryLink,
              'connectedCallback',
              this,
              3
            )([]);
