...
import { i as e, n as o, x as t, s as c } from './query-assigned-elements.js';
import { C as i } from './callout.js';
import { C as s } from './quote-link-with-icon.js';
import { c as n } from './carbon-element.js';
import { C as r } from './defs2.js';
import { C as d } from './link-with-icon.js';
import './state.js';
  ...
  var e = {
    ...
    initializeClassElements: function (e, o) {
      ...
      ['method', 'field'].forEach(function (c) {
        o.forEach(function (o) {
          var i = o.placement;
          if (o.kind === c && ('static' === i || 'prototype' === i)) {
            var s = 'static' === i ? e : t;
    ...
    addElementPlacement: function (e, o, t) {
      var c = o[e.placement];
      if (!t && -1 !== c.indexOf(e.key))
        throw new TypeError('Duplicated element (' + e.key + ')');
      c.push(e.key);
    },
    decorateElement: function (e, o) {
      for (
        var t = [], c = [], i = e.decorators, s = i.length - 1;
        s >= 0;
        s--
      ) {
        var n = o[e.placement];
        ...
        var r = this.fromElementDescriptor(e),
          d = this.toElementFinisherExtras((0, i[s])(r) || r);
        (e = d.element),
          this.addElementPlacement(e, o),
          d.finisher && c.push(d.finisher);
        var a = d.extras;
        if (a) {
      ...
      return { element: e, finishers: c, extras: t };
    },
    decorateConstructor: function (e, o) {
      for (var t = [], c = o.length - 1; c >= 0; c--) {
        var i = this.fromClassDescriptor(e),
          s = this.toClassDescriptor((0, o[c])(i) || i);
        if (
          ...
          for (var n = 0; n < e.length - 1; n++)
            for (var r = n + 1; r < e.length; r++)
              if (e[n].key === e[r].key && e[n].placement === e[r].placement)
...
function y(e, o) {
  ...
  for (var t = 0, c = Array(o); t < o; t++) c[t] = e[t];
  return c;
}
function k() {
  return (
    (k =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, o, t) {
            ...
            if (c) {
              var i = Object.getOwnPropertyDescriptor(c, o);
...
const { prefix: _, stablePrefix: w } = c;
!(function (e, o, t, c) {
  var i = m();
  if (c) for (var s = 0; s < c.length; s++) i = c[s](i);
  var n = o(function (e) {
      i.initializeInstanceElements(e, r.elements);
    }, t),
    r = i.decorateClass(
      (function (e) {
        for (
          ...
          var i,
            s = e[c];
          if ('method' === s.kind && (i = o.find(t)))
            if (h(s.descriptor) || h(i.descriptor)) {
              if (v(s) || v(i))
  ...
  i.initializeClassElements(n.F, r.elements),
    i.runClassFinishers(n.F, r.finishers);
})(
  [n(`${w}-callout-quote`)],
  function (e, c) {
    class i extends c {
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [o({ reflect: !0, attribute: 'color-scheme' })],
          key: 'colorScheme',
          value: () => r.REGULAR,
        },
        {
          ...
          value: function (e) {
            ...
            (t = 'updated'),
            (c = this),
            (n = k(x(1 & (s = 3) ? o.prototype : o), t, c)),
            2 & s && 'function' == typeof n
              ? function (e) {
                  return n.apply(c, e);
                }
              : n)([e]);
            const r = this.querySelector(this.constructor.selectorLinkWithIcon);
            r && (r.colorScheme = this.colorScheme);
          },
        },
        {
          kind: 'method',
    ...
    `),
        ...
        },
        {
          kind: 'get',
          static: !0,
          key: 'selectorLinkWithIcon',
          value: function () {
            return `${w}-callout-link-with-icon`;
          },
        },
        {
          kind: 'get',
  ...
  return (
    (O =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, o, t) {
            var c = (function (e, o) {
              for (; !{}.hasOwnProperty.call(e, o) && null !== (e = F(e)); );
              return e;
            })(e, o);
            if (c) {
              var i = Object.getOwnPropertyDescriptor(c, o);
      ...
      (function (e) {
        for (
          ...
          var i,
            s = e[c];
          if ('method' === s.kind && (i = o.find(t)))
            if (C(s.descriptor) || C(i.descriptor)) {
              if (S(s) || S(i))
                throw new ReferenceError(
                  'Duplicated methods (' + s.key + ") can't be decorated."
                );
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${R}--callout-link-with-icon`;
          },
        },
        {
          kind: 'get',
