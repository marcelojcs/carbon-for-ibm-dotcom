...
let process = { env: {} };
import { g as s, x, s as styles, c as carbonElement, a as settings } from './index-5becb925.js';
 ...
 */
let C4DMegaMenuCategoryLinkGroup = _decorate([carbonElement(`${c4dPrefix}-megamenu-category-link-group`)], function (_initialize, _LitElement) {
  class C4DMegaMenuCategoryLinkGroup extends _LitElement {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
  ...
  return {
    F: C4DMegaMenuCategoryLinkGroup,
    d: [{
      kind: "method",
      key: "render",
...
export { C4DMegaMenuCategoryLinkGroup as default };
