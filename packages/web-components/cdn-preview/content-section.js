...
import { s as o } from './content-section2.js';
...
const { prefix: v, stablePrefix: k } = r;
let b = (function (e, t, r, i) {
  var n = c();
  ...
  function (r, i) {
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [e({ attribute: 'children-custom-class', reflect: !0 })],
          key: 'childrenCustomClass',
          value: () => '',
        },
        {
          kind: 'method',
          ...
          value: function (e) {
            e.target
              ...
              .forEach((e) => {
                e.matches(this.constructor.linkListSelector)
    ...
    `),
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${k}--content-section`;
          },
        },
        {
          kind: 'get',
          static: !0,
          key: 'cardGroupSelector',
          value: function () {
            return `${k}-card-group`;
          },
        },
