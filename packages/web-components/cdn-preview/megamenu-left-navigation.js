...
import { C as r, s as i } from './masthead-container.js';
import './pickBy.js';
import './toNumber.js';
import './store.js';
import './index.js';
...
const { stablePrefix: m } = e;
let f = (function (e, t, r, i) {
  var c = o();
  if (i) for (var p = 0; p < i.length; p++) c = i[p](c);
  var d = t(function (e) {
      c.initializeInstanceElements(e, m.elements);
    }, r),
    m = c.decorateClass(
      (function (e) {
        for (
          ...
          if ('method' === n.kind && (o = t.find(r)))
            if (l(n.descriptor) || l(o.descriptor)) {
              if (a(n) || a(o))
  ...
  return (
    c.initializeClassElements(d.F, m.elements),
    c.runClassFinishers(d.F, m.finishers)
  );
})(
  [t(`${m}-megamenu-left-navigation`)],
  function (e, t) {
    return {
      F: class extends t {
        constructor(...t) {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${m}--masthead__megamenu-left-navigation`;
          },
        },
      ],
    };
