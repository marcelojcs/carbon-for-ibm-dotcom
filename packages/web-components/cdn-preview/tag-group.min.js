...
function e() {
  ...
  var s = {
    ...
    decorateClass: function (s, d) {
      ...
      var i = this.decorateConstructor(n, d);
    ...
    decorateElement: function (s, d) {
      for (
        var n = [], c = [], t = s.decorators, i = t.length - 1;
        i >= 0;
        i--
      ) {
        var o = d[s.placement];
        ...
        var r = this.fromElementDescriptor(s),
          l = this.toElementFinisherExtras((0, t[i])(r) || r);
        (s = l.element),
          this.addElementPlacement(s, d),
          l.finisher && c.push(l.finisher);
        var e = l.extras;
        if (e) {
    ...
    decorateConstructor: function (s, d) {
      for (var n = [], c = d.length - 1; c >= 0; c--) {
        var t = this.fromClassDescriptor(s),
          i = this.toClassDescriptor((0, d[c])(t) || t);
        if (
          (void 0 !== i.finisher && n.push(i.finisher), void 0 !== i.elements)
        ) {
          s = i.elements;
    ...
    toElementDescriptors: function (s) {
      if (void 0 !== s)
        ...
        (function (s) {
          ...
          (function (s, d) {
            if (s) {
              if ('string' == typeof s) return y(s, d);
  ...
  return (
    (f =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (s, d, n) {
            var c = (function (s, d) {
              for (; !{}.hasOwnProperty.call(s, d) && null !== (s = x(s)); );
              return s;
            })(s, d);
            if (c) {
...
!(function (s, d, n, c) {
  ...
  var o = d(function (s) {
      t.initializeInstanceElements(s, r.elements);
    }, n),
    r = t.decorateClass(
      (function (s) {
        for (
          ...
          var t,
            i = s[c];
          if ('method' === i.kind && (t = d.find(n)))
            if (u(i.descriptor) || u(t.descriptor)) {
              if (g(i) || g(t))
  ...
  t.initializeClassElements(o.F, r.elements),
    t.runClassFinishers(o.F, r.finishers);
})(
  [i(`${b}-tag-group`)],
  function (s, n) {
    class c extends n {
      ...
      d: [
        {
          ...
          value: function (s) {
            const d = s.target.assignedNodes(),
              n = d.filter((s) => {
                var d, n;
                return null === (d = (n = s).matches) || void 0 === d
                  ? void 0
                  : d.call(n, this.constructor.selectorTag);
              }),
              c = d.filter((s) => {
                var d, n;
                return null === (d = s.classList) ||
                  void 0 === d ||
                  null === (n = d.contains) ||
                  void 0 === n
                  ? void 0
                  : n.call(d, this.constructor.selectorReactTag);
              });
            n.forEach((s) => {
              s.hasAttribute('type') || s.setAttribute('type', 'green');
            }),
              c.forEach((s) => {
                var d;
                s.className.split(' ').some((s) => /^cds--tag--/.test(s)) ||
                  null === (d = s.classList) ||
                  void 0 === d ||
                  d.add(`${v}--tag--green`);
              });
        ...
        },
        {
          ...
          value: function () {
            ...
            (d = 'connectedCallback'),
            (n = this),
            (i = f(x(1 & (t = 3) ? s.prototype : s), d, n)),
            2 & t && 'function' == typeof i
              ? function (s) {
                  return i.apply(n, s);
                }
              : i)([]),
  ...
  console.warn(
    'The tag-group component has been deprecated in favor of combing cds-tag components. See cds-tag documentation in @carbon/web-components for more information.'
  );
