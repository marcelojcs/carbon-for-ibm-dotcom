...
import { C as o } from './content-block.js';
...
import { i as t, s as e } from './query-assigned-elements.js';
  ...
  var o = {
    ...
    initializeClassElements: function (o, t) {
      ...
      ['method', 'field'].forEach(function (i) {
        t.forEach(function (t) {
          var d = t.placement;
          if (t.kind === i && ('static' === d || 'prototype' === d)) {
            var c = 'static' === d ? o : e;
            this.defineClassElement(c, t);
          }
        }, this);
      }, this);
    },
    defineClassElement: function (o, t) {
      ...
      if ('field' === t.kind) {
        ...
        e = {
          ...
          value: void 0 === i ? void 0 : i.call(o),
        };
      }
    ...
    decorateClass: function (o, t) {
      ...
      if (
        (o.forEach(function (o) {
          this.addElementPlacement(o, d);
        }, this),
        o.forEach(function (o) {
          if (!p(o)) return e.push(o);
          var t = this.decorateElement(o, d);
          e.push(t.element),
      ...
      var c = this.decorateConstructor(e, t);
      return i.push.apply(i, c.finishers), (c.finishers = i), c;
    },
    addElementPlacement: function (o, t, e) {
      var i = t[o.placement];
      if (!e && -1 !== i.indexOf(o.key))
        throw new TypeError('Duplicated element (' + o.key + ')');
      i.push(o.key);
    },
    decorateElement: function (o, t) {
      for (
        var e = [], i = [], d = o.decorators, c = d.length - 1;
        c >= 0;
        c--
      ) {
        var n = t[o.placement];
        n.splice(n.indexOf(o.key), 1);
        var s = this.fromElementDescriptor(o),
          r = this.toElementFinisherExtras((0, d[c])(s) || s);
        (o = r.element),
          this.addElementPlacement(o, t),
          r.finisher && i.push(r.finisher);
        var a = r.extras;
        if (a) {
      ...
      return { element: o, finishers: i, extras: e };
    },
    decorateConstructor: function (o, t) {
      for (var e = [], i = t.length - 1; i >= 0; i--) {
        var d = this.fromClassDescriptor(o),
          c = this.toClassDescriptor((0, t[i])(d) || d);
        if (
          ...
          for (var n = 0; n < o.length - 1; n++)
            for (var s = n + 1; s < o.length; s++)
              if (o[n].key === o[s].key && o[n].placement === o[s].placement)
    ...
    toElementDescriptors: function (o) {
      if (void 0 !== o)
        ...
        (function (o) {
          ...
          (function (o, t) {
            if (o) {
              if ('string' == typeof o) return b(o, t);
...
function a(o) {
  ...
  return (
    o.decorators && (i.decorators = o.decorators),
    'field' === o.kind && (i.initializer = o.value),
    i
  );
}
function l(o, t) {
  ...
  return (
    (v =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (o, t, e) {
            var i = (function (o, t) {
              for (; !{}.hasOwnProperty.call(o, t) && null !== (o = u(o)); );
              return o;
            })(o, t);
            if (i) {
              var d = Object.getOwnPropertyDescriptor(i, t);
              return d.get ? d.get.call(arguments.length < 3 ? o : e) : d.value;
            }
          }),
...
const { stablePrefix: f } = e;
!(function (o, t, e, i) {
  var d = r();
  if (i) for (var c = 0; c < i.length; c++) d = i[c](d);
  var n = t(function (o) {
      d.initializeInstanceElements(o, s.elements);
    }, e),
    s = d.decorateClass(
      (function (o) {
        for (
          ...
          var d,
            c = o[i];
          if ('method' === c.kind && (d = t.find(e)))
            if (m(c.descriptor) || m(d.descriptor)) {
              if (p(c) || p(d))
                throw new ReferenceError(
                  'Duplicated methods (' + c.key + ") can't be decorated."
                );
              d.descriptor = c.descriptor;
            } else {
              if (p(c)) {
                if (p(d))
                  throw new ReferenceError(
  ...
  d.initializeClassElements(n.F, s.elements),
    d.runClassFinishers(n.F, s.finishers);
})(
  [d(`${f}-content-block-simple`)],
  function (o, e) {
    class i extends e {
      constructor(...t) {
        super(...t), o(this);
    ...
    `),
              ...
              (e = 'styles'),
              (d = this),
              (a = v(u(1 & r ? o.prototype : o), e, d)),
              2 & r && 'function' == typeof a
                ? function (o) {
                    return a.apply(d, o);
                  }
                : a),
  ...
  console.warn(
    'The content-block-simple component has been deprecated in favor of the content-section/block component. See content-section/block documentation for more information.'
  );
