...
import { s as i } from './content-block2.js';
...
const { stablePrefix: y } = t;
let v = (function (e, t, r, i) {
  var n = l();
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            ...
            const t = e.assignedNodes({ flatten: !0 }),
              ...
              i = !t.some(r);
            this.style.display = i ? 'none' : 'block';
          },
        },
        {
          kind: 'method',
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${y}--content-block-paragraph`;
          },
        },
