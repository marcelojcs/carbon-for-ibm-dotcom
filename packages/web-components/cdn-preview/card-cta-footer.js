...
import { C as i, f as n, a as o } from './formatVideoCaption.js';
import { C as a } from './card-footer.js';
import { C as s } from './cta-v1.js';
import { V as l } from './video.js';
import { s as c } from './cta2.js';
import { c as d } from './carbon-element.js';
let f,
  p = (e) => e;
function u() {
  u = function () {
...
function g(e, t, r, i) {
  var n = E(C(1 & i ? e.prototype : e), t, r);
...
const { prefix: P, stablePrefix: D } = r;
!(function (e, t, r, i) {
  var n = u();
      ...
      d: [
        {
          ...
          key: '_renderContent',
          value: function () {
            const { ctaType: t, _hasCopy: r } = this;
            if (t !== i.VIDEO) return g(s, '_renderContent', this, 3)([]);
            const {
                videoDuration: n,
                formatVideoCaption: o,
                formatVideoDuration: a,
              } = this,
              l = r
                ? void 0
                : o({ duration: a({ duration: n ? 1e3 * n : n }) });
            return e(
              f ||
                (f = p`
