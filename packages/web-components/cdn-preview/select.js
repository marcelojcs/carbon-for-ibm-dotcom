...
import { _ as s, a as i } from './get.js';
import { i as r, x as l, n as c, a as d } from './query-assigned-elements.js';
import { i as a } from './query.js';
import { o as n } from './class-map.js';
import { s as o } from './163.js';
import { F as u, s as p, a as f } from './form.js';
import { p as v } from './settings.js';
import { l as m } from './if-defined.js';
import { b } from './collection-helpers2.js';
import { I as g } from './text-input.js';
import { i as h } from './if-non-empty.js';
...
let _,
  ...
  T = (e) => e;
function j(e, t, r, l) {
  var c = s(i(1 & l ? e.prototype : e), t, r);
  return 2 & l
    ? function (e) {
        return c.apply(r, e);
      }
  ...
  function (t, s) {
    ...
    return {
      ...
      d: [
        ...
        { kind: 'field', key: '_observerMutation', value: () => null },
        {
          kind: 'field',
          key: '_placeholderItemValue',
          value: () =>
            `__${v}-select-placeholder_${Math.random().toString(36).slice(2)}`,
        },
        {
          kind: 'field',
          decorators: [a('select')],
        ...
        },
        {
          ...
          value: function ({ target: e }) {
            const { value: t } = e;
            this.value = t;
            const { eventSelect: s } = this.constructor;
            this.dispatchEvent(
              new CustomEvent(s, {
                bubbles: !0,
                composed: !0,
        ...
        },
        {
          ...
          key: '_renderItems',
          value: function (e) {
            const { selectorItem: t, selectorLeafItem: s } = this.constructor;
            return l(
              _ ||
                (_ = T`
      ${0}
    `),
              b(
                e.childNodes,
                (e) => e.nodeType === Node.ELEMENT_NODE && e.matches(t)
              ).map((e) => {
                const t = e.hasAttribute('disabled'),
                  i = e.getAttribute('label'),
                  r = e.hasAttribute('selected'),
        ...
        },
        {
          ...
          value: function (e) {
            const { formData: t } = e,
              { disabled: s, name: i, value: r } = this;
            s || t.append(i, r);
          },
        },
        {
        ...
        {
          kind: 'field',
          decorators: [c({ type: Boolean, attribute: 'hide-label' })],
          key: 'hideLabel',
          value: () => !1,
        },
        { kind: 'field', decorators: [c()], key: 'id', value: () => '' },
        {
          kind: 'field',
          decorators: [c({ type: Boolean, reflect: !0 })],
          key: 'invalid',
        ...
        {
          kind: 'field',
          decorators: [c({ attribute: 'label-text' })],
          key: 'labelText',
          value: () => '',
        },
        {
        ...
        { kind: 'field', decorators: [c()], key: 'pattern', value: () => '' },
        {
          kind: 'field',
        ...
        },
        {
          ...
          key: 'selectedIndex',
          value: function (e) {
            (this._selectNode.selectedIndex = e),
        ...
        },
        {
          ...
          value: function () {
            j(i, 'connectedCallback', this, 3)([]),
              (this._observerMutation = new MutationObserver(
        ...
        },
        {
          ...
          value: function (e) {
            var t, s;
            if (e.has('value')) {
              const { value: e, _placeholderItemValue: t } = this;
              this._selectNode.value = e || t;
            }
            null === (t = this.shadowRoot) ||
              void 0 === t ||
              null === (t = t.querySelector("slot[name='slug']")) ||
              void 0 === t ||
              t.classList.toggle(
                `${v}--slug--revert`,
                null === (s = this.querySelector(`${v}-slug`)) || void 0 === s
                  ? void 0
                  : s.hasAttribute('revert-active')
              );
          },
        },
        {
          ...
          value: function () {
            const {
                ...
                warnText: h,
                value: y,
                _placeholderItemValue: k,
                _handleInput: _,
                _handleSlugSlotChange: x,
                _hasSlug: w,
              } = this,
              j = n({
                [`${v}--select`]: !0,
              ...
              C = n({ [`${v}--label`]: !0, [`${v}--label--disabled`]: e }),
              L = n({
                [`${v}--form__helper-text`]: !0,
                [`${v}--form__helper-text--disabled`]: e,
              }),
              X = t
                ? l(
                    $ ||
        ...
        `),
              ...
              R =
                r || g
                  ? l(
                      z ||
                        (z = T` <div class="${0}--form-requirement">
            ${0}
          </div>`),
                      v,
                      r ? c : h
    ...
    `),
            ...
            `),
                ...
                o({ class: `${v}--select__arrow` }),
                x,
                r ? p({ class: `${v}--select__invalid-icon` }) : void 0,
                !r && g
                  ? f({
                      class: `${v}--select__invalid-icon ${v}--select__invalid-icon--warning`,
                    })
                  : null
              );
            return l(
    ...
    `),
              ...
              i
                ? l(
                    B ||
                      (B = T`<div class="${0}--select-input--inline__wrapper">
              <div
        ...
        },
        {
          ...
          key: 'selectorItem',
          value: function () {
            return `${v}-select-item-group,${v}-select-item`;
          },
        },
        {
          kind: 'get',
