...
import { i, L as a } from './Locale.js';
import { s as n, a as l } from './20.js';
import { s as p } from './202.js';
import { l as g } from './index.js';
import { H as h } from './host-listener.js';
import { o as u, H as m } from './host-listener2.js';
import { H as f } from './hybrid-render.js';
import { t as b } from './state.js';
import { s as v } from './spread.js';
import { s as y } from './settings.js';
import { C as _ } from './expressive-modal.js';
import './expressive-modal-heading.js';
import './expressive-modal-close-button.js';
import './link-with-icon.js';
import { S as k } from './StickyHeader.js';
import { c as x } from './carbon-element.js';
import { I as w } from './defs.js';
import './search.js';
import { S as z } from './stable-selector.js';
import { o as E } from './class-map.js';
import { C as P } from './card.js';
import { i as T } from './query.js';
import { I as S } from './text-input.js';
import { t as C } from './throttle.js';
import { a as A } from './collection-helpers.js';
import { C as D } from './link.js';
 ...
 * LICENSE file in the root directory of this source tree.
 */
const j = ({ children: c, ...t } = {}) =>
  e`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${v(
    t
...
function H() {
  ...
  var e = {
    ...
    initializeInstanceElements: function (e, c) {
    ...
    initializeClassElements: function (e, c) {
      var t = e.prototype;
      ['method', 'field'].forEach(function (d) {
        c.forEach(function (c) {
          var s = c.placement;
          if (c.kind === d && ('static' === s || 'prototype' === s)) {
            var o = 'static' === s ? e : t;
            this.defineClassElement(o, c);
          }
        }, this);
      }, this);
    },
    defineClassElement: function (e, c) {
      var t = c.descriptor;
      if ('field' === c.kind) {
        var d = c.initializer;
        t = {
      ...
      Object.defineProperty(e, c.key, t);
    },
    decorateClass: function (e, c) {
      var t = [],
        d = [],
      ...
      if (
        ...
        e.forEach(function (e) {
          if (!X(e)) return t.push(e);
          var c = this.decorateElement(e, s);
          t.push(c.element),
            t.push.apply(t, c.extras),
            d.push.apply(d, c.finishers);
        }, this),
        !c)
      )
        return { elements: t, finishers: d };
      var o = this.decorateConstructor(t, c);
      return d.push.apply(d, o.finishers), (o.finishers = d), o;
    },
    addElementPlacement: function (e, c, t) {
      var d = c[e.placement];
      if (!t && -1 !== d.indexOf(e.key))
        throw new TypeError('Duplicated element (' + e.key + ')');
      d.push(e.key);
    },
    decorateElement: function (e, c) {
      for (
        var t = [], d = [], s = e.decorators, o = s.length - 1;
        o >= 0;
        o--
      ) {
        var r = c[e.placement];
        r.splice(r.indexOf(e.key), 1);
        var i = this.fromElementDescriptor(e),
          a = this.toElementFinisherExtras((0, s[o])(i) || i);
        (e = a.element),
          this.addElementPlacement(e, c),
          a.finisher && d.push(a.finisher);
        var n = a.extras;
        if (n) {
          for (var l = 0; l < n.length; l++) this.addElementPlacement(n[l], c);
          t.push.apply(t, n);
        }
      }
      return { element: e, finishers: d, extras: t };
    },
    decorateConstructor: function (e, c) {
      for (var t = [], d = c.length - 1; d >= 0; d--) {
        var s = this.fromClassDescriptor(e),
          o = this.toClassDescriptor((0, c[d])(s) || s);
        if (
          (void 0 !== o.finisher && t.push(o.finisher), void 0 !== o.elements)
        ) {
          e = o.elements;
          for (var r = 0; r < e.length - 1; r++)
            for (var i = r + 1; i < e.length; i++)
              if (e[r].key === e[i].key && e[r].placement === e[i].placement)
                throw new TypeError('Duplicated element (' + e[r].key + ')');
        }
      }
    ...
    fromElementDescriptor: function (e) {
      ...
      return (
        ...
        'field' === e.kind && (c.initializer = e.initializer),
        c
      );
    },
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          var c = this.toElementDescriptor(e);
          return (
    ...
    runClassFinishers: function (e, c) {
    ...
    disallowProperty: function (e, c, t) {
      if (void 0 !== e[c])
        throw new TypeError(t + " can't have a ." + c + ' property.');
    },
  };
  return e;
}
function N(e) {
  var c,
    t = V(e.key);
  'method' === e.kind
    ? (c = { value: e.value, writable: !0, configurable: !0, enumerable: !1 })
    : 'get' === e.kind
    ? (c = { get: e.value, configurable: !0, enumerable: !1 })
    : 'set' === e.kind
    ? (c = { set: e.value, configurable: !0, enumerable: !1 })
    : 'field' === e.kind &&
      (c = { configurable: !0, writable: !0, enumerable: !0 });
  var d = {
...
function U(e, c) {
  void 0 !== e.descriptor.get
    ? (c.descriptor.get = e.descriptor.get)
    : (c.descriptor.set = e.descriptor.set);
}
function X(e) {
...
function Y(e, c) {
  ...
  if (void 0 !== t && 'function' != typeof t)
    throw new TypeError("Expected '" + c + "' to be a function");
  return t;
}
function V(e) {
  var c = (function (e, c) {
...
function G(e, c) {
  ...
  for (var t = 0, d = Array(c); t < c; t++) d[t] = e[t];
  return d;
}
function J() {
  return (
    (J =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, c, t) {
            var d = (function (e, c) {
              for (; !{}.hasOwnProperty.call(e, c) && null !== (e = K(e)); );
              return e;
            })(e, c);
            if (d) {
              var s = Object.getOwnPropertyDescriptor(d, c);
...
const { prefix: Q, stablePrefix: W } = s;
let ee,
  ce = (function (e, c, t, d) {
    var s = H();
    if (d) for (var o = 0; o < d.length; o++) s = d[o](s);
    var r = c(function (e) {
        s.initializeInstanceElements(e, i.elements);
      }, t),
      i = s.decorateClass(
        (function (e) {
          for (
            ...
            var s,
              o = e[d];
            if ('method' === o.kind && (s = c.find(t)))
              if (Z(o.descriptor) || Z(s.descriptor)) {
                if (X(o) || X(s))
                  throw new ReferenceError(
                    'Duplicated methods (' + o.key + ") can't be decorated."
                  );
                s.descriptor = o.descriptor;
              } else {
                if (X(o)) {
                  if (X(s))
                    throw new ReferenceError(
    ...
    return (
      s.initializeClassElements(r.F, i.elements),
      s.runClassFinishers(r.F, i.finishers)
    );
  })(
    [x(`${W}-locale-modal`)],
    function (e, c) {
      ...
      return {
        ...
        d: [
          ...
          {
            kind: 'method',
            key: '_handleClickBackButton',
            value: function (e) {
              e.preventDefault(), (this._currentRegion = void 0);
            },
          },
          {
            kind: 'method',
            key: '_handleClickRegionSelector',
            value: function (e) {
              const { disabled: c, name: t } = e.target;
              c || (this._currentRegion = t);
            },
          },
          {
            kind: 'method',
            decorators: [h('eventClose')],
            key: '_handleAfterClose',
            value: function () {
              this._currentRegion = void 0;
            },
          },
          {
            kind: 'method',
            key: '_setPrimaryFocus',
            value: async function () {
              const { selectorPrimaryFocus: e } = s,
                c = this.querySelector(e);
              c && ((c.tabIndex = 0), c.focus());
            },
          },
          {
            kind: 'method',
            key: '_setSearchFocus',
            value: async function () {
              const { selectorLocaleSearch: e } = s;
          ...
          {
            kind: 'method',
            key: '_renderRegionSelectorHeading',
            value: function () {
              const { headerTitle: e, langDisplay: c } = this;
              return t(
                F ||
                  (F = L`
      ${0}
    ...
    `),
      ...
      `),
                    ...
                    Q,
                    c,
                    j({ class: `${W}--locale-modal__label-globe` })
                  ),
                c &&
                  e &&
                  t(
      ...
      `),
          ...
          {
            kind: 'method',
            key: '_renderLocaleSelectorHeading',
            value: function () {
              const {
                headerTitle: e,
                _currentRegion: c,
                _handleClickBackButton: d,
              } = this;
              return t(
                O ||
                  (O = L`
    ...
    `),
                ...
                d,
                e,
                n({ slot: 'icon', class: `${W}--locale-modal__label-arrow` }),
                c
              );
            },
          },
          ...
          {
            kind: 'method',
            key: '_renderRegionSelectorBody',
            value: function () {
              const { _handleClickRegionSelector: e } = this;
              return t(
                R ||
                  (R = L`
      <div
    ...
    `),
          ...
          {
            kind: 'method',
            key: '_renderLocaleSelectorBody',
            value: function () {
              return t(B || (B = L` <slot name="locales-selector"></slot> `));
            },
          },
          {
            kind: 'method',
            key: '_renderHeader',
            value: function () {
              const { closeButtonAssistiveText: e } = this;
              return t(
                M ||
                  (M = L`
    ...
    `),
          ...
          {
            kind: 'field',
            decorators: [d({ attribute: 'close-button-assistive-text' })],
            key: 'closeButtonAssistiveText',
            value: void 0,
          },
          {
            kind: 'field',
            decorators: [d({ attribute: 'header-title' })],
            key: 'headerTitle',
            value: () => 'Select geographic area',
          },
          {
            kind: 'field',
            decorators: [d({ attribute: 'lang-display' })],
            key: 'langDisplay',
            value: void 0,
          },
          {
          ...
          },
          {
            ...
            value: async function (e) {
              if (
                ((function (e, c, t, d) {
                  var s = J(K(1 & d ? e.prototype : e), c, t);
                  return 2 & d && 'function' == typeof s
                    ? function (e) {
                        return s.apply(t, e);
                      }
                    : s;
                ...
                e.has('_currentRegion'))
              ) {
                this.dispatchEvent(
                  new CustomEvent(this.constructor.eventRegionUpdated, {
                    bubbles: !0,
                    composed: !0,
                    cancelable: !0,
                    detail: { region: this._currentRegion },
                  })
                );
                const { selectorLocaleSearch: e } = this.constructor,
                  t = this.querySelector(e);
                var c;
                if (t)
                  t.region =
                    null !== (c = this._currentRegion) && void 0 !== c ? c : '';
                this._currentRegion
                  ? this._setSearchFocus()
                  : this._setPrimaryFocus();
              }
            },
          },
          {
            ...
            key: 'stableSelector',
            value: function () {
              return `${W}--locale-modal`;
            },
          },
          {
            kind: 'get',
            static: !0,
            key: 'selectorLocaleSearch',
            value: function () {
              return `${W}-locale-search`;
            },
          },
          {
            kind: 'get',
          ...
          },
          {
            kind: 'get',
            static: !0,
            key: 'eventRegionUpdated',
            value: function () {
              return `${W}-locale-modal-region-updated`;
            },
          },
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return le(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (ie(o.descriptor) || ie(s.descriptor)) {
              if (re(o) || re(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
      ...
      d: [
        {
          ...
          key: 'slot',
          value: () => 'regions-selector',
        },
        {
          kind: 'method',
          key: 'render',
          value: function () {
            return t(ee || (ee = te` <slot></slot> `));
          },
        },
        {
          kind: 'get',
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return we(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
  ...
  return (
    (ze =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, c, t) {
            var d = (function (e, c) {
              for (; !{}.hasOwnProperty.call(e, c) && null !== (e = Ee(e)); );
              return e;
            })(e, c);
            if (d) {
              var s = Object.getOwnPropertyDescriptor(d, c);
...
const { prefix: Pe, stablePrefix: Te } = s;
function Se(e, c, t) {
  return (
    (c = (function (e) {
      var c = (function (e, c) {
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (_e(o.descriptor) || _e(s.descriptor)) {
              if (ye(o) || ye(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
  ...
  function (e, s) {
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            const { _classes: e, _cardClasses: c } = this;
            return t(
              ge ||
                (ge = me`
      <button
    ...
    `),
        ...
        },
        {
          ...
          key: 'render',
          value: function () {
            const { _classes: e, disabled: c, _cardClasses: d } = this;
            return c
        ...
        },
        {
          ...
          value: function (e) {
            if (e.has('name')) {
              const { name: e } = this;
              this.dataset.autoId = `${Te}--locale-modal__geo-btn-${e}`;
            }
          },
        },
        {
    ...
    `),
              (function (e, c, t, d) {
                var s = ze(Ee(1 & d ? e.prototype : e), c, t);
                return 2 & d && 'function' == typeof s
                  ? function (e) {
                      return s.apply(t, e);
                    }
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return Re(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
...
function Be(e, c, t, d) {
  var s = Me(Le(1 & d ? e.prototype : e), c, t);
  return 2 & d && 'function' == typeof s
    ? function (e) {
        return s.apply(t, e);
      }
  ...
  return (
    (Me =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, c, t) {
            var d = (function (e, c) {
              for (; !{}.hasOwnProperty.call(e, c) && null !== (e = Le(e)); );
              return e;
            })(e, c);
            if (d) {
              var s = Object.getOwnPropertyDescriptor(d, c);
...
const { prefix: He, stablePrefix: Ne } = s;
!(function (e, c, t, d) {
  var s = De();
  if (d) for (var o = 0; o < d.length; o++) s = d[o](s);
  var r = c(function (e) {
  ...
  function (e, c) {
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [T(`.${Ne}--locale-modal__list`)],
          key: '_listNode',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [b()],
          key: '_hasAvailableItem',
          value: () => !0,
        },
        {
          kind: 'field',
          decorators: [T(`${He}-search`)],
          key: '_searchNode',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [T('[aria-live]')],
          key: '_liveRegion',
          value: void 0,
        },
        {
          ...
          value: function (e) {
            const { selectorItem: c } = this.constructor,
              { region: t, _liveRegion: d } = this;
            let s = 0;
            if (
              (A(this.querySelectorAll(c), (c) => {
                const { country: d, language: o, region: r } = c,
                  i =
                    r === t &&
                    (function (e, c) {
                      return (
                        ...
                        e.some(
                          (e) =>
                            e && e.toLowerCase().indexOf(c.toLowerCase()) >= 0
                        )
                      );
                    })([d, o], e);
                i && s++, (c.hidden = !i);
              }),
              (this._hasAvailableItem = s > 0),
              d)
            ) {
              const e = 1 === s ? `${s} result` : `${s} results`;
              d.innerText = e;
            }
          },
        },
        {
          kind: 'method',
          key: '_handleThrottledInput',
          value: function (e) {
            this._updateSearchResults(e.detail.value);
          },
        },
        {
          kind: 'field',
          decorators: [d({ attribute: 'availability-label-text' })],
          key: 'availabilityLabelText',
          value: () =>
        ...
        {
          kind: 'field',
          decorators: [d({ type: Number, attribute: 'input-timeout' })],
          key: 'inputTimeout',
          value: () => 200,
        },
        {
          kind: 'field',
          decorators: [d({ attribute: 'label-text' })],
          key: 'labelText',
          value: () => '',
        },
        {
        ...
        { kind: 'field', decorators: [d()], key: 'region', value: () => '' },
        {
          kind: 'field',
          decorators: [d({ reflect: !0 })],
          key: 'slot',
          value: () => 'locales-selector',
        },
        {
          kind: 'field',
          decorators: [d({ attribute: 'unavailability-label-text' })],
          key: 'unavailabilityLabelText',
          value: () =>
        ...
        },
        {
          ...
          key: 'focus',
          value: function () {
            if (this.shadowRoot.delegatesFocus) Be(s, 'focus', this, 3)([]);
            else {
              const { selectorTabable: e } = this.constructor,
                c = this.shadowRoot.querySelector(e);
              c ? c.focus() : Be(s, 'focus', this, 3)([]);
            }
          },
        },
        {
          ...
          key: 'reset',
          value: function () {
            const { _listNode: e, _searchNode: c } = this;
            e && (e.scrollTop = 0),
              c && ((c.value = ''), this._updateSearchResults(''));
          },
        },
        {
          kind: 'method',
          key: 'firstUpdated',
          value: function () {
            const { _searchNode: e } = this;
            e && this._updateSearchResults(e.value);
          },
        },
        {
          kind: 'method',
        ...
        },
        {
          ...
          value: function () {
            const {
              availabilityLabelText: e,
              closeButtonAssistiveText: c,
              labelText: d,
              placeholder: s,
              unavailabilityLabelText: o,
              _hasAvailableItem: r,
            } = this;
            return t(
              Ce ||
  ...
  ((e) => {
    class c extends e {
      constructor(...e) {
        super(...e),
          Se(this, '_hInputToBeThrottled', null),
          Se(this, '_throttledHandleInput', null);
      }
      _invokeHandleThrottledInput(e) {
        var c;
        null === (c = this._throttledHandleInput) ||
          void 0 === c ||
          c.call(this, e);
      }
      _updateThrottledHandleInput() {
        this._throttledHandleInput &&
          (this._throttledHandleInput.cancel(),
          (this._throttledHandleInput = null)),
          (this._throttledHandleInput = C(
      ...
      connectedCallback() {
        ...
        const { eventInput: e } = this.constructor;
        (this._hInputToBeThrottled = u(
          this,
          e,
          this._invokeHandleThrottledInput
        )),
      ...
      disconnectedCallback() {
        this._throttledHandleInput &&
          (this._throttledHandleInput.cancel(),
          (this._throttledHandleInput = null)),
          this._hInputToBeThrottled &&
            (this._hInputToBeThrottled = this._hInputToBeThrottled.release()),
          super.disconnectedCallback();
      }
      updated(e) {
        e.has('inputTimeout') && this._updateThrottledHandleInput();
      }
    }
    return Se(c, 'eventInput', 'input'), c;
  })(z(o))
);
let Ue,
  Xe = (e) => e;
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (Je(o.descriptor) || Je(s.descriptor)) {
              if (Ge(o) || Ge(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: '_renderInner',
          value: function () {
            const { country: e, language: c } = this;
            return t(
              Ue ||
                (Ue = Xe`
...
var cc = c([
  ':host(c4d-locale-modal-composite),:host(c4d-locale-modal-container){display:contents}',
]);
let tc,
  dc,
  sc,
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return mc(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
...
const { stablePrefix: fc } = s;
let bc = (function (e, c, t, d) {
  var s = ac();
  if (d) for (var o = 0; o < d.length; o++) s = d[o](s);
  var r = c(function (e) {
      s.initializeInstanceElements(e, i.elements);
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (gc(o.descriptor) || gc(s.descriptor)) {
              if (pc(o) || pc(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
  ...
  function (e, c) {
      ...
      d: [
        {
          ...
          value: function (e) {
            return e.sort((e, c) =>
              this.collatorCountryName.compare(e.name, c.name)
            );
          },
        },
        {
        ...
        { kind: 'field', decorators: [d()], key: 'language', value: void 0 },
        {
          kind: 'field',
          decorators: [d({ attribute: !1 })],
          key: 'localeList',
        ...
        {
          kind: 'method',
          decorators: [h(ce.eventRegionUpdated)],
          key: '_handleRegionUpdatedEvent',
          value: function (e) {
            this.chosenRegion = e.detail.region || void 0;
          },
        },
        {
          kind: 'method',
        ...
        },
        {
          ...
          value: function () {
            var e;
            const { language: c } = this;
            var t;
            c &&
              (null === (t = this._setLanguage) ||
                void 0 === t ||
                t.call(this, c));
            null === (e = this._loadLocaleList) ||
              void 0 === e ||
              e.call(this, c),
              this.getLangDisplay().then((e) => {
                this.langDisplay = e;
              });
          },
        },
        ...
        },
        {
          ...
          value: function () {
            const {
              ...
              { localeModal: o, regionList: i } = null != d ? d : {},
              {
                availabilityText: a,
                headerTitle: n,
                modalClose: h,
              ...
              v =
                ...
                g.document &&
                  g.document
                    ...
                    .forEach(function (e) {
                      y[e.getAttribute('hreflang')] = e.getAttribute('href');
                    }),
                y);
            var y;
            if (
            ...
            const _ =
              null == i
                ? void 0
                : i.reduce(
                    (e, { countryList: c, name: t }) => (
                      this._sortCountries(c).forEach(
                        ({ name: c, locale: d }) => {
                          d.forEach(([d, s]) => {
                            const o = v[d];
                            o &&
    ...
    `),
            ...
            `),
                      ...
                      d,
                      d
                        ? p({ slot: 'icon', class: `${fc}--card__cta` })
                        : l({ slot: 'icon', class: `${fc}--card__cta` })
                    );
                  }),
              r(u),
              r(m),
        ...
        },
        {
          ...
          key: 'render',
          value: function () {
            return t(rc || (rc = ic` <slot></slot> `));
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => cc },
      ],
    };
  },
  m(f(o))
);
export { bc as C, j as s };
