...
import { x as e, s as t, a as r } from './query-assigned-elements.js';
import { B as i } from './button2.js';
import { s as n } from './button-group-item.js';
  ...
  var e = {
    ...
    decorateElement: function (e, t) {
      for (
        ...
        var c = l.extras;
        if (c) {
          for (var u = 0; u < c.length; u++) this.addElementPlacement(c[u], t);
          r.push.apply(r, c);
        }
      }
      ...
      d: [
        {
          ...
          value: function (e) {
            const t = e.target
              .assignedNodes()
              .filter((e) => void 0 !== e.matches);
            t.forEach((e, t) => {
              e.setAttribute('kind', 0 === t ? i.PRIMARY : i.TERTIARY);
            });
            const { customPropertyItemCount: r } = this.constructor;
            this.style.setProperty(r, String(t.length));
            const n = new CustomEvent(`${k}-button-group-update`, {
              bubbles: !0,
              cancelable: !0,
              composed: !0,
            });
        ...
        },
        {
          ...
          value: function () {
            return `--${k}--button-group--item-count`;
          },
        },
        {
          kind: 'get',
          ...
          key: 'selectorItem',
          value: function () {
            return `${k}-button-group-item`;
          },
        },
        {
          kind: 'get',
          static: !0,
          key: 'selectorItemDefaultCTA',
          value: function () {
            return `${k}-cta`;
          },
        },
