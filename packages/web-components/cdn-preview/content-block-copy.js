...
import { n as e, i as t, s as r } from './query-assigned-elements.js';
import { S as i } from './stable-selector.js';
import { C as n } from './markdown.js';
import { a as o } from './content-block.js';
import './content-block-paragraph.js';
...
function b(e, t, r, i) {
  var n = k(g(1 & i ? e.prototype : e), t, r);
      ...
      (function (e) {
        for (
          ...
          if ('method' === o.kind && (n = t.find(r)))
            if (m(o.descriptor) || m(n.descriptor)) {
              if (u(o) || u(n))
      ...
      d: [
        {
          ...
          key: '_customTags',
          value: function () {
            const e = new Set(b(n, '_customTags', this, 1));
            return e.add(`${w}-content-block-paragraph`), e;
          },
        },
        {
          kind: 'get',
          ...
          value: function () {
            return (
              ...
              Object.assign(b(n, '_renderer', this, 1), {
                paragraph: (e) =>
                  `<${w}-content-block-paragraph part="content-block-paragraph">${e}</${w}-content-block-paragraph>`,
              })
            );
          },
        },
