  ...
  var e = {
    ...
    decorateElement: function (e, c) {
      for (
        ...
        var r = this.fromElementDescriptor(e),
          a = this.toElementFinisherExtras((0, s[o])(r) || r);
        (e = a.element),
        ...
        if (
          ...
          for (var i = 0; i < e.length - 1; i++)
            for (var r = i + 1; r < e.length; r++)
              if (e[i].key === e[r].key && e[i].placement === e[r].placement)
...
const { prefix: E, stablePrefix: P } = d;
!(function (e, c, t, d) {
  var s = b();
  if (d) for (var o = 0; o < d.length; o++) s = d[o](s);
  var i = c(function (e) {
      s.initializeInstanceElements(e, r.elements);
    }, t),
    r = s.decorateClass(
      (function (e) {
        for (
          ...
          if ('method' === o.kind && (s = c.find(t)))
            if (y(o.descriptor) || y(s.descriptor)) {
              if (_(o) || _(s))
  ...
  s.initializeClassElements(i.F, r.elements),
    s.runClassFinishers(i.F, r.finishers);
})(
  [i(`${P}-content-item-row`)],
  function (e, d) {
    return {
      F: class extends d {
        constructor(...c) {
      ...
      d: [
        ...
        },
        {
          ...
          key: '_renderMedia',
          value: function () {
            return t(h || (h = v` <slot name="media"></slot> `));
          },
        },
        {
          kind: 'method',
              ...
              this.thumbnail
                ? t(
                    u ||
                      (u = v`
            <div
              class="${0}--content-item-row__body-wrapper"
              part="body-wrapper">
              <div
                class="${0}--content-item-row__heading-wrapper"
                part="heading-wrapper">
                <slot name="heading"></slot>
              </div>
              <div
                class="${0}--content-item-row__content-wrapper"
                part="content-wrapper">
                ${0}${0}
              </div>
            </div>
            <div class="${0}--content-item-row__col--2" part="col col--2">
              <slot name="thumbnail" @slotchange="${0}">
              </slot>
            </div>
          `),
                    E,
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return I(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (F(o.descriptor) || F(s.descriptor)) {
              if (j(o) || j(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${B}--content-item-row-copy`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => p },
      ],
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (H(o.descriptor) || H(s.descriptor)) {
              if (U(o) || U(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${G}--content-item-row-eyebrow`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => p },
      ],
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return se(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
...
!(function (e, c, t, d) {
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (ce(o.descriptor) || ce(s.descriptor)) {
              if (ee(o) || ee(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
  ...
  [i(`${oe}-content-item-row-media-copy`)],
  function (e, c) {
    return {
      F: class extends c {
        constructor(...c) {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${oe}--content-item-row-media-copy`;
          },
        },
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return ue(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
...
!(function (e, c, t, d) {
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (he(o.descriptor) || he(s.descriptor)) {
              if (pe(o) || pe(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
  ...
  [i(`${ve}-content-item-row-media-video`)],
  function (e, d) {
    return {
      F: class extends d {
        constructor(...c) {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${ve}--content-item-row-media-video`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => n },
      ],
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return Pe(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
...
!(function (e, c, t, d) {
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (we(o.descriptor) || we(s.descriptor)) {
              if (xe(o) || xe(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
  ...
  [i(`${Ce}-content-item-row-thumbnail-copy`)],
  function (e, c) {
    return {
      F: class extends c {
        constructor(...c) {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${Ce}--content-item-row-thumbnail-copy`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => p },
      ],
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return Be(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
...
const { prefix: Me, stablePrefix: Re } = d;
!(function (e, c, t, d) {
  var s = Te();
  if (d) for (var o = 0; o < d.length; o++) s = d[o](s);
  var i = c(function (e) {
      ...
      (function (e) {
        for (
          ...
          var s,
            o = e[d];
          if ('method' === o.kind && (s = c.find(t)))
            if (Oe(o.descriptor) || Oe(s.descriptor)) {
              if (Fe(o) || Fe(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
  ...
  [i(`${Re}-content-item-row-media-featured`)],
  function (e, c) {
    return {
      F: class extends c {
        constructor(...c) {
      ...
      d: [
        {
          ...
          value: function () {
            return t(
              De ||
                (De = Ae`
      <div class="${0}--content-item-row__row" part="row row--eyebrow">
        <div class="${0}--content-item-row__col" part="col col--eyebrow">
          <slot name="eyebrow" @slotchange="${0}"></slot>
          <slot name="heading"></slot>
        </div>
        <div class="${0}--content-item-row__col" part="col col--body">
          ${0} ${0}
        </div>
      </div>
      <div class="${0}--content-item-row__row" part="row row--media">
    ...
    `),
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${Re}-content-item-row-media-featured`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => n },
      ],
