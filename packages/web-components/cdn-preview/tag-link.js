  ...
  var s = {
    ...
    initializeClassElements: function (s, d) {
      ...
      ['method', 'field'].forEach(function (n) {
        d.forEach(function (d) {
          var i = d.placement;
          if (d.kind === n && ('static' === i || 'prototype' === i)) {
            var t = 'static' === i ? s : c;
            this.defineClassElement(t, d);
          }
        }, this);
      }, this);
    },
    defineClassElement: function (s, d) {
      ...
      if ('field' === d.kind) {
        ...
        c = {
          ...
          value: void 0 === n ? void 0 : n.call(s),
        };
      }
      Object.defineProperty(s, d.key, c);
    },
    decorateClass: function (s, d) {
      ...
      if (
        (s.forEach(function (s) {
          this.addElementPlacement(s, i);
        }, this),
        s.forEach(function (s) {
          if (!p(s)) return c.push(s);
          var d = this.decorateElement(s, i);
          c.push(d.element),
            c.push.apply(c, d.extras),
            n.push.apply(n, d.finishers);
        }, this),
        !d)
      )
        return { elements: c, finishers: n };
      var t = this.decorateConstructor(c, d);
      return n.push.apply(n, t.finishers), (t.finishers = n), t;
    },
    addElementPlacement: function (s, d, c) {
      var n = d[s.placement];
      if (!c && -1 !== n.indexOf(s.key))
        throw new TypeError('Duplicated element (' + s.key + ')');
      n.push(s.key);
    },
    decorateElement: function (s, d) {
      for (
        var c = [], n = [], i = s.decorators, t = i.length - 1;
        t >= 0;
        t--
      ) {
        var o = d[s.placement];
        o.splice(o.indexOf(s.key), 1);
        var r = this.fromElementDescriptor(s),
          l = this.toElementFinisherExtras((0, i[t])(r) || r);
        (s = l.element),
          this.addElementPlacement(s, d),
          l.finisher && n.push(l.finisher);
        var e = l.extras;
        if (e) {
          for (var a = 0; a < e.length; a++) this.addElementPlacement(e[a], d);
          c.push.apply(c, e);
        }
      }
      return { element: s, finishers: n, extras: c };
    },
    decorateConstructor: function (s, d) {
      for (var c = [], n = d.length - 1; n >= 0; n--) {
        var i = this.fromClassDescriptor(s),
          t = this.toClassDescriptor((0, d[n])(i) || i);
        if (
          (void 0 !== t.finisher && c.push(t.finisher), void 0 !== t.elements)
        ) {
          s = t.elements;
          for (var o = 0; o < s.length - 1; o++)
            for (var r = o + 1; r < s.length; r++)
              if (s[o].key === s[r].key && s[o].placement === s[r].placement)
                throw new TypeError('Duplicated element (' + s[o].key + ')');
        }
      }
      return { elements: s, finishers: c };
    },
        ...
        (function (s) {
          ...
          (function (s, d) {
            if (s) {
              ...
              return (
                'Object' === c && s.constructor && (c = s.constructor.name),
                'Map' === c || 'Set' === c
                  ? Array.from(s)
                  : 'Arguments' === c ||
    ...
    toClassDescriptor: function (s) {
      ...
      var c = y(s, 'finisher');
      return { elements: this.toElementDescriptors(s.elements), finisher: c };
    },
    ...
    disallowProperty: function (s, d, c) {
      if (void 0 !== s[d])
        throw new TypeError(c + " can't have a ." + d + ' property.');
    },
  };
  return s;
}
function g(s) {
  ...
  return (
    s.decorators && (n.decorators = s.decorators),
    'field' === s.kind && (n.initializer = s.value),
    n
  );
}
function u(s, d) {
...
function x(s, d) {
  ...
  for (var c = 0, n = Array(d); c < d; c++) n[c] = s[c];
  return n;
}
const { prefix: v, stablePrefix: b } = n;
let k = (function (s, d, c, n) {
  var i = m();
  if (n) for (var t = 0; t < n.length; t++) i = n[t](i);
  var o = d(function (s) {
      i.initializeInstanceElements(s, r.elements);
    }, c),
    r = i.decorateClass(
      (function (s) {
        for (
          ...
          var i,
            t = s[n];
          if ('method' === t.kind && (i = d.find(c)))
            if (h(t.descriptor) || h(i.descriptor)) {
              if (p(t) || p(i))
                throw new ReferenceError(
                  'Duplicated methods (' + t.key + ") can't be decorated."
                );
              i.descriptor = t.descriptor;
            } else {
              if (p(t)) {
                if (p(i))
                  throw new ReferenceError(
  ...
  return (
    i.initializeClassElements(o.F, r.elements),
    i.runClassFinishers(o.F, r.finishers)
  );
})(
  [r(`${b}-tag-link`)],
  function (s, n) {
    return {
      ...
      d: [
        ...
        {
          kind: 'field',
          decorators: [d({ attribute: 'link-role' })],
          key: 'linkRole',
          value: void 0,
        },
        {
        ...
        { kind: 'method', key: '_handleClick', value: function (s) {} },
        {
          kind: 'method',
          key: 'render',
          value: function () {
...
console.warn(
  'The tag-link component has been deprecated in favor of using cds-tag components. See cds-tag documentation in @carbon/web-components for more information.'
);
export { k as C };
