...
import { s as n } from './leadspace2.js';
  ...
  return (
    (v =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, t, r) {
            var i = (function (e, t) {
              for (; !{}.hasOwnProperty.call(e, t) && null !== (e = b(e)); );
              return e;
            })(e, t);
            if (i) {
  ...
  function (r, i) {
    ...
    return {
      ...
      d: [
        ...
        {
          kind: 'field',
          decorators: [e({ reflect: !0, attribute: 'type-style' })],
          key: 'typeStyle',
          value: () => 'display-01',
        },
        { kind: 'field', decorators: [e()], key: 'content', value: void 0 },
        {
          kind: 'method',
          key: 'connectedCallback',
          value: function () {
            var e, t, r, i, n;
            this.hasAttribute('role') || this.setAttribute('role', 'heading'),
              this.hasAttribute('aria-level') ||
                this.setAttribute('aria-level', '1'),
              ((e = o),
              (t = 'connectedCallback'),
              (r = this),
              (n = v(b(1 & (i = 3) ? e.prototype : e), t, r)),
        ...
        },
        {
          ...
          value: function (e) {
            ...
            if (((r.textContent = t), e.has('highlight') && this.highlight)) {
              const e = t.indexOf(this.highlight);
              if (-1 !== e) {
                const i = t.substring(0, e),
                  n = document.createElement('span');
                n.textContent = this.highlight;
                const o = t.substring(e + this.highlight.length);
                this.replaceChildren(i, n, o, r);
              }
            } else this.replaceChildren(t, r);
          },
        },
        {
          kind: 'method',
          key: 'render',
          value: function () {
            return t(a || (a = l` <h1 part="heading"><slot></slot></h1> `));
          },
        },
        {
          kind: 'get',
