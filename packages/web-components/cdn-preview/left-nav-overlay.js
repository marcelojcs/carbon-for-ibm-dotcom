...
import { s as n } from './masthead-container.js';
import './pickBy.js';
import './toNumber.js';
import './store.js';
import './index.js';
      ...
      (function (e) {
        for (
          ...
          if ('method' === n.kind && (o = t.find(r)))
            if (f(n.descriptor) || f(o.descriptor)) {
              if (d(n) || d(o))
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            ...
            (t = 'connectedCallback'),
            (r = this),
            (n = y(v(1 & (i = 3) ? e.prototype : e), t, r)),
            2 & i && 'function' == typeof n
              ? function (e) {
                  return n.apply(r, e);
                }
              : n)([]),
              this.closest('[dir]') && (this.dir = this.closest('[dir]').dir);
          },
        },
        {
          kind: 'method',
