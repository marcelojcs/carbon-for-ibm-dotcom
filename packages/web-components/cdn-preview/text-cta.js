...
import { C as n, f as o, a } from './formatVideoCaption.js';
      ...
      d: [
        ...
        },
        {
          ...
          value: function ({ target: e }) {
            this._hasContent = e.assignedNodes().some((e) => {
              var t;
              return (
        ...
        },
        {
          ...
          key: '_renderContent',
          value: function () {
            const { ctaType: t, _hasContent: r } = this;
            if (t !== n.VIDEO)
            ...
            const {
              ...
              c = r
                ? void 0
                : a({ duration: s({ duration: i ? 1e3 * i : i }), name: o });
            return e(
              p ||
                (p = u`
      <span
