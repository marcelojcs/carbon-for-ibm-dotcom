...
import { C as t } from './content-section.js';
...
!(function (c, e, d, t) {
  ...
  var p = e(function (c) {
      s.initializeInstanceElements(c, g.elements);
    }, d),
    g = s.decorateClass(
      (function (c) {
        for (
  ...
  s.initializeClassElements(p.F, g.elements),
    s.runClassFinishers(p.F, g.finishers);
})(
  [s(`${m}-card-section-simple`)],
  function (c, e) {
    return {
      F: class extends e {
        constructor(...e) {
  ...
  console.warn(
    'The card-section-simple component has been deprecated in favor of the content-section/block component combined with card-group. See content-section/block and card group documentation for more information.'
  );
