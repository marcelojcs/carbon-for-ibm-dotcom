...
import { S as o } from './StickyHeader.js';
...
import { C as K } from './content-block-paragraph.js';
import './search-with-typeahead.js';
import './scoped-search-dropdown-mobile.js';
import './spread.js';
import './directive.js';
import './32.js';
import './image.js';
...
import './leadspace.js';
import './leadspace2.js';
import './content-block2.js';
import './dropdown.js';
import './163.js';
import './form.js';
import './validity.js';
 ...
 */ let Z = (function (e) {
    return (
      (e.WHITE_AND_G10 = 'white-and-g10'),
      (e.G10_AND_WHITE = 'g10-and-white'),
      (e.G90_AND_G100 = 'g90-and-g100'),
      (e.G100_AND_G90 = 'g100-and-g90'),
      (e.MONOTHEME = ''),
      e
    );
  })({}),
  Q = (function (e) {
    return (e.MONOTHEME = ''), (e.DUAL_THEME = 'dual-theme'), e;
  })({});
const Y = '#000000',
  J = '#ffffff',
  ee = '#e8e8e8',
  ...
  Ze = '#333333',
  Qe = (e, c) => {
    const t = [e.substring(1, 3), e.substring(3, 5), e.substring(5, 7)].map(
      (e) => parseInt(e, 16)
    );
    return `rgba(${t[0]}, ${t[1]}, ${t[2]}, ${c})`;
  };
var Ye = { exports: {} },
  Je = {
  ...
  tc = Array.prototype.concat,
  dc = Array.prototype.slice,
  sc = (ec.exports = function (e) {
    for (var c = [], t = 0, d = e.length; t < d; t++) {
      var s = e[t];
      cc(s) ? (c = tc.call(c, dc.call(s))) : c.push(s);
    }
    return c;
  });
sc.wrap = function (e) {
  return function () {
    return e(sc(arguments));
  };
};
var ac = Je,
  ic = ec.exports,
  oc = Object.hasOwnProperty,
  rc = Object.create(null);
for (var nc in ac) oc.call(ac, nc) && (rc[ac[nc]] = nc);
var lc = (Ye.exports = { to: {}, get: {} });
function gc(e, c, t) {
  return Math.min(Math.max(c, e), t);
}
function hc(e) {
  var c = Math.round(e).toString(16).toUpperCase();
...
(lc.get = function (e) {
  ...
  switch (e.substring(0, 3).toLowerCase()) {
    case 'hsl':
      (c = lc.get.hsl(e)), (t = 'hsl');
      break;
    case 'hwb':
      (c = lc.get.hwb(e)), (t = 'hwb');
      break;
    default:
      (c = lc.get.rgb(e)), (t = 'rgb');
  }
  return c ? { model: t, value: c } : null;
}),
  (lc.get.rgb = function (e) {
    if (!e) return null;
    var c,
      t,
      d,
      s = [0, 0, 0, 1];
    if ((c = e.match(/^#([a-f0-9]{6})([a-f0-9]{2})?$/i))) {
      for (d = c[2], c = c[1], t = 0; t < 3; t++) {
        var a = 2 * t;
        s[t] = parseInt(c.slice(a, a + 2), 16);
      }
      d && (s[3] = parseInt(d, 16) / 255);
    } else if ((c = e.match(/^#([a-f0-9]{3,4})$/i))) {
      for (d = (c = c[1])[3], t = 0; t < 3; t++)
        s[t] = parseInt(c[t] + c[t], 16);
      ...
      for (t = 0; t < 3; t++) s[t] = parseInt(c[t + 1], 0);
      c[4] &&
        (c[5] ? (s[3] = 0.01 * parseFloat(c[4])) : (s[3] = parseFloat(c[4])));
    } else {
      if (
        !(c = e.match(
        ...
        return (c = e.match(/^(\w+)$/))
          ? 'transparent' === c[1]
            ...
            : null
          : null;
      for (t = 0; t < 3; t++) s[t] = Math.round(2.55 * parseFloat(c[t + 1]));
      c[4] &&
        (c[5] ? (s[3] = 0.01 * parseFloat(c[4])) : (s[3] = parseFloat(c[4])));
    }
    for (t = 0; t < 3; t++) s[t] = gc(s[t], 0, 255);
    return (s[3] = gc(s[3], 0, 1)), s;
  }),
  (lc.get.hsl = function (e) {
    if (!e) return null;
    var c = e.match(
      /^hsla?\(\s*([+-]?(?:\d{0,3}\.)?\d+)(?:deg)?\s*,?\s*([+-]?[\d\.]+)%\s*,?\s*([+-]?[\d\.]+)%\s*(?:[,|\/]\s*([+-]?(?=\.\d|\d)(?:0|[1-9]\d*)?(?:\.\d*)?(?:[eE][+-]?\d+)?)\s*)?\)$/
    );
    if (c) {
      var t = parseFloat(c[4]);
      return [
        ((parseFloat(c[1]) % 360) + 360) % 360,
        gc(parseFloat(c[2]), 0, 100),
        gc(parseFloat(c[3]), 0, 100),
        gc(isNaN(t) ? 1 : t, 0, 1),
      ];
    }
    return null;
  }),
  (lc.get.hwb = function (e) {
    if (!e) return null;
    var c = e.match(
  ...
  (lc.to.rgb.percent = function () {
    var e = ic(arguments),
      c = Math.round((e[0] / 255) * 100),
      t = Math.round((e[1] / 255) * 100),
      d = Math.round((e[2] / 255) * 100);
    return e.length < 4 || 1 === e[3]
      ? 'rgb(' + c + '%, ' + t + '%, ' + d + '%)'
      : 'rgba(' + c + '%, ' + t + '%, ' + d + '%, ' + e[3] + ')';
  }),
  ...
  (lc.to.hwb = function () {
    var e = ic(arguments),
      c = '';
    return (
      e.length >= 4 && 1 !== e[3] && (c = ', ' + e[3]),
      'hwb(' + e[0] + ', ' + e[1] + '%, ' + e[2] + '%' + c + ')'
    );
  }),
  (lc.to.keyword = function (e) {
    return rc[e.slice(0, 3)];
  });
const pc = Je,
  fc = {};
for (const e of Object.keys(pc)) fc[pc[e]] = e;
const uc = {
...
for (const e of Object.keys(uc)) {
  ...
  if (uc[e].labels.length !== uc[e].channels)
    throw new Error('channel and label counts mismatch: ' + e);
  const { channels: c, labels: t } = uc[e];
  delete uc[e].channels,
    delete uc[e].labels,
    Object.defineProperty(uc[e], 'channels', { value: c }),
    Object.defineProperty(uc[e], 'labels', { value: t });
}
function bc(e, c) {
  return (e[0] - c[0]) ** 2 + (e[1] - c[1]) ** 2 + (e[2] - c[2]) ** 2;
}
(uc.rgb.hsl = function (e) {
  const c = e[0] / 255,
    t = e[1] / 255,
    d = e[2] / 255,
    s = Math.min(c, t, d),
  ...
  const n = (s + a) / 2;
  return (
    (r = a === s ? 0 : n <= 0.5 ? i / (a + s) : i / (2 - a - s)),
    [o, 100 * r, 100 * n]
  );
}),
  (uc.rgb.hsv = function (e) {
    let c, t, d, s, a;
    const i = e[0] / 255,
      o = e[1] / 255,
      r = e[2] / 255,
  ...
  (uc.rgb.hwb = function (e) {
    const c = e[0],
      t = e[1];
    let d = e[2];
    const s = uc.rgb.hsl(e)[0],
      a = (1 / 255) * Math.min(c, Math.min(t, d));
    return (
      (d = 1 - (1 / 255) * Math.max(c, Math.max(t, d))), [s, 100 * a, 100 * d]
    );
  }),
  (uc.rgb.cmyk = function (e) {
    const c = e[0] / 255,
      t = e[1] / 255,
      d = e[2] / 255,
      s = Math.min(1 - c, 1 - t, 1 - d);
    return [
      100 * ((1 - c - s) / (1 - s) || 0),
      100 * ((1 - t - s) / (1 - s) || 0),
      100 * ((1 - d - s) / (1 - s) || 0),
  ...
  (uc.rgb.keyword = function (e) {
    const c = fc[e];
    if (c) return c;
    let t,
      d = 1 / 0;
    for (const c of Object.keys(pc)) {
      const s = bc(e, pc[c]);
      s < d && ((d = s), (t = c));
    }
    return t;
  }),
  (uc.keyword.rgb = function (e) {
    return pc[e];
  }),
  (uc.rgb.xyz = function (e) {
    let c = e[0] / 255,
      t = e[1] / 255,
      d = e[2] / 255;
    ...
    return [
      100 * (0.4124 * c + 0.3576 * t + 0.1805 * d),
      100 * (0.2126 * c + 0.7152 * t + 0.0722 * d),
      100 * (0.0193 * c + 0.1192 * t + 0.9505 * d),
    ];
  }),
  (uc.rgb.lab = function (e) {
    const c = uc.rgb.xyz(e);
    let t = c[0],
      d = c[1],
      s = c[2];
    (t /= 95.047),
    ...
    return [116 * d - 16, 500 * (t - d), 200 * (d - s)];
  }),
  (uc.hsl.rgb = function (e) {
    const c = e[0] / 360,
      t = e[1] / 100,
      d = e[2] / 100;
    let s, a, i;
    if (0 === t) return (i = 255 * d), [i, i, i];
    s = d < 0.5 ? d * (1 + t) : d + t - d * t;
    const o = 2 * d - s,
      r = [0, 0, 0];
    for (let e = 0; e < 3; e++)
      (a = c + (1 / 3) * -(e - 1)),
  ...
  (uc.hsl.hsv = function (e) {
    const c = e[0];
    let t = e[1] / 100,
      d = e[2] / 100,
      s = t;
    const a = Math.max(d, 0.01);
    (d *= 2), (t *= d <= 1 ? d : 2 - d), (s *= a <= 1 ? a : 2 - a);
    return [
      c,
      100 * (0 === d ? (2 * s) / (a + s) : (2 * t) / (d + t)),
      100 * ((d + t) / 2),
    ];
  }),
  (uc.hsv.rgb = function (e) {
    const c = e[0] / 60,
      t = e[1] / 100;
    let d = e[2] / 100;
    const s = Math.floor(c) % 6,
      a = c - Math.floor(c),
      i = 255 * d * (1 - t),
      o = 255 * d * (1 - t * a),
      r = 255 * d * (1 - t * (1 - a));
  ...
  (uc.hwb.rgb = function (e) {
    ...
    return [255 * n, 255 * l, 255 * g];
  }),
  (uc.cmyk.rgb = function (e) {
    const c = e[0] / 100,
      t = e[1] / 100,
      d = e[2] / 100,
      s = e[3] / 100;
    return [
      255 * (1 - Math.min(1, c * (1 - s) + s)),
      255 * (1 - Math.min(1, t * (1 - s) + s)),
      255 * (1 - Math.min(1, d * (1 - s) + s)),
    ];
  }),
  (uc.xyz.rgb = function (e) {
    const c = e[0] / 100,
      t = e[1] / 100,
      d = e[2] / 100;
    let s, a, i;
    return (
      (s = 3.2406 * c + -1.5372 * t + -0.4986 * d),
      (a = -0.9689 * c + 1.8758 * t + 0.0415 * d),
      (i = 0.0557 * c + -0.204 * t + 1.057 * d),
  ...
  (uc.xyz.lab = function (e) {
    ...
    (c /= 95.047),
      ...
      (t = t > 0.008856 ? t ** (1 / 3) : 7.787 * t + 16 / 116),
      (d = d > 0.008856 ? d ** (1 / 3) : 7.787 * d + 16 / 116);
    return [116 * t - 16, 500 * (c - t), 200 * (t - d)];
  }),
  (uc.lab.xyz = function (e) {
    let c, t, d;
    (t = (e[0] + 16) / 116), (c = e[1] / 500 + t), (d = t - e[2] / 200);
    const s = t ** 3,
      a = c ** 3,
      i = d ** 3;
    return (
      (t = s > 0.008856 ? s : (t - 16 / 116) / 7.787),
      (c = a > 0.008856 ? a : (c - 16 / 116) / 7.787),
      (d = i > 0.008856 ? i : (d - 16 / 116) / 7.787),
      (c *= 95.047),
      (t *= 100),
      (d *= 108.883),
      [c, t, d]
  ...
  (uc.lab.lch = function (e) {
    const c = e[0],
      t = e[1],
      d = e[2];
    let s;
    (s = (360 * Math.atan2(d, t)) / 2 / Math.PI), s < 0 && (s += 360);
    return [c, Math.sqrt(t * t + d * d), s];
  }),
  (uc.lch.lab = function (e) {
    const c = e[0],
      t = e[1],
      d = (e[2] / 360) * 2 * Math.PI;
    return [c, t * Math.cos(d), t * Math.sin(d)];
  }),
  (uc.rgb.ansi16 = function (e, c = null) {
    const [t, d, s] = e;
    let a = null === c ? uc.rgb.hsv(e)[2] : c;
  ...
  (uc.hsv.ansi16 = function (e) {
    return uc.rgb.ansi16(uc.hsv.rgb(e), e[2]);
  }),
  (uc.rgb.ansi256 = function (e) {
    const c = e[0],
      t = e[1],
      d = e[2];
    if (c === t && t === d)
  ...
  (uc.ansi16.rgb = function (e) {
    let c = e % 10;
    if (0 === c || 7 === c)
      return e > 50 && (c += 3.5), (c = (c / 10.5) * 255), [c, c, c];
    const t = 0.5 * (1 + ~~(e > 50));
    return [
      (1 & c) * t * 255,
      ((c >> 1) & 1) * t * 255,
  ...
  (uc.ansi256.rgb = function (e) {
    ...
    return [
      ...
      (Math.floor((c = e % 36) / 6) / 5) * 255,
      ((c % 6) / 5) * 255,
    ];
  }),
  (uc.rgb.hex = function (e) {
    const c = (
  ...
  (uc.hex.rgb = function (e) {
    const c = e.toString(16).match(/[a-f0-9]{6}|[a-f0-9]{3}/i);
    if (!c) return [0, 0, 0];
    let t = c[0];
    3 === c[0].length &&
      (t = t
        ...
        .map((e) => e + e)
        .join(''));
    const d = parseInt(t, 16);
    return [(d >> 16) & 255, (d >> 8) & 255, 255 & d];
  }),
  (uc.rgb.hcg = function (e) {
    const c = e[0] / 255,
      t = e[1] / 255,
      d = e[2] / 255,
      s = Math.max(Math.max(c, t), d),
      a = Math.min(Math.min(c, t), d),
      i = s - a;
    let o, r;
    return (
      (o = i < 1 ? a / (1 - i) : 0),
  ...
  (uc.hsl.hcg = function (e) {
    const c = e[1] / 100,
      t = e[2] / 100,
      d = t < 0.5 ? 2 * c * t : 2 * c * (1 - t);
    let s = 0;
    return d < 1 && (s = (t - 0.5 * d) / (1 - d)), [e[0], 100 * d, 100 * s];
  }),
  (uc.hsv.hcg = function (e) {
    const c = e[1] / 100,
      t = e[2] / 100,
      d = c * t;
    let s = 0;
    return d < 1 && (s = (t - d) / (1 - d)), [e[0], 100 * d, 100 * s];
  }),
  (uc.hcg.rgb = function (e) {
    const c = e[0] / 360,
      t = e[1] / 100,
      d = e[2] / 100;
    if (0 === t) return [255 * d, 255 * d, 255 * d];
    const s = [0, 0, 0],
      a = (c % 1) * 6,
      i = a % 1,
      o = 1 - i;
    ...
    return (
      (r = (1 - t) * d),
      [255 * (t * s[0] + r), 255 * (t * s[1] + r), 255 * (t * s[2] + r)]
    );
  }),
  (uc.hcg.hsv = function (e) {
    const c = e[1] / 100,
      t = c + (e[2] / 100) * (1 - c);
    let d = 0;
    return t > 0 && (d = c / t), [e[0], 100 * d, 100 * t];
  }),
  (uc.hcg.hsl = function (e) {
    const c = e[1] / 100,
      t = (e[2] / 100) * (1 - c) + 0.5 * c;
    let d = 0;
    return (
  ...
  (uc.hcg.hwb = function (e) {
    const c = e[1] / 100,
      t = c + (e[2] / 100) * (1 - c);
    return [e[0], 100 * (t - c), 100 * (1 - t)];
  }),
  (uc.hwb.hcg = function (e) {
    const c = e[1] / 100,
      t = 1 - e[2] / 100,
      d = t - c;
    let s = 0;
  ...
  (uc.apple.rgb = function (e) {
    return [(e[0] / 65535) * 255, (e[1] / 65535) * 255, (e[2] / 65535) * 255];
  }),
  (uc.rgb.apple = function (e) {
    return [(e[0] / 255) * 65535, (e[1] / 255) * 65535, (e[2] / 255) * 65535];
  }),
  (uc.gray.rgb = function (e) {
    return [(e[0] / 100) * 255, (e[0] / 100) * 255, (e[0] / 100) * 255];
  }),
  (uc.gray.hsl = function (e) {
    return [0, 0, e[0]];
  }),
  (uc.gray.hsv = uc.gray.hsl),
  (uc.gray.hwb = function (e) {
    return [0, 100, e[0]];
  }),
  (uc.gray.cmyk = function (e) {
    return [0, 0, 0, e[0]];
  }),
  (uc.gray.lab = function (e) {
    return [e[0], 0, 0];
  }),
  (uc.gray.hex = function (e) {
    const c = 255 & Math.round((e[0] / 100) * 255),
      t = ((c << 16) + (c << 8) + c).toString(16).toUpperCase();
    return '000000'.substring(t.length) + t;
  }),
  (uc.rgb.gray = function (e) {
...
function yc(e) {
  const c = (function () {
      const e = {},
        c = Object.keys(vc);
      for (let t = c.length, d = 0; d < t; d++)
        e[c[d]] = { distance: -1, parent: null };
      return e;
    })(),
    t = [e];
  for (c[e].distance = 0; t.length; ) {
    const e = t.pop(),
      d = Object.keys(vc[e]);
    for (let s = d.length, a = 0; a < s; a++) {
      const s = d[a],
        i = c[s];
      -1 === i.distance &&
        ((i.distance = c[e].distance + 1), (i.parent = e), t.unshift(s));
    }
  }
  return c;
}
...
function kc(e, c) {
  const t = [c[e].parent, e];
  let d = vc[c[e].parent][e],
    s = c[e].parent;
  for (; c[s].parent; )
    t.unshift(c[s].parent), (d = xc(vc[c[s].parent][s], d)), (s = c[s].parent);
  return (d.conversion = t), d;
}
const _c = mc,
  wc = function (e) {
    const c = yc(e),
      t = {},
      d = Object.keys(c);
    for (let e = d.length, s = 0; s < e; s++) {
      const e = d[s];
      null !== c[e].parent && (t[e] = kc(e, c));
    }
    return t;
  },
  zc = {};
Object.keys(_c).forEach((e) => {
  (zc[e] = {}),
    Object.defineProperty(zc[e], 'channels', { value: _c[e].channels }),
    Object.defineProperty(zc[e], 'labels', { value: _c[e].labels });
  const c = wc(e);
  Object.keys(c).forEach((t) => {
    ...
    (zc[e][t] = (function (e) {
      const c = function (...c) {
        ...
        const d = e(c);
        if ('object' == typeof d)
          for (let e = d.length, c = 0; c < e; c++) d[c] = Math.round(d[c]);
        return d;
      };
      return 'conversion' in e && (c.conversion = e.conversion), c;
    })(d)),
      (zc[e][t].raw = (function (e) {
        const c = function (...c) {
          const t = c[0];
          return null == t ? t : (t.length > 1 && (c = t), e(c));
        };
        return 'conversion' in e && (c.conversion = e.conversion), c;
      })(d));
  });
...
const Bc = Ye.exports,
  ...
  qc = ['keyword', 'gray', 'hex'],
  Hc = {};
for (const e of Object.keys(Mc)) Hc[[...Mc[e].labels].sort().join('')] = e;
const Ac = {};
function Tc(e, c) {
  if (!(this instanceof Tc)) return new Tc(e, c);
  if ((c && c in qc && (c = null), c && !(c in Mc)))
  ...
  if (null == e)
    ...
    const c = Bc.get(e);
    if (null === c) throw new Error('Unable to parse color from string: ' + e);
    (this.model = c.model),
      (d = Mc[this.model].channels),
      (this.color = c.value.slice(0, d)),
      (this.valpha = 'number' == typeof c.value[d] ? c.value[d] : 1);
  } else if (e.length > 0) {
    (this.model = c || 'rgb'), (d = Mc[this.model].channels);
    const t = Array.prototype.slice.call(e, 0, d);
    (this.color = Cc(t, d)), (this.valpha = 'number' == typeof e[d] ? e[d] : 1);
    ...
    this.model = Hc[d];
    const { labels: s } = Mc[this.model],
      a = [];
    for (t = 0; t < s.length; t++) a.push(e[s[t]]);
    this.color = Cc(a);
  }
  if (Ac[this.model])
    for (d = Mc[this.model].channels, t = 0; t < d; t++) {
      const e = Ac[this.model][t];
      e && (this.color[t] = e(this.color[t]));
    }
...
Tc.prototype = {
  ...
  string(e) {
    let c = this.model in Bc.to ? this : this.rgb();
    c = c.round('number' == typeof e ? e : 1);
    const t = 1 === c.valpha ? c.color : [...c.color, this.valpha];
    return Bc.to[c.model](t);
  },
  percentString(e) {
    const c = this.rgb().round('number' == typeof e ? e : 1),
      t = 1 === c.valpha ? c.color : [...c.color, this.valpha];
    return Bc.to.rgb.percent(t);
  },
  array() {
  ...
  object() {
    const e = {},
      { channels: c } = Mc[this.model],
      { labels: t } = Mc[this.model];
    for (let d = 0; d < c; d++) e[t[d]] = this.color[d];
  ...
  round(e) {
    return (
      (e = Math.max(e || 0, 0)),
      new Tc([...this.color.map(Pc(e)), this.valpha], this.model)
    );
  },
  alpha(e) {
    return void 0 !== e
      ? new Tc([...this.color, Math.max(0, Math.min(1, e))], this.model)
      : this.valpha;
  },
  red: Fc('rgb', 0, Ic(255)),
  green: Fc('rgb', 1, Ic(255)),
  blue: Fc('rgb', 2, Ic(255)),
  hue: Fc(
    ['hsl', 'hsv', 'hsl', 'hwb', 'hcg'],
    0,
    (e) => ((e % 360) + 360) % 360
  ),
  saturationl: Fc('hsl', 1, Ic(100)),
  lightness: Fc('hsl', 2, Ic(100)),
  saturationv: Fc('hsv', 1, Ic(100)),
  value: Fc('hsv', 2, Ic(100)),
  chroma: Fc('hcg', 1, Ic(100)),
  gray: Fc('hcg', 2, Ic(100)),
  white: Fc('hwb', 1, Ic(100)),
  wblack: Fc('hwb', 2, Ic(100)),
  cyan: Fc('cmyk', 0, Ic(100)),
  magenta: Fc('cmyk', 1, Ic(100)),
  yellow: Fc('cmyk', 2, Ic(100)),
  black: Fc('cmyk', 3, Ic(100)),
  x: Fc('xyz', 0, Ic(95.047)),
  y: Fc('xyz', 1, Ic(100)),
  z: Fc('xyz', 2, Ic(108.833)),
  l: Fc('lab', 0, Ic(100)),
  a: Fc('lab', 1),
  b: Fc('lab', 2),
  keyword(e) {
    return void 0 !== e ? new Tc(e) : Mc[this.model].keyword(this.color);
  },
  hex(e) {
    return void 0 !== e ? new Tc(e) : Bc.to.hex(this.rgb().round().color);
  },
  hexa(e) {
    if (void 0 !== e) return new Tc(e);
    const c = this.rgb().round().color;
    let t = Math.round(255 * this.valpha)
      .toString(16)
      .toUpperCase();
    return 1 === t.length && (t = '0' + t), Bc.to.hex(c) + t;
  },
  rgbNumber() {
    const e = this.rgb().color;
  ...
  luminosity() {
    ...
    for (const [t, d] of e.entries()) {
      const e = d / 255;
      c[t] = e <= 0.04045 ? e / 12.92 : ((e + 0.055) / 1.055) ** 2.4;
    }
    return 0.2126 * c[0] + 0.7152 * c[1] + 0.0722 * c[2];
  },
  contrast(e) {
    const c = this.luminosity(),
      t = e.luminosity();
    return c > t ? (c + 0.05) / (t + 0.05) : (t + 0.05) / (c + 0.05);
  },
  level(e) {
    const c = this.contrast(e);
    return c >= 7 ? 'AAA' : c >= 4.5 ? 'AA' : '';
  },
  isDark() {
    const e = this.rgb().color;
  ...
  negate() {
    const e = this.rgb();
    for (let c = 0; c < 3; c++) e.color[c] = 255 - e.color[c];
    return e;
  },
  lighten(e) {
    const c = this.hsl();
    return (c.color[2] += c.color[2] * e), c;
  },
  darken(e) {
    const c = this.hsl();
    return (c.color[2] -= c.color[2] * e), c;
  ...
  saturate(e) {
    const c = this.hsl();
    return (c.color[1] += c.color[1] * e), c;
  },
  desaturate(e) {
    const c = this.hsl();
    return (c.color[1] -= c.color[1] * e), c;
  ...
  rotate(e) {
    const c = this.hsl();
    let t = c.color[0];
    return (t = (t + e) % 360), (t = t < 0 ? 360 + t : t), (c.color[0] = t), c;
  },
  mix(e, c) {
    if (!e || !e.rgb)
      throw new Error(
    ...
    const t = e.rgb(),
      ...
      a = 2 * s - 1,
      i = t.alpha() - d.alpha(),
      o = ((a * i == -1 ? a : (a + i) / (1 + a * i)) + 1) / 2,
      r = 1 - o;
    return Tc.rgb(
      o * t.red() + r * d.red(),
      o * t.green() + r * d.green(),
      o * t.blue() + r * d.blue(),
      t.alpha() * s + d.alpha() * (1 - s)
    );
  },
};
for (const e of Object.keys(Mc)) {
  if (qc.includes(e)) continue;
  const { channels: c } = Mc[e];
  (Tc.prototype[e] = function (...c) {
    return this.model === e
      ? new Tc(this)
      : c.length > 0
      ? new Tc(c, e)
      : new Tc(
          [
            ...((t = Mc[this.model][e].raw(this.color)),
            Array.isArray(t) ? t : [t]),
            this.valpha,
          ],
          e
    ...
    (Tc[e] = function (...t) {
      let d = t[0];
      return 'number' == typeof d && (d = Cc(t, c)), new Tc(d, e);
    });
}
function Pc(e) {
  return function (c) {
...
function Fc(e, c, t) {
  ...
  for (const d of e) (Ac[d] || (Ac[d] = []))[c] = t;
  return (
    (e = e[0]),
    function (d) {
      let s;
      return void 0 !== d
        ? (t && (d = t(d)), (s = this[e]()), (s.color[c] = d), s)
        : ((s = this[e]().color[c]), t && (s = t(s)), s);
    }
  );
}
function Ic(e) {
  return function (c) {
    return Math.max(0, Math.min(e, c));
  };
}
function Cc(e, c) {
  for (let t = 0; t < c; t++) 'number' != typeof e[t] && (e[t] = 0);
  return e;
}
var Ec = Tc;
const jc =
    "'IBM Plex Mono', 'Menlo', 'DejaVu Sans Mono', 'Bitstream Vera Sans Mono', Courier, monospace",
  Nc = "'IBM Plex Serif', 'Georgia', Times, serif",
  Oc = 300,
  Dc = 400,
  Rc = 600,
  Lc = [
  ...
  Vc = {
    ...
    fontWeight: Dc,
    lineHeight: 1.28572,
    letterSpacing: l(0.16),
  },
  Xc = { fontSize: n(Lc[0]), lineHeight: 1.33333, letterSpacing: l(0.32) },
  Kc = { fontSize: n(Lc[1]), lineHeight: 1.28572, letterSpacing: l(0.16) },
  Gc = {
    fontSize: n(Lc[1]),
    fontWeight: Dc,
    lineHeight: 1.28572,
  ...
  lt = { ...ct, lineHeight: 1.25 },
  gt = { ...dt, lineHeight: 1.5 },
  ht = {
    fontSize: n(Lc[4]),
    fontWeight: Dc,
    lineHeight: 1.4,
    letterSpacing: 0,
    breakpoints: {
      xlg: { fontSize: n(Lc[4]), lineHeight: 1.4 },
      max: { fontSize: n(Lc[5]), lineHeight: 1.334 },
    },
  },
  pt = {
    fontSize: n(Lc[6]),
    ...
    letterSpacing: 0,
    breakpoints: {
      xlg: { fontSize: n(Lc[7]), fontWeight: Dc, lineHeight: 1.25 },
      max: { fontSize: n(Lc[7]), fontWeight: Dc },
    },
  },
  ft = {
    fontSize: n(Lc[7]),
    ...
    breakpoints: {
      ...
      lg: { fontSize: n(Lc[9]), lineHeight: 1.19, letterSpacing: 0 },
      xlg: { fontSize: n(Lc[10]), lineHeight: 1.17, letterSpacing: 0 },
      max: { fontSize: n(Lc[12]), letterSpacing: 0 },
    },
  },
  ut = {
    fontSize: n(Lc[7]),
    ...
    breakpoints: {
      ...
      max: { fontSize: n(Lc[12]), fontWeight: Rc, letterSpacing: 0 },
    },
  },
  mt = {
    fontSize: n(Lc[5]),
    ...
    letterSpacing: 0,
    breakpoints: {
      lg: { fontSize: n(Lc[6]), lineHeight: 1.28572 },
      max: { fontSize: n(Lc[7]), lineHeight: 1.25 },
    },
  },
  bt = {
    fontFamily: Nc,
    ...
    letterSpacing: 0,
    breakpoints: {
      md: { fontSize: n(Lc[4]), fontWeight: Dc, letterSpacing: 0 },
      lg: {
        fontSize: n(Lc[5]),
        fontWeight: Dc,
        lineHeight: 1.334,
  ...
  vt = {
    ...
    letterSpacing: 0,
    breakpoints: {
      md: { fontSize: n(Lc[8]), lineHeight: 1.22 },
      lg: { fontSize: n(Lc[9]), lineHeight: 1.19 },
      xlg: { fontSize: n(Lc[10]), lineHeight: 1.17 },
      max: { fontSize: n(Lc[12]) },
    },
  },
  yt = {
    fontSize: n(Lc[9]),
    ...
    breakpoints: {
      md: { fontSize: n(Lc[9]) },
      lg: { fontSize: n(Lc[11]) },
      xlg: { fontSize: n(Lc[12]), lineHeight: 1.17 },
      max: { fontSize: n(Lc[14]), lineHeight: 1.13 },
    },
  },
  xt = {
    fontSize: n(Lc[9]),
    ...
    breakpoints: {
      md: { fontSize: n(Lc[9]) },
      lg: { fontSize: n(Lc[11]) },
      xlg: { fontSize: n(Lc[12]), lineHeight: 1.16 },
      max: { fontSize: n(Lc[14]), lineHeight: 1.13 },
    },
  },
  kt = {
    ...
    letterSpacing: 0,
    breakpoints: {
      md: { fontSize: n(Lc[11]), lineHeight: 1.18 },
      lg: { fontSize: n(Lc[12]), lineHeight: 1.16, letterSpacing: l(-0.64) },
      xlg: { fontSize: n(Lc[14]), lineHeight: 1.13 },
      max: { fontSize: n(Lc[15]), lineHeight: 1.11, letterSpacing: l(-0.96) },
    },
  },
  _t = {
    fontSize: n(Lc[9]),
    ...
    letterSpacing: 0,
    breakpoints: {
      md: { fontSize: n(Lc[13]), lineHeight: 1.15 },
      lg: { fontSize: n(Lc[16]), lineHeight: 1.11, letterSpacing: l(-0.64) },
      xlg: { fontSize: n(Lc[19]), lineHeight: 1.07, letterSpacing: l(-0.64) },
      max: { fontSize: n(Lc[22]), lineHeight: 1.05, letterSpacing: l(-0.96) },
    },
  };
var wt = Object.defineProperty,
  zt = (e, c) => {
    let t = {};
    for (var d in e) wt(t, d, { get: e[d], enumerable: !0 });
    return c || wt(t, Symbol.toStringTag, { value: 'Module' }), t;
  };
function St(e, c) {
  const t = Ec(e).hsl().object();
  return Ec({ ...t, l: (t.l += c) })
    .round()
    .hex()
    .toLowerCase();
...
function Bt(e, c) {
  return Ec(e).rgb().alpha(c).string();
}
var Mt = zt({
  aiAuraEnd: () => ri,
  aiAuraHoverBackground: () => pi,
  aiAuraHoverEnd: () => ui,
  aiAuraHoverStart: () => fi,
  aiAuraStart: () => oi,
  aiAuraStartSm: () => ii,
  ...
  aiInnerShadow: () => ai,
  aiOverlay: () => ki,
  aiPopoverBackground: () => mi,
  aiPopoverCaretBottom: () => wi,
  aiPopoverCaretBottomBackground: () => Si,
  aiPopoverCaretBottomBackgroundActions: () => zi,
  aiPopoverCaretCenter: () => _i,
  aiPopoverShadowOuter01: () => bi,
  aiPopoverShadowOuter02: () => vi,
  aiSkeletonBackground: () => yi,
  aiSkeletonElementBackground: () => xi,
  background: () => Ht,
  backgroundActive: () => Pt,
  backgroundBrand: () => Tt,
  backgroundHover: () => Ft,
  backgroundInverse: () => At,
  backgroundInverseHover: () => It,
  backgroundSelected: () => Ct,
  backgroundSelectedHover: () => Et,
  bodyLong01: () => Zc,
  bodyLong02: () => Yc,
  bodyShort01: () => Gc,
  bodyShort02: () => Qc,
  borderDisabled: () => Fd,
  borderInteractive: () => Pd,
  borderInverse: () => Td,
  borderStrong01: () => Sd,
  borderStrong02: () => Bd,
  borderStrong03: () => Md,
  ...
  borderSubtle02: () => kd,
  borderSubtle03: () => wd,
  borderSubtleSelected01: () => xd,
  borderSubtleSelected02: () => _d,
  borderSubtleSelected03: () => zd,
  borderTile01: () => qd,
  borderTile02: () => Hd,
  borderTile03: () => Ad,
  caption01: () => Wc,
  ...
  chatAvatarUser: () => ji,
  chatBubbleAgent: () => Pi,
  chatBubbleAgentText: () => Fi,
  chatBubbleBorder: () => Ii,
  chatBubbleUser: () => Ai,
  chatBubbleUserText: () => Ti,
  chatButton: () => Ri,
  chatButtonActive: () => Ui,
  chatButtonHover: () => Li,
  chatButtonSelected: () => $i,
  chatButtonTextHover: () => Wi,
  chatButtonTextSelected: () => Vi,
  chatHeaderBackground: () => Oi,
  chatHeaderText: () => Di,
  chatPromptBackground: () => Bi,
  chatPromptBorderEnd: () => qi,
  chatPromptBorderStart: () => Mi,
  chatPromptText: () => Hi,
  chatShellBackground: () => Ni,
  code01: () => Jc,
  code02: () => et,
  colorScheme: () => qt,
  container01: () => g,
  ...
  display03: () => kt,
  display04: () => _t,
  expressiveHeading01: () => lt,
  expressiveHeading02: () => gt,
  expressiveHeading03: () => ht,
  expressiveHeading04: () => pt,
  expressiveHeading05: () => ft,
  expressiveHeading06: () => ut,
  expressiveParagraph01: () => mt,
  field01: () => hd,
  field02: () => fd,
  field03: () => md,
  fieldHover01: () => pd,
  ...
  layerAccent02: () => id,
  layerAccent03: () => nd,
  layerAccentActive01: () => sd,
  layerAccentActive02: () => od,
  layerAccentActive03: () => ld,
  layerAccentHover01: () => ad,
  layerAccentHover02: () => rd,
  layerAccentHover03: () => gd,
  layerActive01: () => Nt,
  layerActive02: () => Ut,
  layerActive03: () => Zt,
  layerBackground01: () => Ot,
  layerBackground02: () => $t,
  layerBackground03: () => Qt,
  layerHover01: () => Dt,
  layerHover02: () => Vt,
  layerHover03: () => Yt,
  layerSelected01: () => Rt,
  layerSelected02: () => Xt,
  layerSelected03: () => Jt,
  layerSelectedDisabled: () => td,
  layerSelectedHover01: () => Lt,
  layerSelectedHover02: () => Kt,
  layerSelectedHover03: () => ed,
  layerSelectedInverse: () => cd,
  layout01: () => _,
  layout02: () => w,
  layout03: () => z,
  layout04: () => S,
  ...
  layout07: () => q,
  linkInverse: () => Vd,
  linkInverseActive: () => Gd,
  linkInverseHover: () => Zd,
  linkInverseVisited: () => Kd,
  linkPrimary: () => Wd,
  linkPrimaryHover: () => Ud,
  linkSecondary: () => $d,
  linkVisited: () => Xd,
  overlay: () => _s,
  productiveHeading01: () => tt,
  productiveHeading02: () => st,
  productiveHeading03: () => at,
  productiveHeading04: () => it,
  productiveHeading05: () => ot,
  productiveHeading06: () => rt,
  productiveHeading07: () => nt,
  quotation01: () => bt,
  quotation02: () => vt,
  shadow: () => zs,
  size2XLarge: () => H,
  ...
  spacing12: () => V,
  spacing13: () => X,
  supportCautionMajor: () => ps,
  supportCautionMinor: () => hs,
  supportCautionUndefined: () => fs,
  supportError: () => ss,
  supportErrorInverse: () => rs,
  supportInfo: () => os,
  supportInfoInverse: () => gs,
  supportSuccess: () => as,
  supportSuccessInverse: () => ns,
  supportWarning: () => is,
  supportWarningInverse: () => ls,
  syntaxAngleBracket: () => Ba,
  syntaxAnnotation: () => Ga,
  syntaxArithmeticOperator: () => fa,
  syntaxAtom: () => Zs,
  syntaxAttribute: () => Ds,
  syntaxAttributeName: () => Rs,
  syntaxAttributeValue: () => ia,
  syntaxBitwiseOperator: () => ma,
  syntaxBlockComment: () => Ms,
  syntaxBool: () => Ys,
  syntaxBrace: () => Ha,
  syntaxBracket: () => Sa,
  syntaxCharacter: () => aa,
  ...
  syntaxColor: () => ga,
  syntaxComment: () => Ss,
  syntaxCompareOperator: () => ba,
  syntaxConstant: () => Ya,
  syntaxContent: () => Aa,
  syntaxContentSeparator: () => Wa,
  syntaxControlKeyword: () => Fs,
  syntaxControlOperator: () => ka,
  syntaxDefinition: () => Qa,
  syntaxDefinitionKeyword: () => Is,
  syntaxDefinitionOperator: () => ya,
  syntaxDeleted: () => si,
  syntaxDerefOperator: () => pa,
  syntaxDocComment: () => qs,
  syntaxDocString: () => As,
  syntaxDocumentMeta: () => Ka,
  syntaxEmphasis: () => Pa,
  syntaxEscape: () => na,
  syntaxFloat: () => da,
  syntaxFunction: () => Ja,
  ...
  syntaxKeyword: () => Ts,
  syntaxLabelName: () => Os,
  syntaxLineComment: () => Bs,
  syntaxLink: () => $a,
  syntaxList: () => Ta,
  syntaxLiteral: () => Qs,
  syntaxLocal: () => ci,
  syntaxLogicOperator: () => ua,
  syntaxMacroName: () => Gs,
  syntaxMeta: () => Xa,
  syntaxModifier: () => _a,
  syntaxModuleKeyword: () => Cs,
  syntaxMonospace: () => Ia,
  syntaxName: () => js,
  syntaxNamespace: () => Ks,
  syntaxNull: () => Js,
  syntaxNumber: () => ca,
  syntaxOperator: () => ha,
  syntaxOperatorKeyword: () => Ps,
  syntaxParen: () => qa,
  syntaxProcessingInstruction: () => Za,
  syntaxPropertyName: () => Ls,
  syntaxPunctuation: () => wa,
  syntaxQuote: () => Ua,
  syntaxRegexp: () => ra,
  syntaxSelf: () => ea,
  syntaxSeparator: () => za,
  syntaxSpecial: () => ti,
  syntaxSpecialString: () => oa,
  syntaxSquareBracket: () => Ma,
  syntaxStandard: () => ei,
  syntaxStrikethrough: () => Ca,
  syntaxString: () => Hs,
  syntaxStrong: () => Fa,
  syntaxTag: () => Ws,
  syntaxTagName: () => Us,
  syntaxType: () => $s,
  syntaxTypeName: () => Vs,
  syntaxTypeOperator: () => xa,
  syntaxUnit: () => sa,
  syntaxUpdateOperator: () => va,
  syntaxUrl: () => la,
  syntaxVariable: () => Es,
  syntaxVariableName: () => Ns,
  textDisabled: () => Ld,
  textError: () => Nd,
  textHelper: () => jd,
  textInverse: () => Od,
  textOnColor: () => Dd,
  textOnColorDisabled: () => Rd,
  textPlaceholder: () => Ed,
  textPrimary: () => Id,
  textSecondary: () => Cd,
  toggleOff: () => ws,
...
var Xi = zt({
  ...
  aiInnerShadow: () => Ml,
  aiOverlay: () => Wl,
  aiPopoverBackground: () => Nl,
  aiPopoverCaretBottom: () => $l,
  aiPopoverCaretBottomBackground: () => Xl,
  aiPopoverCaretBottomBackgroundActions: () => Vl,
  aiPopoverCaretCenter: () => Ul,
  aiPopoverShadowOuter01: () => Ol,
  aiPopoverShadowOuter02: () => Dl,
  aiSkeletonBackground: () => Rl,
  aiSkeletonElementBackground: () => Ll,
  background: () => Gi,
  backgroundActive: () => Yi,
  backgroundBrand: () => Qi,
  backgroundHover: () => Ji,
  backgroundInverse: () => Zi,
  backgroundInverseHover: () => eo,
  backgroundSelected: () => co,
  backgroundSelectedHover: () => to,
  bodyLong01: () => Zc,
  bodyLong02: () => Yc,
  bodyShort01: () => Gc,
  bodyShort02: () => Qc,
  borderDisabled: () => er,
  borderInteractive: () => Jo,
  borderInverse: () => Yo,
  borderStrong01: () => Vo,
  borderStrong02: () => Xo,
  borderStrong03: () => Ko,
  ...
  borderSubtle02: () => Lo,
  borderSubtle03: () => Uo,
  borderSubtleSelected01: () => Ro,
  borderSubtleSelected02: () => Wo,
  borderSubtleSelected03: () => $o,
  borderTile01: () => Go,
  borderTile02: () => Zo,
  borderTile03: () => Qo,
  caption01: () => Wc,
  ...
  chatAvatarUser: () => ag,
  chatBubbleAgent: () => eg,
  chatBubbleAgentText: () => cg,
  chatBubbleBorder: () => tg,
  chatBubbleUser: () => Yl,
  chatBubbleUserText: () => Jl,
  chatButton: () => ng,
  chatButtonActive: () => hg,
  chatButtonHover: () => lg,
  chatButtonSelected: () => pg,
  chatButtonTextHover: () => gg,
  chatButtonTextSelected: () => fg,
  chatHeaderBackground: () => og,
  chatHeaderText: () => rg,
  chatPromptBackground: () => Kl,
  chatPromptBorderEnd: () => Zl,
  chatPromptBorderStart: () => Gl,
  chatPromptText: () => Ql,
  chatShellBackground: () => ig,
  code01: () => Jc,
  code02: () => et,
  colorScheme: () => Ki,
  container01: () => g,
  ...
  layerAccent02: () => Mo,
  layerAccent03: () => Ao,
  layerAccentActive01: () => So,
  layerAccentActive02: () => qo,
  layerAccentActive03: () => To,
  layerAccentHover01: () => Bo,
  layerAccentHover02: () => Ho,
  layerAccentHover03: () => Po,
  layerActive01: () => ao,
  layerActive02: () => go,
  layerActive03: () => bo,
  layerBackground01: () => io,
  layerBackground02: () => ho,
  layerBackground03: () => vo,
  layerHover01: () => oo,
  layerHover02: () => po,
  layerHover03: () => yo,
  layerSelected01: () => ro,
  layerSelected02: () => fo,
  layerSelected03: () => xo,
  layerSelectedDisabled: () => wo,
  layerSelectedHover01: () => no,
  layerSelectedHover02: () => uo,
  layerSelectedHover03: () => ko,
  layerSelectedInverse: () => _o,
  layout01: () => _,
  layout02: () => w,
  layout03: () => z,
  layout04: () => S,
  ...
  layout07: () => q,
  linkInverse: () => pr,
  linkInverseActive: () => mr,
  linkInverseHover: () => br,
  linkInverseVisited: () => ur,
  linkPrimary: () => lr,
  linkPrimaryHover: () => gr,
  linkSecondary: () => hr,
  linkVisited: () => fr,
  ...
  spacing12: () => V,
  spacing13: () => X,
  supportCautionMajor: () => Ir,
  supportCautionMinor: () => Fr,
  supportCautionUndefined: () => Cr,
  supportError: () => Sr,
  supportErrorInverse: () => Hr,
  supportInfo: () => qr,
  supportInfoInverse: () => Pr,
  supportSuccess: () => Br,
  supportSuccessInverse: () => Ar,
  supportWarning: () => Mr,
  supportWarningInverse: () => Tr,
  syntaxAngleBracket: () => Kn,
  syntaxAnnotation: () => bl,
  syntaxArithmeticOperator: () => En,
  syntaxAtom: () => vn,
  syntaxAttribute: () => rn,
  syntaxAttributeName: () => nn,
  syntaxAttributeValue: () => qn,
  syntaxBitwiseOperator: () => Nn,
  syntaxBlockComment: () => Kr,
  syntaxBool: () => xn,
  syntaxBrace: () => Qn,
  syntaxBracket: () => Xn,
  syntaxCharacter: () => Mn,
  ...
  syntaxColor: () => Fn,
  syntaxComment: () => Vr,
  syntaxCompareOperator: () => On,
  syntaxConstant: () => xl,
  syntaxContent: () => Yn,
  syntaxContentSeparator: () => gl,
  syntaxControlKeyword: () => en,
  syntaxControlOperator: () => Wn,
  syntaxDefinition: () => yl,
  syntaxDefinitionKeyword: () => cn,
  syntaxDefinitionOperator: () => Rn,
  syntaxDeleted: () => Bl,
  syntaxDerefOperator: () => Cn,
  syntaxDocComment: () => Gr,
  syntaxDocString: () => Qr,
  syntaxDocumentMeta: () => ml,
  syntaxEmphasis: () => el,
  syntaxEscape: () => Tn,
  syntaxFloat: () => Sn,
  syntaxFunction: () => kl,
  ...
  syntaxKeyword: () => Yr,
  syntaxLabelName: () => on,
  syntaxLineComment: () => Xr,
  syntaxLink: () => pl,
  syntaxList: () => Jn,
  syntaxLiteral: () => yn,
  syntaxLocal: () => wl,
  syntaxLogicOperator: () => jn,
  syntaxMacroName: () => bn,
  syntaxMeta: () => ul,
  syntaxModifier: () => Un,
  syntaxModuleKeyword: () => tn,
  syntaxMonospace: () => tl,
  syntaxName: () => sn,
  syntaxNamespace: () => mn,
  syntaxNull: () => kn,
  syntaxNumber: () => wn,
  syntaxOperator: () => In,
  syntaxOperatorKeyword: () => Jr,
  syntaxParen: () => Zn,
  syntaxProcessingInstruction: () => vl,
  syntaxPropertyName: () => ln,
  syntaxPunctuation: () => $n,
  syntaxQuote: () => hl,
  syntaxRegexp: () => An,
  syntaxSelf: () => _n,
  syntaxSeparator: () => Vn,
  syntaxSpecial: () => zl,
  syntaxSpecialString: () => Hn,
  syntaxSquareBracket: () => Gn,
  syntaxStandard: () => _l,
  syntaxStrikethrough: () => dl,
  syntaxString: () => Zr,
  syntaxStrong: () => cl,
  syntaxTag: () => gn,
  syntaxTagName: () => hn,
  syntaxType: () => pn,
  syntaxTypeName: () => fn,
  syntaxTypeOperator: () => Ln,
  syntaxUnit: () => Bn,
  syntaxUpdateOperator: () => Dn,
  syntaxUrl: () => Pn,
  syntaxVariable: () => dn,
  syntaxVariableName: () => an,
  textDisabled: () => nr,
  textError: () => ar,
  textHelper: () => sr,
  textInverse: () => ir,
  textOnColor: () => or,
  textOnColorDisabled: () => rr,
  textPlaceholder: () => dr,
  textPrimary: () => cr,
  textSecondary: () => tr,
  toggleOff: () => Ur,
...
var ug = zt({
  ...
  aiInnerShadow: () => Kf,
  aiOverlay: () => lu,
  aiPopoverBackground: () => au,
  aiPopoverCaretBottom: () => hu,
  aiPopoverCaretBottomBackground: () => fu,
  aiPopoverCaretBottomBackgroundActions: () => pu,
  aiPopoverCaretCenter: () => gu,
  aiPopoverShadowOuter01: () => iu,
  aiPopoverShadowOuter02: () => ou,
  aiSkeletonBackground: () => ru,
  aiSkeletonElementBackground: () => nu,
  background: () => bg,
  backgroundActive: () => xg,
  backgroundBrand: () => yg,
  backgroundHover: () => kg,
  backgroundInverse: () => vg,
  backgroundInverseHover: () => _g,
  backgroundSelected: () => wg,
  backgroundSelectedHover: () => zg,
  bodyLong01: () => Zc,
  bodyLong02: () => Yc,
  bodyShort01: () => Gc,
  bodyShort02: () => Qc,
  borderDisabled: () => kh,
  borderInteractive: () => xh,
  borderInverse: () => yh,
  borderStrong01: () => ph,
  borderStrong02: () => fh,
  borderStrong03: () => uh,
  ...
  borderSubtle02: () => nh,
  borderSubtle03: () => gh,
  borderSubtleSelected01: () => rh,
  borderSubtleSelected02: () => lh,
  borderSubtleSelected03: () => hh,
  borderTile01: () => mh,
  borderTile02: () => bh,
  borderTile03: () => vh,
  caption01: () => Wc,
  ...
  chatAvatarUser: () => Bu,
  chatBubbleAgent: () => ku,
  chatBubbleAgentText: () => _u,
  chatBubbleBorder: () => wu,
  chatBubbleUser: () => yu,
  chatBubbleUserText: () => xu,
  chatButton: () => Au,
  chatButtonActive: () => Fu,
  chatButtonHover: () => Tu,
  chatButtonSelected: () => Iu,
  chatButtonTextHover: () => Pu,
  chatButtonTextSelected: () => Cu,
  chatHeaderBackground: () => qu,
  chatHeaderText: () => Hu,
  chatPromptBackground: () => uu,
  chatPromptBorderEnd: () => bu,
  chatPromptBorderStart: () => mu,
  chatPromptText: () => vu,
  chatShellBackground: () => Mu,
  code01: () => Jc,
  code02: () => et,
  colorScheme: () => mg,
  container01: () => g,
  ...
  layerAccent02: () => Kg,
  layerAccent03: () => Qg,
  layerAccentActive01: () => Vg,
  layerAccentActive02: () => Gg,
  layerAccentActive03: () => Yg,
  layerAccentHover01: () => Xg,
  layerAccentHover02: () => Zg,
  layerAccentHover03: () => Jg,
  layerActive01: () => Bg,
  layerActive02: () => Pg,
  layerActive03: () => Ng,
  layerBackground01: () => Mg,
  layerBackground02: () => Fg,
  layerBackground03: () => Og,
  layerHover01: () => qg,
  layerHover02: () => Ig,
  layerHover03: () => Dg,
  layerSelected01: () => Hg,
  layerSelected02: () => Cg,
  layerSelected03: () => Rg,
  layerSelectedDisabled: () => Ug,
  layerSelectedHover01: () => Ag,
  layerSelectedHover02: () => Eg,
  layerSelectedHover03: () => Lg,
  layerSelectedInverse: () => Wg,
  layout01: () => _,
  layout02: () => w,
  layout03: () => z,
  layout04: () => S,
  ...
  layout07: () => q,
  linkInverse: () => Ih,
  linkInverseActive: () => jh,
  linkInverseHover: () => Nh,
  linkInverseVisited: () => Eh,
  linkPrimary: () => Th,
  linkPrimaryHover: () => Ph,
  linkSecondary: () => Fh,
  linkVisited: () => Ch,
  ...
  spacing12: () => V,
  spacing13: () => X,
  supportCautionMajor: () => cp,
  supportCautionMinor: () => ep,
  supportCautionUndefined: () => tp,
  supportError: () => Vh,
  supportErrorInverse: () => Zh,
  supportInfo: () => Gh,
  supportInfoInverse: () => Jh,
  supportSuccess: () => Xh,
  supportSuccessInverse: () => Qh,
  supportWarning: () => Kh,
  supportWarningInverse: () => Yh,
  syntaxAngleBracket: () => uf,
  syntaxAnnotation: () => Nf,
  syntaxArithmeticOperator: () => tf,
  syntaxAtom: () => Np,
  syntaxAttribute: () => qp,
  syntaxAttributeName: () => Hp,
  syntaxAttributeValue: () => Kp,
  syntaxBitwiseOperator: () => sf,
  syntaxBlockComment: () => up,
  syntaxBool: () => Dp,
  syntaxBrace: () => vf,
  syntaxBracket: () => ff,
  syntaxCharacter: () => Xp,
  ...
  syntaxColor: () => Jp,
  syntaxComment: () => pp,
  syntaxCompareOperator: () => af,
  syntaxConstant: () => Rf,
  syntaxContent: () => yf,
  syntaxContentSeparator: () => Pf,
  syntaxControlKeyword: () => kp,
  syntaxControlOperator: () => lf,
  syntaxDefinition: () => Df,
  syntaxDefinitionKeyword: () => _p,
  syntaxDefinitionOperator: () => rf,
  syntaxDeleted: () => Xf,
  syntaxDerefOperator: () => cf,
  syntaxDocComment: () => mp,
  syntaxDocString: () => vp,
  syntaxDocumentMeta: () => jf,
  syntaxEmphasis: () => kf,
  syntaxEscape: () => Qp,
  syntaxFloat: () => $p,
  syntaxFunction: () => Lf,
  ...
  syntaxKeyword: () => yp,
  syntaxLabelName: () => Mp,
  syntaxLineComment: () => fp,
  syntaxLink: () => If,
  syntaxList: () => xf,
  syntaxLiteral: () => Op,
  syntaxLocal: () => Uf,
  syntaxLogicOperator: () => df,
  syntaxMacroName: () => jp,
  syntaxMeta: () => Ef,
  syntaxModifier: () => gf,
  syntaxModuleKeyword: () => wp,
  syntaxMonospace: () => wf,
  syntaxName: () => Sp,
  syntaxNamespace: () => Ep,
  syntaxNull: () => Rp,
  syntaxNumber: () => Wp,
  syntaxOperator: () => ef,
  syntaxOperatorKeyword: () => xp,
  syntaxParen: () => bf,
  syntaxProcessingInstruction: () => Of,
  syntaxPropertyName: () => Ap,
  syntaxPunctuation: () => hf,
  syntaxQuote: () => Ff,
  syntaxRegexp: () => Zp,
  syntaxSelf: () => Lp,
  syntaxSeparator: () => pf,
  syntaxSpecial: () => $f,
  syntaxSpecialString: () => Gp,
  syntaxSquareBracket: () => mf,
  syntaxStandard: () => Wf,
  syntaxStrikethrough: () => zf,
  syntaxString: () => bp,
  syntaxStrong: () => _f,
  syntaxTag: () => Tp,
  syntaxTagName: () => Pp,
  syntaxType: () => Fp,
  syntaxTypeName: () => Ip,
  syntaxTypeOperator: () => nf,
  syntaxUnit: () => Vp,
  syntaxUpdateOperator: () => of,
  syntaxUrl: () => Yp,
  syntaxVariable: () => zp,
  syntaxVariableName: () => Bp,
  textDisabled: () => Ah,
  textError: () => Bh,
  textHelper: () => Sh,
  textInverse: () => Mh,
  textOnColor: () => qh,
  textOnColorDisabled: () => Hh,
  textPlaceholder: () => zh,
  textPrimary: () => _h,
  textSecondary: () => wh,
  toggleOff: () => gp,
...
var Eu = zt({
  ...
  aiInnerShadow: () => fy,
  aiOverlay: () => Ay,
  aiPopoverBackground: () => Sy,
  aiPopoverCaretBottom: () => Py,
  aiPopoverCaretBottomBackground: () => Iy,
  aiPopoverCaretBottomBackgroundActions: () => Fy,
  aiPopoverCaretCenter: () => Ty,
  aiPopoverShadowOuter01: () => By,
  aiPopoverShadowOuter02: () => My,
  aiSkeletonBackground: () => qy,
  aiSkeletonElementBackground: () => Hy,
  background: () => Nu,
  backgroundActive: () => Ru,
  backgroundBrand: () => Du,
  backgroundHover: () => Lu,
  backgroundInverse: () => Ou,
  backgroundInverseHover: () => Wu,
  backgroundSelected: () => Uu,
  backgroundSelectedHover: () => $u,
  bodyLong01: () => Zc,
  bodyLong02: () => Yc,
  bodyShort01: () => Gc,
  bodyShort02: () => Qc,
  borderDisabled: () => Lm,
  borderInteractive: () => Rm,
  borderInverse: () => Dm,
  borderStrong01: () => Im,
  borderStrong02: () => Cm,
  borderStrong03: () => Em,
  ...
  borderSubtle02: () => Am,
  borderSubtle03: () => Pm,
  borderSubtleSelected01: () => Hm,
  borderSubtleSelected02: () => Tm,
  borderSubtleSelected03: () => Fm,
  borderTile01: () => jm,
  borderTile02: () => Nm,
  borderTile03: () => Om,
  caption01: () => Wc,
  ...
  chatAvatarUser: () => Vy,
  chatBubbleAgent: () => Ry,
  chatBubbleAgentText: () => Ly,
  chatBubbleBorder: () => Wy,
  chatBubbleUser: () => Oy,
  chatBubbleUserText: () => Dy,
  chatButton: () => Zy,
  chatButtonActive: () => Jy,
  chatButtonHover: () => Qy,
  chatButtonSelected: () => ex,
  chatButtonTextHover: () => Yy,
  chatButtonTextSelected: () => cx,
  chatHeaderBackground: () => Ky,
  chatHeaderText: () => Gy,
  chatPromptBackground: () => Cy,
  chatPromptBorderEnd: () => jy,
  chatPromptBorderStart: () => Ey,
  chatPromptText: () => Ny,
  chatShellBackground: () => Xy,
  code01: () => Jc,
  code02: () => et,
  colorScheme: () => ju,
  container01: () => g,
  ...
  layerAccent02: () => um,
  layerAccent03: () => vm,
  layerAccentActive01: () => pm,
  layerAccentActive02: () => mm,
  layerAccentActive03: () => ym,
  layerAccentHover01: () => fm,
  layerAccentHover02: () => bm,
  layerAccentHover03: () => xm,
  layerActive01: () => Xu,
  layerActive02: () => Ju,
  layerActive03: () => am,
  layerBackground01: () => Ku,
  layerBackground02: () => em,
  layerBackground03: () => im,
  layerHover01: () => Gu,
  layerHover02: () => cm,
  layerHover03: () => om,
  layerSelected01: () => Zu,
  layerSelected02: () => tm,
  layerSelected03: () => rm,
  layerSelectedDisabled: () => gm,
  layerSelectedHover01: () => Qu,
  layerSelectedHover02: () => dm,
  layerSelectedHover03: () => nm,
  layerSelectedInverse: () => lm,
  layout01: () => _,
  layout02: () => w,
  layout03: () => z,
  layout04: () => S,
  ...
  layout07: () => q,
  linkInverse: () => cb,
  linkInverseActive: () => sb,
  linkInverseHover: () => ab,
  linkInverseVisited: () => db,
  linkPrimary: () => Ym,
  linkPrimaryHover: () => Jm,
  linkSecondary: () => eb,
  linkVisited: () => tb,
  ...
  spacing12: () => V,
  spacing13: () => X,
  supportCautionMajor: () => _b,
  supportCautionMinor: () => kb,
  supportCautionUndefined: () => wb,
  supportError: () => pb,
  supportErrorInverse: () => bb,
  supportInfo: () => mb,
  supportInfoInverse: () => xb,
  supportSuccess: () => fb,
  supportSuccessInverse: () => vb,
  supportWarning: () => ub,
  supportWarningInverse: () => yb,
  syntaxAngleBracket: () => Cv,
  syntaxAnnotation: () => sy,
  syntaxArithmeticOperator: () => wv,
  syntaxAtom: () => av,
  syntaxAttribute: () => Gb,
  syntaxAttributeName: () => Zb,
  syntaxAttributeValue: () => uv,
  syntaxBitwiseOperator: () => Sv,
  syntaxBlockComment: () => Eb,
  syntaxBool: () => ov,
  syntaxBrace: () => Nv,
  syntaxBracket: () => Iv,
  syntaxCharacter: () => fv,
  ...
  syntaxColor: () => xv,
  syntaxComment: () => Ib,
  syntaxCompareOperator: () => Bv,
  syntaxConstant: () => oy,
  syntaxContent: () => Ov,
  syntaxContentSeparator: () => Yv,
  syntaxControlKeyword: () => Lb,
  syntaxControlOperator: () => Av,
  syntaxDefinition: () => iy,
  syntaxDefinitionKeyword: () => Wb,
  syntaxDefinitionOperator: () => qv,
  syntaxDeleted: () => py,
  syntaxDerefOperator: () => _v,
  syntaxDocComment: () => jb,
  syntaxDocString: () => Ob,
  syntaxDocumentMeta: () => dy,
  syntaxEmphasis: () => Rv,
  syntaxEscape: () => vv,
  syntaxFloat: () => hv,
  syntaxFunction: () => ry,
  ...
  syntaxKeyword: () => Db,
  syntaxLabelName: () => Kb,
  syntaxLineComment: () => Cb,
  syntaxLink: () => ey,
  syntaxList: () => Dv,
  syntaxLiteral: () => iv,
  syntaxLocal: () => ly,
  syntaxLogicOperator: () => zv,
  syntaxMacroName: () => sv,
  syntaxMeta: () => ty,
  syntaxModifier: () => Tv,
  syntaxModuleKeyword: () => Ub,
  syntaxMonospace: () => Wv,
  syntaxName: () => Vb,
  syntaxNamespace: () => dv,
  syntaxNull: () => rv,
  syntaxNumber: () => lv,
  syntaxOperator: () => kv,
  syntaxOperatorKeyword: () => Rb,
  syntaxParen: () => jv,
  syntaxProcessingInstruction: () => ay,
  syntaxPropertyName: () => Qb,
  syntaxPunctuation: () => Pv,
  syntaxQuote: () => Jv,
  syntaxRegexp: () => bv,
  syntaxSelf: () => nv,
  syntaxSeparator: () => Fv,
  syntaxSpecial: () => gy,
  syntaxSpecialString: () => mv,
  syntaxSquareBracket: () => Ev,
  syntaxStandard: () => ny,
  syntaxStrikethrough: () => Uv,
  syntaxString: () => Nb,
  syntaxStrong: () => Lv,
  syntaxTag: () => Yb,
  syntaxTagName: () => Jb,
  syntaxType: () => ev,
  syntaxTypeName: () => cv,
  syntaxTypeOperator: () => Hv,
  syntaxUnit: () => pv,
  syntaxUpdateOperator: () => Mv,
  syntaxUrl: () => yv,
  syntaxVariable: () => $b,
  syntaxVariableName: () => Xb,
  textDisabled: () => Qm,
  textError: () => Xm,
  textHelper: () => Vm,
  textInverse: () => Km,
  textOnColor: () => Gm,
  textOnColorDisabled: () => Zm,
  textPlaceholder: () => $m,
  textPrimary: () => Wm,
  textSecondary: () => Um,
  toggleOff: () => Pb,
...
St(re, -8);
St(ax, 6), Qe(Y, 0.8);
Qe(Oe, 0.24), Qe(Oe, 0.24), Qe(Oe, 0.12), Qe(Oe, 0.12);
var ix = class e {
    static create(c) {
      return 'string' == typeof c
        ? new e(c)
        : new e(c.name, c.properties, c.state);
    }
    constructor(e, c, t) {
      (this.kind = 'Token'),
        (this.name = e),
  ...
  ox = class e {
    static create({ name: c, properties: t, tokens: d = [] }) {
      return new e(c, d, t);
    }
    constructor(e, c, t) {
      (this.kind = 'TokenGroup'),
        (this.name = e),
        t && (this.properties = t),
        (this.children = c.map((e) =>
          'TokenGroup' === e.kind ? e : ix.create(e)
        ));
    }
    *[Symbol.iterator]() {
      yield this;
      for (const e of this.children)
        yield e, 'TokenGroup' === e.kind && (yield* e);
    }
    getTokens(e = {}) {
      const c = {
        ...e,
        groups: e.groups ? e.groups.concat(this.name) : [this.name],
        properties: this.properties || e.properties,
      };
      return this.children.flatMap((e) => {
        if ('TokenGroup' === e.kind) return e.getTokens(c);
        const t = {
          ...c,
          name: e.name,
          properties: e.properties || c.properties,
        };
        return e.state && (t.state = e.state), t;
      });
    }
    getToken(e) {
      const c = 'string' == typeof e ? e : e.name;
      for (const e of this)
        if ('TokenGroup' !== e.kind && e.name === c) return e;
      return null;
    }
    getTokenGroups() {
      const e = new Set();
      for (const c of this) 'TokenGroup' === c.kind && e.add(c);
      return Array.from(e);
    }
    getTokenProperties() {
      const e = new Set();
      for (const c of this)
        if (Array.isArray(c.properties)) for (const t of c.properties) e.add(t);
      return Array.from(e);
    }
    getTokenStates() {
      const e = new Set();
      for (const c of this) 'Token' === c.kind && c.state && e.add(c.state);
      return Array.from(e);
    }
  };
const rx = ox.create({
    ...
    tokens: [
      'background',
      { name: 'background-active', state: 'active' },
      { name: 'background-selected', state: 'selected' },
      { name: 'background-selected-hover', state: 'hover' },
      { name: 'background-hover', state: 'hover' },
      'background-brand',
      'background-inverse',
      { state: 'hover', name: 'background-inverse-hover' },
    ],
  }),
  nx = ox.create({
    name: 'Layer',
    ...
    tokens: [
      { name: 'layer-01' },
      { state: 'active', name: 'layer-active-01' },
      { name: 'layer-background-01' },
      { state: 'hover', name: 'layer-hover-01' },
      { state: 'selected', name: 'layer-selected-01' },
      { state: 'hover', name: 'layer-selected-hover-01' },
      { name: 'layer-02' },
      { state: 'active', name: 'layer-active-02' },
      { name: 'layer-background-02' },
      { state: 'hover', name: 'layer-hover-02' },
      { state: 'selected', name: 'layer-selected-02' },
      { state: 'hover', name: 'layer-selected-hover-02' },
      { name: 'layer-03' },
      { state: 'active', name: 'layer-active-03' },
      { name: 'layer-background-03' },
      { state: 'hover', name: 'layer-hover-03' },
      { state: 'selected', name: 'layer-selected-03' },
      { state: 'hover', name: 'layer-selected-hover-03' },
      { name: 'layer-selected-inverse' },
      { state: 'disabled', name: 'layer-selected-disabled' },
      { name: 'layer-accent-01' },
      { state: 'active', name: 'layer-accent-active-01' },
      { state: 'hover', name: 'layer-accent-hover-01' },
      { name: 'layer-accent-02' },
      { state: 'active', name: 'layer-accent-active-02' },
      { state: 'hover', name: 'layer-accent-hover-02' },
      { name: 'layer-accent-03' },
      { state: 'active', name: 'layer-accent-active-03' },
      { state: 'hover', name: 'layer-accent-hover-03' },
    ],
  }),
  lx = ox.create({
    name: 'Field',
    ...
    tokens: [
      { name: 'field-01' },
      { state: 'hover', name: 'field-hover-01' },
      { name: 'field-02' },
      { state: 'hover', name: 'field-hover-02' },
      { name: 'field-03' },
      { state: 'hover', name: 'field-hover-03' },
    ],
  }),
  gx = ox.create({
    name: 'Borders',
    ...
    tokens: [
      ...
      { state: 'selected', name: 'border-subtle-selected-01' },
      { name: 'border-subtle-02' },
      { state: 'selected', name: 'border-subtle-selected-02' },
      { name: 'border-subtle-03' },
      { state: 'selected', name: 'border-subtle-selected-03' },
      'border-strong-01',
      'border-strong-02',
      'border-strong-03',
      'border-tile-01',
      ...
      'border-inverse',
      'border-interactive',
      { state: 'disabled', name: 'border-disabled' },
    ],
  }),
  hx = ox.create({
    name: 'Text',
    ...
    tokens: [
      ...
      'text-inverse',
      { name: 'text-on-color' },
      { state: 'disabled', name: 'text-on-color-disabled' },
      { state: 'disabled', name: 'text-disabled' },
    ],
  }),
  px = ox.create({
    name: 'Link',
    ...
    tokens: [
      { name: 'link-primary' },
      { state: 'hover', name: 'link-primary-hover' },
      'link-secondary',
      { state: 'visited', name: 'link-inverse-visited' },
      'link-visited',
      'link-inverse',
      'link-inverse-active',
      'link-inverse-hover',
  ...
  fx = ox.create({
    ...
    tokens: [
      ...
      'icon-inverse',
      { name: 'icon-on-color' },
      { state: 'disabled', name: 'icon-on-color-disabled' },
      { state: 'disabled', name: 'icon-disabled' },
      'icon-interactive',
    ],
  }),
  ux = ox.create({
  ...
  kx = ox.create({
    ...
    tokens: [
      ...
      nx,
      lx,
      { name: 'interactive', properties: ['background', 'text'] },
      gx,
      hx,
      px,
      fx,
      ...
      xx,
      { name: 'highlight' },
      { name: 'overlay', properties: ['background'] },
      { name: 'color-scheme', properties: ['color-scheme'] },
      { name: 'toggle-off' },
      { name: 'shadow' },
      mx,
      bx,
...
Ax.getTokens().map((e) => ({ name: e.name, type: 'color' })),
  Tx.getTokens().map((e) => ({ name: e.name, type: 'type' })),
  Px.getTokens().map((e) => ({ name: e.name, type: 'layout' }));
kx.getTokens().map((e) => ({ name: e.name, type: 'color' })),
  vx.getTokens().map((e) => ({ name: e.name, type: 'color' })),
  Object.values(_x).flatMap((e) =>
    e.getTokens().map((e) => ({ name: e.name, type: 'color' }))
  ),
  qx.getTokens().map((e) => ({ name: e.name, type: 'type' })),
  Hx.getTokens().map((e) => ({ name: e.name, type: 'layout' }));
const Fx = { white: Mt, g10: Xi, g90: ug, g100: Eu };
let Ix,
  Cx = (e) => e;
function Ex() {
  Ex = function () {
  ...
  var e = {
    ...
    decorateClass: function (e, c) {
      ...
      var a = this.decorateConstructor(t, c);
      return d.push.apply(d, a.finishers), (a.finishers = d), a;
    },
    ...
    decorateElement: function (e, c) {
      for (
        var t = [], d = [], s = e.decorators, a = s.length - 1;
        a >= 0;
        a--
      ) {
        var i = c[e.placement];
        ...
        var o = this.fromElementDescriptor(e),
          r = this.toElementFinisherExtras((0, s[a])(o) || o);
        (e = r.element),
          this.addElementPlacement(e, c),
          r.finisher && d.push(r.finisher);
        var n = r.extras;
        if (n) {
    ...
    decorateConstructor: function (e, c) {
      for (var t = [], d = c.length - 1; d >= 0; d--) {
        var s = this.fromClassDescriptor(e),
          a = this.toClassDescriptor((0, c[d])(s) || s);
        if (
          (void 0 !== a.finisher && t.push(a.finisher), void 0 !== a.elements)
        ) {
          e = a.elements;
          for (var i = 0; i < e.length - 1; i++)
            for (var o = i + 1; o < e.length; o++)
              if (e[i].key === e[o].key && e[i].placement === e[o].placement)
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return Wx(e, c);
...
const { prefix: Ux, stablePrefix: $x } = d;
!(function (e, c, t, d) {
  var s = Ex();
  if (d) for (var a = 0; a < d.length; a++) s = d[a](s);
  var i = c(function (e) {
      s.initializeInstanceElements(e, o.elements);
    }, t),
    o = s.decorateClass(
      (function (e) {
        for (
          ...
          var s,
            a = e[d];
          if ('method' === a.kind && (s = c.find(t)))
            if (Dx(a.descriptor) || Dx(s.descriptor)) {
              if (Ox(a) || Ox(s))
  ...
  s.initializeClassElements(i.F, o.elements),
    s.runClassFinishers(i.F, o.finishers);
})(
  [r(`${$x}-leadspace-with-search`)],
  function (e, d) {
    return {
      F: class extends d {
        constructor(...c) {
      ...
      d: [
        { kind: 'field', decorators: [c()], key: '_heading', value: () => '' },
        {
          kind: 'field',
          decorators: [
            c({ attribute: 'scroll-behavior', reflect: !0, type: Boolean }),
          ],
          key: '_scrollBehavior',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [c({ attribute: 'adjacent-theme', reflect: !0 })],
          key: 'adjacentTheme',
          value: () => Q.MONOTHEME,
        },
        {
          kind: 'field',
          decorators: [c({ attribute: 'dual-theme', reflect: !0 })],
          key: 'dualTheme',
          value: () => Z.MONOTHEME,
        },
        {
          ...
          value: function ({ target: e }) {
            var c;
            this._heading =
              null === (c = e.assignedNodes()[0].querySelector('h1')) ||
              void 0 === c
                ? void 0
                : c.innerText;
          },
        },
        {
          ...
          value: function () {
            return a({
              [`${Ux}--search-container`]: !0,
              [`${Ux}--search-container-dual-theme`]:
                this.adjacentTheme === Q.DUAL_THEME,
            });
          },
        },
        {
          ...
          value: function () {
            var e;
            (o.global.leadspaceSearch = this),
              null === (e = this.querySelector(`${$x}-leadspace-heading`)) ||
                void 0 === e ||
        ...
        },
        {
          ...
          value: function () {
            const e = window
              ...
              c = Object.keys(Fx).find((c) => Fx[c].background === e);
            if (this.adjacentTheme === Q.DUAL_THEME) {
              for (const e in Z)
                if (Z[e].startsWith(c)) {
                  this.dualTheme = Z[e];
                  break;
        ...
        },
        {
          ...
          value: function () {
            return t(
              Ix ||
                (Ix = Cx`
      <div part="content-layout" class="${0}--content-layout">
        <slot
          name="heading"
          @slotchange=${0}></slot>
        <div part="content-layout-body" class="${0}--content-layout__body">
          <slot name="copy"></slot>
        </div>
      </div>
      <div part="search-container" class="${0}">
        <div
          part="search-container-inner"
          class="${0}--search-container-inner">
          <div part="sticky-header" class="${0}--sticky-header">
            ${0}
          </div>
    ...
    `),
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${$x}--leadspace-with-search`;
          },
        },
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, c) {
            if (e) {
              if ('string' == typeof e) return ck(e, c);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
  ...
  return (
    (tk =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, c, t) {
            var d = (function (e, c) {
              for (; !{}.hasOwnProperty.call(e, c) && null !== (e = dk(e)); );
              return e;
            })(e, c);
            if (d) {
...
!(function (e, c, t, d) {
      ...
      (function (e) {
        for (
          ...
          var s,
            a = e[d];
          if ('method' === a.kind && (s = c.find(t)))
            if (Yx(a.descriptor) || Yx(s.descriptor)) {
              if (Qx(a) || Qx(s))
                throw new ReferenceError(
                  'Duplicated methods (' + a.key + ") can't be decorated."
                );
  ...
  [r(`${sk}-leadspace-with-search-copy`)],
  function (t, d) {
    class s extends d {
      constructor(...e) {
        super(...e), t(this);
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${sk}--leadspace-with-search-content-copy`;
          },
        },
        {
          kind: 'get',
    ...
    `),
              (function (e, c, t, d) {
                var s = tk(dk(1 & d ? e.prototype : e), c, t);
