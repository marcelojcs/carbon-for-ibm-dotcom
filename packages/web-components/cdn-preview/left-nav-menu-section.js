...
import { n as e, x as t, s as r, a as i } from './query-assigned-elements.js';
import { H as n } from './host-listener.js';
import { H as o } from './host-listener2.js';
import { b as s } from './tabs.js';
import { F as a } from './focus.js';
import { s as l } from './settings.js';
import { d as c, s as d } from './masthead-container.js';
  ...
  return (
    (E =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, t, r) {
            var i = (function (e, t) {
              for (; !{}.hasOwnProperty.call(e, t) && null !== (e = x(e)); );
              return e;
            })(e, t);
            if (i) {
...
const { prefix: P, stablePrefix: T } = r;
  ...
  function (r, i) {
      ...
      d: [
        {
          kind: 'field',
          decorators: [
            e({ type: String, attribute: 'aria-hidden', reflect: !0 }),
          ],
          key: 'ariaHidden',
          value: () => 'true',
        },
        {
          kind: 'field',
          decorators: [e({ attribute: 'back-button-text' })],
          key: 'backButtonText',
          value: () => 'Back',
        },
        {
          kind: 'field',
          decorators: [e({ type: Boolean, reflect: !0 })],
          key: 'expanded',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [e({ type: String, attribute: 'section-id' })],
          key: 'sectionId',
          value: () => '',
        },
        {
        ...
        {
          kind: 'field',
          decorators: [e({ type: Boolean, attribute: 'is-submenu' })],
          key: 'isSubmenu',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [
            e({ type: Boolean, reflect: !0, attribute: 'show-back-button' }),
          ],
          key: 'showBackBtn',
          value: () => !1,
        },
        { kind: 'field', decorators: [e()], key: 'title', value: () => '' },
        { kind: 'field', decorators: [e()], key: 'titleUrl', value: () => '' },
        {
          kind: 'method',
          key: '_requestLeftNavMenuSectionUpdate',
          value: async function () {
            const { eventToggle: e } = this.constructor;
            return new Promise((t) => {
              this.dispatchEvent(
                new CustomEvent(e, {
                  ...
                  cancelable: !0,
                  composed: !0,
                  detail: { active: this.expanded, resolveFn: t },
                })
              ),
                setTimeout(() => {
                  t();
        ...
        },
        {
          ...
          value: function () {
            ...
            this.dispatchEvent(new CustomEvent(e, i));
          },
        },
        {
          kind: 'method',
          decorators: [n('transitionend')],
        ...
        },
        {
          ...
          value: function () {
            '-1, -1' === this.sectionId
              ? ((this.expanded = !0), (this.ariaHidden = 'false'))
              : ((this.expanded = !1),
        ...
        },
        {
          ...
          value: function (e) {
            return (
              e.has('expanded') &&
                this.expanded &&
                ((this.style.visibility = ''), (this.style.height = '')),
              !0
            );
          },
        },
        {
          ...
          value: async function (e) {
            if (
              (await this._requestLeftNavMenuSectionUpdate(), e.has('expanded'))
            ) {
              const { expanded: e, isSubmenu: r } = this;
              if (e) {
                let e;
                var t;
                if (r)
                ...
                else e = this.getRootNode().querySelector(c.selectorNavItems);
                e &&
    ...
    `),
        ...
        },
        {
          ...
          key: 'eventToggle',
          value: function () {
            return `${T}-left-nav-menu-toggled`;
          },
        },
        {
          kind: 'get',
        ...
        },
        {
          ...
          value: function () {
            return [l, `${T}-left-nav-menu`, `${T}-left-nav-menu-item`].join(
              ','
            );
          },
        },
