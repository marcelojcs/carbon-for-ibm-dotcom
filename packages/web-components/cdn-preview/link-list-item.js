...
import { s as o } from './link-list.js';
import { S as s } from './stable-selector.js';
import { c as a } from './carbon-element.js';
import { C as l } from './link-with-icon.js';
import { L as c } from './link-list2.js';
let f,
  d = (e) => e;
function p() {
  p = function () {
  ...
  var e = {
    ...
    decorateElement: function (e, t) {
      for (
        ...
        var c = l.extras;
        if (c) {
          for (var f = 0; f < c.length; f++) this.addElementPlacement(c[f], t);
          r.push.apply(r, c);
        }
      }
        ...
        },
        {
          ...
          value: function () {
            ...
            this.hasAttribute('role') || this.setAttribute('role', 'heading'),
              ...
              (t = 'connectedCallback'),
              (r = this),
              (o = w(g(1 & (i = 3) ? e.prototype : e), t, r)),
              2 & i && 'function' == typeof o
                ? function (e) {
                    return o.apply(r, e);
                  }
                : o)([]);
...
function F(e, t, r, i) {
  var n = I(R(1 & i ? e.prototype : e), t, r);
      ...
      (function (e) {
        for (
          ...
          var n,
            o = e[i];
          if ('method' === o.kind && (n = t.find(r)))
            if (j(o.descriptor) || j(n.descriptor)) {
              if (T(o) || T(n))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
