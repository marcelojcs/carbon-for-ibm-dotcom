...
let process = { env: {} };
import { b, d as spread, e as CDSLink, n, x, i as ifNonEmpty, f as C4DMegaMenu, s as styles, c as carbonElement, a as settings } from './index-5becb925.js';
...
const svgResultCarbonIcon = ({ children, ...attrs } = {}) =>
  b`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${spread(
    attrs
 ...
 */
let C4DMegaMenuCategoryLink = _decorate([carbonElement(`${c4dPrefix}-megamenu-category-link`)], function (_initialize, _CDSLink) {
  class C4DMegaMenuCategoryLink extends _CDSLink {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
  ...
  return {
    ...
    d: [{
      ...
      key: "_targetMap",
      value() {
        return new Map([['external', svgResultCarbonIcon()]]);
      }
    }, {
      kind: "method",
      key: "_renderIcon",
    ...
    `), title ? x(_t2 || (_t2 = _`
          ...
          `), title, this._renderIcon(), this._handleSlotChange) : '');
      }
    }, {
      kind: "method",
      key: "_renderLink",
    ...
    `), classes, ifNonEmpty(linkRole), ifNonEmpty(download), ifNonEmpty(href), ifNonEmpty(hreflang), ifNonEmpty(ping), ifNonEmpty(rel), ifNonEmpty(target), ifNonEmpty(type), ifNonEmpty(handleClick), title, this._renderInner());
      }
    }, {
      kind: "method",
      key: "connectedCallback",
      value: function connectedCallback() {
        const megamenu = this.closest(`[data-autoid="${C4DMegaMenu.stableSelector}"`);
        this.layout = megamenu === null || megamenu === void 0 ? void 0 : megamenu.getAttribute('layout');
        _superPropGet(C4DMegaMenuCategoryLink, "connectedCallback", this, 3)([]);
      }
    }, {
      kind: "field",
      static: true,
...
export { C4DMegaMenuCategoryLink as default };
