 ...
 */
let C4DMegaMenuCategoryGroup = _decorate([carbonElement(`${c4dPrefix}-megamenu-category-group`)], function (_initialize, _LitElement) {
  class C4DMegaMenuCategoryGroup extends _LitElement {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
...
export { C4DMegaMenuCategoryGroup as default };
