...
import { s as e, b as t, x as r, n as i } from './query-assigned-elements.js';
import { C as n } from './dropdown.js';
import { s as o } from './search-with-typeahead.js';
import './validity.js';
import { c as s } from './carbon-element.js';
import { s as a } from './spread.js';
import { C as l } from './select.js';
import { I as c } from './text-input.js';
import { o as d } from './class-map.js';
import { l as p } from './if-defined.js';
import { c as f } from './collection-helpers.js';
function u(e, t) {
  var r = Object.keys(e);
          ...
          value: function (e) {
            if (this._selectionShouldChange(e)) {
              ...
              if (this.dispatchEvent(i)) {
                ...
                const i = new CustomEvent(r.eventSelect, t);
...
const { prefix: q, stablePrefix: B } = e;
!(function (e, t, r, i) {
  var n = I();
  if (i) for (var o = 0; o < i.length; o++) n = i[o](n);
  var s = t(function (e) {
  ...
  [s(`${B}-scoped-search-dropdown-mobile`)],
  function (e, n) {
    return {
      F: class extends n {
        constructor(...t) {
      ...
      d: [
        {
          kind: 'field',
          key: '_placeholderItemValueMobile',
          value: () =>
            `__${q}-select-placeholder_${Math.random().toString(36).slice(2)}`,
        },
        {
          kind: 'method',
          key: '_handleInputMobile',
          value: function ({ target: e }) {
            const { value: t } = e;
            this.value = t;
            const { eventSelect: r } = this.constructor;
            this.dispatchEvent(
              new CustomEvent(r, {
                bubbles: !0,
                composed: !0,
        ...
        {
          kind: 'method',
          key: '_renderItemsMobile',
          value: function (e) {
            const { selectorItem: t, selectorLeafItem: i } = this.constructor;
            return r(
              D ||
                (D = z`
      ${0}
        ...
        },
        {
          ...
          value: function () {
            const {
                ...
                invalidText: c,
                value: f,
                _placeholderItemValueMobile: u,
                _handleInputMobile: h,
              } = this,
              m = d({
                [`${q}--select-input`]: !0,
                [`${q}--select-input--${l}`]: l,
              }),
              v = d({ [`${q}--label`]: !0, [`${q}--label--disabled`]: e }),
              y = d({
                [`${q}--form__helper-text`]: !0,
                [`${q}--form__helper-text--disabled`]: e,
              }),
              b = n
                ? r(
                    T ||
    ...
    `),
              ...
              (({ children: e, ...r } = {}) =>
                t`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${a(
                  r
                )}" aria-hidden="true" width="20" height="20" viewBox="0 0 32 32">${e}<path d="M18,28H14a2,2,0,0,1-2-2V18.41L4.59,11A2,2,0,0,1,4,9.59V6A2,2,0,0,1,6,4H26a2,2,0,0,1,2,2V9.59A2,2,0,0,1,27.41,11L20,18.41V26A2,2,0,0,1,18,28ZM6,6V9.59l8,8V26h4V17.59l8-8V6Z"></path></svg>`)(
