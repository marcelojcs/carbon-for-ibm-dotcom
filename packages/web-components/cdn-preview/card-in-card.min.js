...
import { i as c, s as e, x as d } from './query-assigned-elements.js';
import { l as t } from './if-defined.js';
import { C as s } from './card.js';
import './card-cta.js';
import { C as o } from './image.js';
import { c as r } from './carbon-element.js';
import { S as i } from './stable-selector.js';
import { C as a } from './formatVideoCaption.js';
  ...
  var c = {
    ...
    decorateElement: function (c, e) {
      for (
        ...
        var r = e[c.placement];
        r.splice(r.indexOf(c.key), 1);
        var i = this.fromElementDescriptor(c),
          a = this.toElementFinisherExtras((0, s[o])(i) || i);
        (c = a.element),
          this.addElementPlacement(c, e),
          a.finisher && t.push(a.finisher);
        var l = a.extras;
        if (l) {
          for (var n = 0; n < l.length; n++) this.addElementPlacement(l[n], e);
          d.push.apply(d, l);
        }
      }
      ...
      for (var d = [], t = e.length - 1; t >= 0; t--) {
        ...
        if (
          ...
          for (var r = 0; r < c.length - 1; r++)
            for (var i = r + 1; i < c.length; i++)
              if (c[r].key === c[i].key && c[r].placement === c[i].placement)
                throw new TypeError('Duplicated element (' + c[r].key + ')');
        }
      }
    ...
    toElementDescriptors: function (c) {
      if (void 0 !== c)
        ...
        (function (c) {
          ...
          (function (c, e) {
            if (c) {
              if ('string' == typeof c) return _(c, e);
  ...
  return (
    (k =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (c, e, d) {
            var t = (function (c, e) {
              for (; !{}.hasOwnProperty.call(c, e) && null !== (c = y(c)); );
              return c;
            })(c, e);
            if (t) {
              var s = Object.getOwnPropertyDescriptor(t, e);
              return s.get ? s.get.call(arguments.length < 3 ? c : d) : s.value;
            }
          }),
...
const { stablePrefix: x } = e;
!(function (c, e, d, t) {
  var s = g();
  if (t) for (var o = 0; o < t.length; o++) s = t[o](s);
  var r = e(function (c) {
      s.initializeInstanceElements(c, i.elements);
    }, d),
    i = s.decorateClass(
      (function (c) {
        for (
          ...
          if ('method' === o.kind && (s = e.find(d)))
            if (b(o.descriptor) || b(s.descriptor)) {
              if (u(o) || u(s))
    ...
    toElementDescriptors: function (c) {
      if (void 0 !== c)
        ...
        (function (c) {
          ...
          (function (c, e) {
            if (c) {
              if ('string' == typeof c) return F(c, e);
              var d = {}.toString.call(c).slice(8, -1);
              return (
                'Object' === d && c.constructor && (d = c.constructor.name),
                'Map' === d || 'Set' === d
...
function B(c, e, d, t) {
  var s = I(M(1 & t ? c.prototype : c), e, d);
  return 2 & t && 'function' == typeof s
    ? function (c) {
        return s.apply(d, c);
      }
    : s;
  ...
  return (
    (I =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (c, e, d) {
            var t = (function (c, e) {
              for (; !{}.hasOwnProperty.call(c, e) && null !== (c = M(c)); );
              return c;
            })(c, e);
            if (t) {
              var s = Object.getOwnPropertyDescriptor(t, e);
...
const { prefix: R, stablePrefix: q } = e;
!(function (c, e, d, t) {
  var s = P();
  if (t) for (var o = 0; o < t.length; o++) s = t[o](s);
  var r = e(function (c) {
      ...
      (function (c) {
        for (
          ...
          var s,
            o = c[t];
          if ('method' === o.kind && (s = e.find(d)))
            if (A(o.descriptor) || A(s.descriptor)) {
              if (S(o) || S(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
  ...
  function (e, s) {
    ...
    `),
        ...
        },
        {
          ...
          key: 'updated',
          value: function (c) {
            B(o, 'updated', this, 3)([c]);
            const { _linkNode: e } = this;
            e && e.classList.add(`${R}--card-in-card`),
              (this.onclick = () => {
                var c;
                return null === (c = this.querySelector(`${q}-card-footer`)) ||
                  void 0 === c ||
                  null === (c = c.shadowRoot) ||
                  void 0 === c ||
                  null === (c = c.querySelector('a')) ||
                  void 0 === c
                  ? void 0
                  : c.click();
              });
