...
import { s as t } from './callout-with-media.js';
import { C as i } from './video-player-container.js';
import { C as o } from './defs2.js';
...
let h = (function (e, r, t, i) {
      ...
      (function (e) {
        for (
          ...
          if ('method' === n.kind && (o = r.find(t)))
            if (p(n.descriptor) || p(o.descriptor)) {
              if (c(n) || c(o))
  ...
  return (
    o.initializeClassElements(d.F, f.elements),
    o.runClassFinishers(d.F, f.finishers)
  );
})(
  [n(`${u}-callout-with-media-video`)],
  function (r, i) {
    return {
      F: class extends i {
        constructor(...e) {
