...
import { x as t, n as r, s as n, a as o } from './query-assigned-elements.js';
import { t as i } from './state.js';
import { s } from './content-block2.js';
 ...
 */ let d,
  ...
  v,
  k = (function (e) {
    return (e.SMALL = 'sm'), (e.REGULAR = 'md'), e;
  })({}),
  g = (function (e) {
    return (e.REGULAR = 'regular'), (e.WITH_BORDER = 'with-border'), e;
  })({}),
  b = (e) => e;
function w() {
  w = function () {
  ...
  var e = {
    ...
    decorateConstructor: function (e, t) {
      for (var r = [], n = t.length - 1; n >= 0; n--) {
        ...
        if (
          (void 0 !== i.finisher && r.push(i.finisher), void 0 !== i.elements)
        ) {
          e = i.elements;
...
const { prefix: P, stablePrefix: T } = n,
  x = {
  ...
  function (n, o) {
    return {
      ...
      d: [
        ...
        { kind: 'field', decorators: [i()], key: '_hasCopy', value: () => !1 },
        {
          kind: 'field',
          decorators: [i()],
          key: '_hasFooter',
        ...
        { kind: 'field', decorators: [i()], key: '_hasMedia', value: () => !1 },
        {
          kind: 'method',
          key: '_getContainerClasses',
          value: function () {
            const {
              complementaryStyleScheme: t,
              _hasContent: r,
              _hasComplementary: n,
              _hasFooter: o,
            } = this;
            return e({
              [`${P}--content-layout`]: !0,
              [`${P}--content-layout--with-children`]: r,
              [`${P}--content-layout--with-complementary`]: n,
              [`${P}--content-layout--with-footer`]: o,
              [`${P}--layout--border`]: t === g.WITH_BORDER,
            });
          },
        },
        {
    ...
    `),
        ...
        },
        {
          ...
          key: '_renderContent',
          value: function () {
            const { _handleSlotChange: e } = this;
            return t(c || (c = b` <slot @slotchange="${0}"></slot> `), e);
          },
        },
        {
          kind: 'method',
          ...
          value: function () {
            const { _handleSlotChange: e } = this;
            return t(
              u || (u = b` <slot name="copy" @slotchange="${0}"></slot> `),
              e
            );
          },
        },
        {
          ...
          key: '_renderFooter',
          value: function () {
            const { _hasFooter: e, _handleSlotChange: r } = this,
              n = this.querySelector(this.constructor.selectorCardGroup),
              o = null == n ? void 0 : n.getAttribute('style');
            return t(
              h ||
                (h = b`
      <div
    ...
    `),
              !e,
              e && `${T}--content-block-footer`,
              o,
              n,
              null == n ? void 0 : n.getAttribute('grid-mode'),
              r
            );
          },
        },
    ...
    `),
        ...
        },
        {
          ...
          value: function () {
            const { _handleSlotChange: e } = this;
            return t(
              m || (m = b` <slot name="media" @slotchange="${0}"></slot> `),
              e
            );
          },
        },
    ...
    `),
        ...
        {
          kind: 'field',
          decorators: [r({ attribute: 'complementary-style-scheme' })],
          key: 'complementaryStyleScheme',
          value: () => g.REGULAR,
        },
        {
          kind: 'method',
