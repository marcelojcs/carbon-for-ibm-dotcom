 ...
 */
let C4DMegaMenuCategoryGroupCopy = _decorate([carbonElement(`${c4dPrefix}-megamenu-category-group-copy`)], function (_initialize, _LitElement) {
  class C4DMegaMenuCategoryGroupCopy extends _LitElement {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
  ...
  return {
    F: C4DMegaMenuCategoryGroupCopy,
    d: [{
      kind: "method",
      key: "render",
...
export { C4DMegaMenuCategoryGroupCopy as default };
