...
import {
  ...
  x,
  q as o,
  j as svgResultCarbonIcon,
  k as svgResultCarbonIcon$1,
  s as styles,
  c as carbonElement,
  a as settings,
 ...
 */
let C4DLeftNavMenuCategoryHeading = _decorate(
  [carbonElement(`${c4dPrefix}-left-nav-menu-category-heading`)],
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function _renderHeading() {
            ...
            const headingClasses = {
              [`${prefix}--side-nav__menu-section-title`]:
        ...
        `),
                  ...
                  headingText,
                  headingText,
                  isRTL ? svgResultCarbonIcon() : svgResultCarbonIcon$1()
                )
              : x(
                  _t2 ||
                    (_t2 = _`
