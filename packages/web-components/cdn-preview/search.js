...
import { s as n } from './16.js';
import { s as o } from './spread.js';
import { p as l } from './settings.js';
import { i as p } from './if-non-empty.js';
import { F as h } from './focus.js';
import { F as u } from './form.js';
import { I as b } from './text-input.js';
import { H as m } from './host-listener.js';
import { H as f } from './host-listener2.js';
import { c as g } from './carbon-element.js';
/**
 * @license
 *
...
let x,
  ...
  k = s(
        ...
        d: [
          ...
          },
          {
            ...
            value: function () {
              ...
              null == e || e.setAttribute('part', 'search-icon'),
                null == e ||
                  e.setAttribute('class', `${l}--search-magnifier-icon`),
                null == e || e.setAttribute('role', 'img'),
                (this.hasCustomIcon = !0);
            },
          },
          {
            kind: 'method',
            ...
            value: function (e) {
              const { formData: s } = e,
                { disabled: i, name: t, value: c } = this;
              i || s.append(t, c);
            },
          },
          {
            kind: 'field',
            decorators: [a({ attribute: 'autocomplete' })],
            key: 'autoComplete',
            value: () => 'off',
          },
          {
            kind: 'field',
            decorators: [a({ attribute: 'close-button-label-text' })],
            key: 'closeButtonLabelText',
            value: () => '',
          },
          {
            kind: 'field',
            decorators: [a({ type: Boolean, reflect: !0 })],
            key: 'disabled',
            value: () => !1,
          },
          {
          ...
          {
            kind: 'field',
            decorators: [a({ attribute: 'label-text' })],
            key: 'labelText',
            value: () => '',
          },
          { kind: 'field', decorators: [a()], key: 'name', value: () => '' },
          { kind: 'field', decorators: [a()], key: 'role', value: () => '' },
          {
            kind: 'field',
            decorators: [a()],
            key: 'placeholder',
          ...
          {
            kind: 'field',
            decorators: [a({ reflect: !0 })],
            key: 'size',
            value: () => b.MEDIUM,
          },
          { kind: 'field', decorators: [a()], key: 'type', value: () => '' },
          {
            kind: 'field',
            decorators: [a({ type: String })],
            key: 'value',
            value: () => '',
          },
          {
            ...
            value: function () {
              const {
                  ...
                  value: f = '',
                  _handleInput: g,
                  _handleClearInputButtonClick: v,
                  _handleSlotChange: k,
                } = this,
                w = i({
                  [`${l}--search-close`]: !0,
                  [`${l}--search-close--hidden`]: !this.value,
                });
              return d(
                x ||
                  (x = z`
    ...
    `),
                  ...
                  : d(
                      ...
                      (({ children: e, ...s } = {}) =>
                        t`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${o(
                          s
                        )}" aria-hidden="true" width="16" height="16" viewBox="0 0 16 16">${e}${e}<path d="M15,14.3L10.7,10c1.9-2.3,1.6-5.8-0.7-7.7S4.2,0.7,2.3,3S0.7,8.8,3,10.7c2,1.7,5,1.7,7,0l4.3,4.3L15,14.3z M2,6.5	C2,4,4,2,6.5,2S11,4,11,6.5S9,11,6.5,11S2,9,2,6.5z"></path></svg>`)(
                        {
                          part: 'search-icon',
                          class: `${l}--search-magnifier-icon`,
                          role: 'img',
                        }
                      )
                    ),
                ...
                v,
                s,
                n({ part: 'close-icon', 'aria-label': s, role: 'img' })
              );
            },
          },
          {
