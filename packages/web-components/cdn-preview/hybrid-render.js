...
import { D as t } from './query-assigned-elements.js';
function e(t, e, r) {
  return (
    (e = (function (t) {
      var e = (function (t, e) {
...
const r = (r) =>
  class extends r {
    constructor(...t) {
      super(...t), e(this, 'lightRenderRoot', null);
    }
    ...
    update(e) {
      super.update(e),
        this.lightRenderRoot ||
          (this.lightRenderRoot = this.createLightRenderRoot());
      const { lightRenderRoot: r } = this;
      r && t(this.renderLightDOM(), r);
    }
  };
export { r as H };
