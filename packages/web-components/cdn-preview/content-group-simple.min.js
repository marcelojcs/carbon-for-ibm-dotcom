...
import { i as t, s as n } from './query-assigned-elements.js';
import { S as c } from './stable-selector.js';
  ...
  var t = {
    ...
    initializeClassElements: function (t, n) {
      ...
      ['method', 'field'].forEach(function (o) {
        n.forEach(function (n) {
          var s = n.placement;
          if (n.kind === o && ('static' === s || 'prototype' === s)) {
            var e = 'static' === s ? t : c;
    ...
    defineClassElement: function (t, n) {
      ...
      Object.defineProperty(t, n.key, c);
    },
    decorateClass: function (t, n) {
      ...
      if (
        ...
        t.forEach(function (t) {
          if (!m(t)) return c.push(t);
          var n = this.decorateElement(t, s);
          c.push(n.element),
            c.push.apply(c, n.extras),
            o.push.apply(o, n.finishers);
        }, this),
        !n)
      )
        return { elements: c, finishers: o };
      var e = this.decorateConstructor(c, n);
      return o.push.apply(o, e.finishers), (e.finishers = o), e;
    },
    addElementPlacement: function (t, n, c) {
      var o = n[t.placement];
      if (!c && -1 !== o.indexOf(t.key))
        throw new TypeError('Duplicated element (' + t.key + ')');
      o.push(t.key);
    },
    decorateElement: function (t, n) {
      for (
        var c = [], o = [], s = t.decorators, e = s.length - 1;
        e >= 0;
        e--
      ) {
        var d = n[t.placement];
        d.splice(d.indexOf(t.key), 1);
        var i = this.fromElementDescriptor(t),
          r = this.toElementFinisherExtras((0, s[e])(i) || i);
        (t = r.element),
          this.addElementPlacement(t, n),
          r.finisher && o.push(r.finisher);
        var l = r.extras;
        if (l) {
          for (var a = 0; a < l.length; a++) this.addElementPlacement(l[a], n);
          c.push.apply(c, l);
        }
      }
      return { element: t, finishers: o, extras: c };
    },
    decorateConstructor: function (t, n) {
      for (var c = [], o = n.length - 1; o >= 0; o--) {
        var s = this.fromClassDescriptor(t),
          e = this.toClassDescriptor((0, n[o])(s) || s);
        if (
          (void 0 !== e.finisher && c.push(e.finisher), void 0 !== e.elements)
        ) {
          t = e.elements;
          for (var d = 0; d < t.length - 1; d++)
            for (var i = d + 1; i < t.length; i++)
              if (t[d].key === t[i].key && t[d].placement === t[i].placement)
    ...
    fromElementDescriptor: function (t) {
      ...
      return (
        ...
        'field' === t.kind && (n.initializer = t.initializer),
        n
      );
    },
        ...
        (function (t) {
          ...
          (function (t, n) {
            if (t) {
              ...
              var c = {}.toString.call(t).slice(8, -1);
              return (
    ...
    toClassDescriptor: function (t) {
      ...
      var c = p(t, 'finisher');
      return { elements: this.toElementDescriptors(t.elements), finisher: c };
    },
    ...
    disallowProperty: function (t, n, c) {
      if (void 0 !== t[n])
        throw new TypeError(c + " can't have a ." + n + ' property.');
    },
  };
  return t;
}
function l(t) {
  var n,
    c = u(t.key);
  'method' === t.kind
    ? (n = { value: t.value, writable: !0, configurable: !0, enumerable: !1 })
    : 'get' === t.kind
    ? (n = { get: t.value, configurable: !0, enumerable: !1 })
    : 'set' === t.kind
    ? (n = { set: t.value, configurable: !0, enumerable: !1 })
    : 'field' === t.kind &&
...
function a(t, n) {
  void 0 !== t.descriptor.get
    ? (n.descriptor.get = t.descriptor.get)
    : (n.descriptor.set = t.descriptor.set);
}
function m(t) {
...
function h(t, n) {
  ...
  for (var c = 0, o = Array(n); c < n; c++) o[c] = t[c];
  return o;
}
function y() {
  return (
    (y =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (t, n, c) {
            var o = (function (t, n) {
              for (; !{}.hasOwnProperty.call(t, n) && null !== (t = f(t)); );
              return t;
            })(t, n);
            if (o) {
              var s = Object.getOwnPropertyDescriptor(o, n);
              return s.get ? s.get.call(arguments.length < 3 ? t : c) : s.value;
            }
          }),
...
const { stablePrefix: b } = n;
!(function (t, n, c, o) {
  var s = r();
  if (o) for (var e = 0; e < o.length; e++) s = o[e](s);
  var d = n(function (t) {
      s.initializeInstanceElements(t, i.elements);
    }, c),
    i = s.decorateClass(
      (function (t) {
        for (
          ...
          var s,
            e = t[o];
          if ('method' === e.kind && (s = n.find(c)))
            if (g(e.descriptor) || g(s.descriptor)) {
              if (m(e) || m(s))
                throw new ReferenceError(
                  'Duplicated methods (' + e.key + ") can't be decorated."
                );
              s.descriptor = e.descriptor;
            } else {
              if (m(e)) {
                if (m(s))
                  throw new ReferenceError(
  ...
  function (n, c) {
    ...
    `),
              ...
              (c = 'styles'),
              (s = this),
              (l = y(f(1 & r ? n.prototype : n), c, s)),
              2 & r && 'function' == typeof l
                ? function (t) {
                    return l.apply(s, t);
                  }
                : l),
  ...
  console.warn(
    'The content-group-simple component has been deprecated in favor of the content-group, image, and content-item components. See content-group, image, and content-item documentation for more information.'
  );
