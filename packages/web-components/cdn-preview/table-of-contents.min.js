...
import { l as s } from './if-defined.js';
import {
  b as d,
  i as n,
  n as c,
...
import { e as l } from './query-all.js';
import { s as g } from './spread.js';
import { H as m } from './host-listener.js';
import { H as p } from './host-listener2.js';
import { t as f } from './throttle.js';
import { S as u } from './StickyHeader.js';
import { S as h } from './stable-selector.js';
import { c as b } from './carbon-element.js';
import { M as y, a as x, b as v } from './media-query.js';
import './directive.js';
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */ const w = ({ children: e, ...s } = {}) =>
    d`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${g(
      s
    )}" aria-hidden="true" width="20" height="20" viewBox="0 0 32 32">${e}<path d="M10 16L20 6 21.4 7.4 12.8 16 21.4 24.6 20 26z"></path></svg>`,
  /**
   * @license
   *
   * Copyright IBM Corp. 2019, 2020
 ...
 */ let z,
  ...
  N,
  j = (function (e) {
    return (e.DEFAULT = ''), (e.HORIZONTAL = 'horizontal'), e;
  })({}),
  L = (e) => e;
function D() {
  D = function () {
  ...
  var e = {
    ...
    initializeInstanceElements: function (e, s) {
      ['method', 'field'].forEach(function (d) {
        s.forEach(function (s) {
          s.kind === d &&
            'own' === s.placement &&
            this.defineClassElement(e, s);
        }, this);
      }, this);
    },
    initializeClassElements: function (e, s) {
      var d = e.prototype;
      ['method', 'field'].forEach(function (n) {
        s.forEach(function (s) {
          var c = s.placement;
          if (s.kind === n && ('static' === c || 'prototype' === c)) {
            var i = 'static' === c ? e : d;
            this.defineClassElement(i, s);
          }
        }, this);
      }, this);
    },
    defineClassElement: function (e, s) {
      var d = s.descriptor;
      if ('field' === s.kind) {
        var n = s.initializer;
        d = {
      ...
      Object.defineProperty(e, s.key, d);
    },
    decorateClass: function (e, s) {
      var d = [],
        n = [],
      ...
      if (
        ...
        e.forEach(function (e) {
          if (!U(e)) return d.push(e);
          var s = this.decorateElement(e, c);
          d.push(s.element),
            d.push.apply(d, s.extras),
            n.push.apply(n, s.finishers);
        }, this),
        !s)
      )
        return { elements: d, finishers: n };
      var i = this.decorateConstructor(d, s);
      return n.push.apply(n, i.finishers), (i.finishers = n), i;
    },
    addElementPlacement: function (e, s, d) {
      var n = s[e.placement];
      if (!d && -1 !== n.indexOf(e.key))
        throw new TypeError('Duplicated element (' + e.key + ')');
      n.push(e.key);
    },
    decorateElement: function (e, s) {
      for (
        var d = [], n = [], c = e.decorators, i = c.length - 1;
        i >= 0;
        i--
      ) {
        var t = s[e.placement];
        ...
        var o = this.fromElementDescriptor(e),
          a = this.toElementFinisherExtras((0, c[i])(o) || o);
        (e = a.element),
          this.addElementPlacement(e, s),
          a.finisher && n.push(a.finisher);
        var r = a.extras;
        if (r) {
          for (var l = 0; l < r.length; l++) this.addElementPlacement(r[l], s);
          d.push.apply(d, r);
        }
      }
      return { element: e, finishers: n, extras: d };
    },
    decorateConstructor: function (e, s) {
      for (var d = [], n = s.length - 1; n >= 0; n--) {
        var c = this.fromClassDescriptor(e),
          i = this.toClassDescriptor((0, s[n])(c) || c);
        if (
          (void 0 !== i.finisher && d.push(i.finisher), void 0 !== i.elements)
        ) {
          e = i.elements;
          for (var t = 0; t < e.length - 1; t++)
            for (var o = t + 1; o < e.length; o++)
              if (e[t].key === e[o].key && e[t].placement === e[o].placement)
                throw new TypeError('Duplicated element (' + e[t].key + ')');
        }
      }
    ...
    fromElementDescriptor: function (e) {
      ...
      return (
        ...
        'field' === e.kind && (s.initializer = e.initializer),
        s
      );
    },
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, s) {
            if (e) {
              if ('string' == typeof e) return W(e, s);
          ...
          var s = this.toElementDescriptor(e);
          return (
    ...
    runClassFinishers: function (e, s) {
    ...
    disallowProperty: function (e, s, d) {
      if (void 0 !== e[s])
        throw new TypeError(d + " can't have a ." + s + ' property.');
    },
  };
  return e;
}
function H(e) {
  var s,
    d = V(e.key);
  'method' === e.kind
    ? (s = { value: e.value, writable: !0, configurable: !0, enumerable: !1 })
    : 'get' === e.kind
    ? (s = { get: e.value, configurable: !0, enumerable: !1 })
    : 'set' === e.kind
    ? (s = { set: e.value, configurable: !0, enumerable: !1 })
    : 'field' === e.kind &&
      (s = { configurable: !0, writable: !0, enumerable: !0 });
  var n = {
...
function X(e, s) {
  void 0 !== e.descriptor.get
    ? (s.descriptor.get = e.descriptor.get)
    : (s.descriptor.set = e.descriptor.set);
}
function U(e) {
...
function Z(e, s) {
  ...
  if (void 0 !== d && 'function' != typeof d)
    throw new TypeError("Expected '" + s + "' to be a function");
  return d;
}
function V(e) {
  var s = (function (e, s) {
...
function W(e, s) {
  ...
  for (var d = 0, n = Array(s); d < s; d++) n[d] = e[d];
  return n;
}
function G(e, s, d, n) {
  var c = J(K(1 & n ? e.prototype : e), s, d);
  return 2 & n && 'function' == typeof c
    ? function (e) {
        return c.apply(d, e);
      }
    : c;
  ...
  return (
    (J =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, s, d) {
            var n = (function (e, s) {
              for (; !{}.hasOwnProperty.call(e, s) && null !== (e = K(e)); );
              return e;
            })(e, s);
            if (n) {
              var c = Object.getOwnPropertyDescriptor(n, s);
              return c.get ? c.get.call(arguments.length < 3 ? e : d) : c.value;
            }
          }),
...
const { prefix: Q, stablePrefix: ee } = t,
  se = 32;
function de(e, s, d) {
  for (let n = e.length - 1; n >= 0; --n) if (s(e[n], n, d)) return n;
  return -1;
}
!(function (e, s, d, n) {
  var c = D();
  if (n) for (var i = 0; i < n.length; i++) c = n[i](c);
  var t = s(function (e) {
      c.initializeInstanceElements(e, o.elements);
    }, d),
    o = c.decorateClass(
      (function (e) {
        for (
          ...
          var c,
            i = e[n];
          if ('method' === i.kind && (c = s.find(d)))
            if (Y(i.descriptor) || Y(c.descriptor)) {
              if (U(i) || U(c))
  ...
  c.initializeClassElements(t.F, o.elements),
    c.runClassFinishers(t.F, o.finishers);
})(
  [b(`${ee}-table-of-contents`)],
  function (d, n) {
    class t extends n {
      constructor(...e) {
        super(...e), d(this);
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [c({ reflect: !0, attribute: 'toc-layout' })],
          key: 'layout',
          value: () => j.DEFAULT,
        },
        {
        ...
        {
          kind: 'field',
          decorators: [r(`.${Q}--tableofcontents`)],
          key: '_contentNode',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [r(`.${Q}--sub-content-left`)],
          key: '_intersectionLeftSentinelNode',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [r(`.${Q}--sub-content-right`)],
          key: '_intersectionRightSentinelNode',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [l(`.${Q}--tableofcontents__item`)],
          key: '_itemNodes',
          value: () => [],
        },
        {
          kind: 'field',
          decorators: [r(`.${Q}--tableofcontents__content`)],
          key: '_contentDiv',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [r(`.${Q}--tableofcontents__navbar`)],
          key: '_navBar',
          value: void 0,
        },
        {
        ...
        { kind: 'field', decorators: [a()], key: '_targets', value: () => [] },
        {
          kind: 'field',
        ...
        { kind: 'field', key: '_throttleScroll', value: () => null },
        {
          kind: 'method',
          key: '_handleClickItem',
          value: function (e) {
            var s;
            const { selectorItem: d } = this.constructor,
              n = e.target;
            null !== (s = n.matches) &&
              void 0 !== s &&
              s.call(n, d) &&
              (this._handleUserInitiatedJump(n.dataset.target),
              this._isMobile &&
                n.scrollIntoView({
                  block: 'nearest',
                  inline: 'center',
        ...
        },
        {
          ...
          value: function (e) {
            ...
            const { selectorItem: d } = this.constructor,
              n = e.target,
              { _pageIsRTL: c } = this,
              i = this.layout === j.HORIZONTAL || this._isMobile;
            if (null !== (s = n.matches) && void 0 !== s && s.call(n, d))
              if (c) {
                var t, o, a, r, l, g;
                if ('ArrowLeft' === e.key)
                  null === (t = n.parentElement) ||
                    void 0 === t ||
                    null === (t = t.nextElementSibling) ||
                    void 0 === t ||
                    null === (t = t.children[0]) ||
                    void 0 === t ||
                    t.focus(),
                    i &&
                      ...
                      (null === (a = n.parentElement) || void 0 === a
                        ? void 0
                        : a.previousElementSibling.getBoundingClientRect()
                            .right) >
                        this._navBar.getBoundingClientRect().right - se &&
                      this._paginateLeft();
                if ('ArrowRight' === e.key)
                  null === (r = n.parentElement) ||
                    void 0 === r ||
                    null === (r = r.previousElementSibling) ||
                    void 0 === r ||
                    null === (r = r.children[0]) ||
                    void 0 === r ||
                    r.focus(),
                    i &&
                      ...
                      (null === (g = n.parentElement) || void 0 === g
                        ? void 0
                        : g.nextElementSibling.getBoundingClientRect().left) <
                        this._navBar.getBoundingClientRect().left + se &&
                      this._paginateRight();
              } else {
                var m, p, f, u, h, b;
                if ('ArrowLeft' === e.key)
                  null === (m = n.parentElement) ||
                    void 0 === m ||
                    null === (m = m.previousElementSibling) ||
                    void 0 === m ||
                    null === (m = m.children[0]) ||
                    void 0 === m ||
                    m.focus(),
                    i &&
                      null !== (p = n.parentElement) &&
                      void 0 !== p &&
                      p.previousElementSibling &&
                      (null === (f = n.parentElement) || void 0 === f
                        ? void 0
                ...
                if ('ArrowRight' === e.key)
                  null === (u = n.parentElement) ||
                    void 0 === u ||
                    null === (u = u.nextElementSibling) ||
                    void 0 === u ||
                    null === (u = u.children[0]) ||
                    void 0 === u ||
                    u.focus(),
                    i &&
                      null !== (h = n.parentElement) &&
                      void 0 !== h &&
                      h.nextElementSibling &&
                      (null === (b = n.parentElement) || void 0 === b
                        ? void 0
                        : b.nextElementSibling.getBoundingClientRect().right) >
                        this._navBar.getBoundingClientRect().right - se &&
                      this._paginateRight();
              }
          },
                ...
                if (this._targets) {
                  const e = this._targets
                      .map((e, s, d) => ({
                        elem: e,
                        height: d[s + 1]
                          ? d[s + 1].getBoundingClientRect().y -
                            e.getBoundingClientRect().y
                          : null,
                        position: e.getBoundingClientRect().y,
                      }))
                      .filter((e, s, d) => {
                        if (null === e.height) {
                          var n;
                          ...
                          return (
                            !!e &&
                            e.position <
                              (null !== (n = e.height) && void 0 !== n ? n : 0)
                          );
                        }
                        return e.position - 50 - this.stickyOffset > -e.height;
                      }),
                    s =
        ...
        {
          kind: 'method',
          key: '_contentObserverCallback',
          value: function () {
            const e = this.shadowRoot,
              s = Array.from(e.querySelectorAll('slot')).flatMap((e) =>
                e.assignedNodes()
              );
            this._setTargets(s);
          },
        },
        {
          ...
          key: '_setTargets',
          value: function (e) {
            const { _tagNamesToAvoid: s, _disableTargetAttribute: d } = this,
              { selectorTarget: n } = this.constructor;
            this._targets = e.reduce((e, c) => {
              if (c instanceof HTMLElement) {
                const i = c.querySelectorAll(n),
                  t = [c, ...i].filter((e) => {
                    var c, i;
                    if (null == e.innerText && null == e.innerText) return !1;
                    const t = /[^\s\n\r]/g,
                      o =
                        (null === (c = e.innerText) || void 0 === c
                          ? void 0
                          : c.match(t)) ||
                        (null === (i = e.dataset.title) || void 0 === i
                          ? void 0
                          : i.match(t)),
                      a = e.matches(n),
                      r =
                        !s.includes(e.tagName.toLowerCase()) &&
                        !e.closest(`[${d}]`);
                    return o && a && r;
                  });
                e.push(...t);
        ...
        },
        {
          ...
          value: function (e) {
            ...
            this._setTargets(s),
              ...
              e.target.assignedNodes().forEach((e) => {
                e instanceof HTMLElement &&
                  this._contentMutationObserver.observe(e, {
                    subtree: !0,
                    childList: !0,
        ...
        {
          kind: 'method',
          key: '_handleUserInitiatedJump',
          value: function (e) {
            const s = this.querySelector(`[name="${e}"]`),
              d = this.ownerDocument.querySelector(`${ee}-masthead`);
            if (s instanceof HTMLElement) {
              const e = window.scrollY;
              let n;
              const c = s.getBoundingClientRect().top + e;
              (n =
                e > c && d
                  ? c - d.offsetHeight
                  : c -
                    parseInt(
                      window.getComputedStyle(s).getPropertyValue('padding-top')
                    ) -
                    parseInt(
                      window
                ...
                s.addEventListener(
                  'focusout',
                  ({ target: e }) => {
                    null == e || e.removeAttribute('tabindex');
                  },
                  { once: !0 }
                );
            }
        ...
        },
        {
          ...
          value: function ({ create: e } = {}) {
            const {
              _intersectionLeftSentinelNode: s,
              _intersectionRightSentinelNode: d,
            } = this;
            this._observerIntersection &&
              ...
              e &&
                ((this._observerIntersection = new IntersectionObserver(
                  ...
                  { root: this._navBar, threshold: 0 }
                )),
                s && this._observerIntersection.observe(s),
                d && this._observerIntersection.observe(d));
          },
        },
        {
          kind: 'field',
          ...
          value() {
            return (e) => {
              ...
              e.forEach(({ isIntersecting: e, target: n }) => {
                n === s && (this._isIntersectionLeftTrackerInContent = e),
                  n === d && (this._isIntersectionRightTrackerInContent = e);
              });
            };
          },
        },
        {
          ...
          value: function () {
            ...
            if (c)
              if (n) {
                const d = s.getBoundingClientRect().right,
                  n = de(c, (e) => e.getBoundingClientRect().right > d - se);
                if (n >= 0) {
                  const s = e - c[n].getBoundingClientRect().left + 48;
                  this._currentScrollPosition = s <= 0 ? 0 : s;
                }
              } else {
                const d = de(
                  c,
                  (e) =>
                    ...
                    se + s.getBoundingClientRect().left
                );
                if (d >= 0) {
                  const n =
                    c[d].getBoundingClientRect().right +
                    e -
                    s.getBoundingClientRect().right +
                    se;
                  this._currentScrollPosition = n <= 0 ? 0 : n;
                }
              }
          },
        },
            ...
            if (i)
              if (c) {
                const n = e.getBoundingClientRect().left,
                  c = i.findIndex(
                    (e) => e.getBoundingClientRect().left < n + se
                  );
                if (c > 0) {
                  const n = Math.abs(
                      i[c].getBoundingClientRect().right +
                        se -
                        e.getBoundingClientRect().right
                    ),
                    t = s.scrollWidth - e.offsetWidth;
                  this._currentScrollPosition = Math.min(n + d, t);
                }
              } else {
                const n = e.getBoundingClientRect().right,
                  c = i.findIndex(
                    (e) => e.getBoundingClientRect().right > n - se
                  );
                if (c > 0) {
                  const n =
                      i[c].getBoundingClientRect().left -
                      e.getBoundingClientRect().left -
                      se,
                    t = s.scrollWidth - e.offsetWidth;
                  this._currentScrollPosition = Math.min(n + d, t);
        ...
        {
          kind: 'field',
          decorators: [m(`document:${ee}-table-of-contents-reharvest`)],
          ...
          value: function () {
            G(t, 'connectedCallback', this, 3)([]),
              ...
              this._throttleScroll ||
                ((this._throttleScroll = f(this._handleOnScroll, 250)),
        ...
        },
        {
          ...
          value: function () {
            this._cleanAndCreateIntersectionObserverContainer(),
              this._contentMutationObserver.disconnect(),
              this._throttleScroll &&
                (this._throttleScroll.cancel(), (this._throttleScroll = null)),
        ...
        },
        {
          ...
          key: 'firstUpdated',
          value: function () {
            G(t, 'firstUpdated', this, 3)([]),
              this._cleanAndCreateIntersectionObserverContainer({ create: !0 }),
              (u.global.tableOfContents = this);
          },
        },
        {
          kind: 'method',
          ...
          value: function () {
            const {
                ...
                stickyOffset: n,
                _currentTarget: c,
                _currentScrollPosition: t,
                _hasHeading: o,
                _isIntersectionLeftTrackerInContent: a,
                _isIntersectionRightTrackerInContent: r,
                _isMobile: l,
                _targets: g,
                _handleClickItem: m,
                _handleOnKeyDown: p,
                _handleSlotChange: f,
                _handleSlotChangeHeading: u,
                _paginateLeft: h,
                _paginateRight: b,
                _pageIsRTL: y,
              } = this,
              x = e({
                [`${ee}-ce--table-of-contents__container`]:
                  d === j.DEFAULT && !l,
                [`${ee}-ce--table-of-contents-horizontal__container`]:
                  d === j.HORIZONTAL || l,
              }),
              v = e({
                [`${Q}--tableofcontents__sidebar`]: d === j.DEFAULT && !l,
                [`${Q}--tableofcontents__navbar`]: d === j.HORIZONTAL || l,
              }),
              _ = e({
                [`${Q}--toc__navbar-chevron-left-container`]: !0,
                [`${ee}-ce--toc__navbar-chevron-container--hidden`]: a,
              }),
              D = e({
                [`${Q}--toc__navbar-chevron-right-container`]: !0,
                [`${ee}-ce--toc__navbar-chevron-container--hidden`]: r,
              });
            return i(
              z ||
                (z = L`
    ...
    `),
          ...
          `),
                    ...
                    g.map((d) => {
                      var n, t;
                      const o = d.getAttribute('name'),
                        a = (
                          null !==
                            (n =
                              null !== (t = d.dataset.title) && void 0 !== t
                                ? t
                                : d.textContent) && void 0 !== n
                            ? n
                            : ''
                        ).trim(),
                        r = d === c,
                        l = e({
                          [`${Q}--tableofcontents__item`]: !0,
                          [`${Q}--tableofcontents__item--active`]: r,
                        });
                      return i(
                        $ ||
                          ($ = L`
              ...
              `),
                ...
                : '',
              ee,
              n && this.layout !== j.HORIZONTAL ? `${n}px` : 0,
              Q,
              Q,
              y ? 'right' : 'left',
              t,
        ...
        },
        {
          ...
          key: 'selectorItem',
          value: function () {
            return `.${Q}--tableofcontents__item a`;
          },
        },
        {
          kind: 'field',
