...
import { C as t, b as o } from './content-block.js';
...
import { i as n, x as i, s as c } from './query-assigned-elements.js';
import { c as d } from './carbon-element.js';
import { S as s } from './stable-selector.js';
import { C as r } from './content-group.js';
...
function g() {
  ...
  var t = {
    ...
    initializeInstanceElements: function (t, o) {
      ['method', 'field'].forEach(function (e) {
        o.forEach(function (o) {
          o.kind === e &&
            'own' === o.placement &&
            this.defineClassElement(t, o);
        }, this);
      }, this);
    },
    initializeClassElements: function (t, o) {
      var e = t.prototype;
      ['method', 'field'].forEach(function (n) {
        o.forEach(function (o) {
          var i = o.placement;
          if (o.kind === n && ('static' === i || 'prototype' === i)) {
            var c = 'static' === i ? t : e;
    ...
    defineClassElement: function (t, o) {
      var e = o.descriptor;
      if ('field' === o.kind) {
        var n = o.initializer;
        e = {
      ...
      Object.defineProperty(t, o.key, e);
    },
    decorateClass: function (t, o) {
      var e = [],
        n = [],
      ...
      if (
        ...
        t.forEach(function (t) {
          if (!v(t)) return e.push(t);
          var o = this.decorateElement(t, i);
          e.push(o.element),
            e.push.apply(e, o.extras),
            n.push.apply(n, o.finishers);
        }, this),
        !o)
      )
        return { elements: e, finishers: n };
      var c = this.decorateConstructor(e, o);
      return n.push.apply(n, c.finishers), (c.finishers = n), c;
    },
    addElementPlacement: function (t, o, e) {
      var n = o[t.placement];
      if (!e && -1 !== n.indexOf(t.key))
        throw new TypeError('Duplicated element (' + t.key + ')');
      n.push(t.key);
    },
    decorateElement: function (t, o) {
      for (
        var e = [], n = [], i = t.decorators, c = i.length - 1;
        c >= 0;
        c--
      ) {
        var d = o[t.placement];
        d.splice(d.indexOf(t.key), 1);
        var s = this.fromElementDescriptor(t),
          r = this.toElementFinisherExtras((0, i[c])(s) || s);
        (t = r.element),
          this.addElementPlacement(t, o),
          r.finisher && n.push(r.finisher);
        var a = r.extras;
        if (a) {
      ...
      return { element: t, finishers: n, extras: e };
    },
    decorateConstructor: function (t, o) {
      for (var e = [], n = o.length - 1; n >= 0; n--) {
        var i = this.fromClassDescriptor(t),
          c = this.toClassDescriptor((0, o[n])(i) || i);
        if (
          (void 0 !== c.finisher && e.push(c.finisher), void 0 !== c.elements)
        ) {
          t = c.elements;
          for (var d = 0; d < t.length - 1; d++)
            for (var s = d + 1; s < t.length; s++)
              if (t[d].key === t[s].key && t[d].placement === t[s].placement)
                throw new TypeError('Duplicated element (' + t[d].key + ')');
        }
      }
      return { elements: t, finishers: e };
    },
    fromElementDescriptor: function (t) {
      ...
      return (
        ...
        'field' === t.kind && (o.initializer = t.initializer),
        o
      );
    },
    toElementDescriptors: function (t) {
      if (void 0 !== t)
        ...
        (function (t) {
          ...
          var o = this.toElementDescriptor(t);
          return (
    ...
    toClassDescriptor: function (t) {
      ...
      var e = f(t, 'finisher');
      return { elements: this.toElementDescriptors(t.elements), finisher: e };
    },
    runClassFinishers: function (t, o) {
    ...
    disallowProperty: function (t, o, e) {
      if (void 0 !== t[o])
        throw new TypeError(e + " can't have a ." + o + ' property.');
    },
  };
  return t;
}
function h(t) {
  var o,
    e = y(t.key);
  'method' === t.kind
    ? (o = { value: t.value, writable: !0, configurable: !0, enumerable: !1 })
    : 'get' === t.kind
    ? (o = { get: t.value, configurable: !0, enumerable: !1 })
    : 'set' === t.kind
    ? (o = { set: t.value, configurable: !0, enumerable: !1 })
    : 'field' === t.kind &&
...
function b(t, o) {
  void 0 !== t.descriptor.get
    ? (o.descriptor.get = t.descriptor.get)
    : (o.descriptor.set = t.descriptor.set);
}
function v(t) {
  ...
  return (
    (x =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (t, o, e) {
            var n = (function (t, o) {
              for (; !{}.hasOwnProperty.call(t, o) && null !== (t = _(t)); );
              return t;
            })(t, o);
            if (n) {
...
const { prefix: w, stablePrefix: z } = c;
!(function (t, o, e, n) {
  var i = g();
  if (n) for (var c = 0; c < n.length; c++) i = n[c](i);
  var d = o(function (t) {
    ...
    s = i.decorateClass(
      (function (t) {
        for (
          ...
          var i,
            c = t[n];
          if ('method' === c.kind && (i = o.find(e)))
            if (u(c.descriptor) || u(i.descriptor)) {
              if (v(c) || v(i))
  ...
  i.initializeClassElements(d.F, s.elements),
    i.runClassFinishers(d.F, s.finishers);
})(
  [d(`${z}-content-block-segmented`)],
  function (t, c) {
    class d extends c {
      constructor(...o) {
        super(...o), t(this);
      ...
      d: [
        {
          ...
          value: function () {
            ...
            return e({
              [`${w}--content-layout`]: !0,
              [`${w}--content-layout--with-complementary`]: n,
              [`${z}-ce--content-layout--with-adjacent-heading-content`]:
                d && i && !c && !s,
              [`${w}--layout--border`]: t === o.WITH_BORDER,
            });
          },
        },
        {
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${z}--content-block-segmented`;
          },
        },
        {
          kind: 'get',
    ...
    `),
              (function (t, o, e, n) {
                var i = x(_(1 & n ? t.prototype : t), o, e);
  ...
  console.warn(
    'The content-block-segmented component has been deprecated in favor of the content-section/block and a variety of group components. See content-section/block documentation for more information.'
  );
let j,
  E,
  C,
  ...
  return (
    (R =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (t, o, e) {
            var n = (function (t, o) {
              for (; !{}.hasOwnProperty.call(t, o) && null !== (t = q(t)); );
              return t;
            })(t, o);
            if (n) {
              var i = Object.getOwnPropertyDescriptor(n, o);
...
const { prefix: M, stablePrefix: X } = c;
!(function (t, o, e, n) {
  var i = T();
  if (n) for (var c = 0; c < n.length; c++) i = n[c](i);
  var d = o(function (t) {
      ...
      (function (t) {
        for (
          ...
          var i,
            c = t[n];
          if ('method' === c.kind && (i = o.find(e)))
            if (O(c.descriptor) || O(i.descriptor)) {
              if (S(c) || S(i))
                throw new ReferenceError(
                  'Duplicated methods (' + c.key + ") can't be decorated."
                );
  ...
  [d(`${X}-content-block-segmented-item`)],
  function (t, o) {
    class e extends o {
      constructor(...o) {
        super(...o), t(this);
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: '_renderMedia',
          value: function () {
            const { _hasMedia: t, _handleSlotChange: o } = this;
            return i(
              E ||
                (E = P`
      <div
    ...
    `),
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${X}--content-block-segmented-item`;
          },
        },
        {
          kind: 'get',
    ...
    `),
              (function (t, o, e, n) {
                var i = R(q(1 & n ? t.prototype : t), o, e);
                return 2 & n && 'function' == typeof i
                  ? function (t) {
                      return i.apply(e, t);
                    }
  ...
  console.warn(
    'The content-block-segmented-item component has been deprecated in favor of the content-block component. See content-block documentation for more information.'
  );
