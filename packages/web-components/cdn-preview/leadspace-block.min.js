...
import './leadspace-heading.js';
import { C as a } from './content-block.js';
  ...
  var c = {
    ...
    initializeClassElements: function (c, e) {
      ...
      ['method', 'field'].forEach(function (d) {
        e.forEach(function (e) {
          var s = e.placement;
          if (e.kind === d && ('static' === s || 'prototype' === s)) {
            var o = 'static' === s ? c : t;
    ...
    decorateClass: function (c, e) {
      ...
      var o = this.decorateConstructor(t, e);
    ...
    decorateElement: function (c, e) {
      for (
        var t = [], d = [], s = c.decorators, o = s.length - 1;
        o >= 0;
        o--
      ) {
        var i = e[c.placement];
    ...
    decorateConstructor: function (c, e) {
      for (var t = [], d = e.length - 1; d >= 0; d--) {
        var s = this.fromClassDescriptor(c),
          o = this.toClassDescriptor((0, e[d])(s) || s);
        if (
...
const { prefix: x, stablePrefix: w } = d,
  z = { title: '_hasTitle' };
!(function (c, e, t, d) {
  var s = m();
  ...
  function (c, d) {
    return {
      ...
      d: [
        { kind: 'field', decorators: [o()], key: '_hasTitle', value: () => !1 },
        {
          kind: 'field',
    ...
    `),
              ...
              this._renderHeading(),
              x,
              this.border ? t(g || (g = h`<c4d-hr part="hr"></c4d-hr>`)) : ''
            );
          },
        },
        {
    ...
    toElementDescriptors: function (c) {
      if (void 0 !== c)
        ...
        (function (c) {
          ...
          (function (c, e) {
            if (c) {
              if ('string' == typeof c) return O(c, e);
              var t = {}.toString.call(c).slice(8, -1);
              return (
                'Object' === t && c.constructor && (t = c.constructor.name),
                'Map' === t || 'Set' === t
      ...
      (function (c) {
        for (
          ...
          var s,
            o = c[d];
          if ('method' === o.kind && (s = e.find(t)))
            if (D(o.descriptor) || D(s.descriptor)) {
              if (A(o) || A(s))
                throw new ReferenceError(
                  'Duplicated methods (' + o.key + ") can't be decorated."
                );
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${B}--leadspace-block__media`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => n },
      ],
...
function V(c, e, t, d) {
  var s = G(J(1 & d ? c.prototype : c), e, t);
  ...
  return (
    (G =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (c, e, t) {
            var d = (function (c, e) {
              for (; !{}.hasOwnProperty.call(c, e) && null !== (c = J(c)); );
              return c;
            })(c, e);
            if (d) {
              var s = Object.getOwnPropertyDescriptor(d, e);
              return s.get ? s.get.call(arguments.length < 3 ? c : t) : s.value;
            }
          }),
...
const { prefix: K, stablePrefix: Q } = d;
!(function (c, e, t, d) {
  var s = q();
  if (d) for (var o = 0; o < d.length; o++) s = d[o](s);
  var i = e(function (c) {
  ...
  function (e, d) {
      ...
      d: [
        {
          ...
          value: function () {
            const { _hasContent: c, _hasMedia: e } = this;
            return t(
              I ||
                (I = R`
      <div
    ...
    `),
        ...
        },
        {
          ...
          value: function () {
            const c = this.querySelector('c4d-link-list-heading');
            c && c.setAttribute('aria-level', '3'),
              V(s, 'connectedCallback', this, 3)([]);
          },
        },
        {
          kind: 'method',
    ...
    `),
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${Q}--leadspace-block-content`;
          },
        },
        {
          kind: 'get',
