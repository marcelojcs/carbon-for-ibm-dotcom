...
let process = { env: {} };
import { C as C4DMegaMenuRightNavigation, s as styles, c as carbonElement, a as settings } from './index-5becb925.js';
 ...
 */
let C4DMegaMenuLeftNavigation = _decorate([carbonElement(`${c4dPrefix}-megamenu-left-navigation`)], function (_initialize, _C4DMegaMenuRightNavi) {
  class C4DMegaMenuLeftNavigation extends _C4DMegaMenuRightNavi {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
...
}, C4DMegaMenuRightNavigation);

export { C4DMegaMenuLeftNavigation as default };
