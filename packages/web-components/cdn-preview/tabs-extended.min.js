...
!(function (e, t, r, i) {
  ...
  n.initializeClassElements(p.F, f.elements),
    n.runClassFinishers(p.F, f.finishers);
})(
  [i(`${u}-tab`)],
  function (e, r) {
    return {
      ...
      d: [
        ...
        },
        {
          kind: 'get',
          static: !0,
          key: 'eventTabSelected',
          value: function () {
            return `${u}-tab-selected`;
          },
        },
