...
import { i as e, x as o, n as t, s as r } from './query-assigned-elements.js';
import { o as n } from './class-map.js';
import { p as c } from './parseAspectRatio.js';
...
import { C as a } from './image.js';
import { C as l } from './card-link.js';
  ...
  var e = {
    ...
    initializeClassElements: function (e, o) {
      ...
      ['method', 'field'].forEach(function (r) {
        o.forEach(function (o) {
          var n = o.placement;
          if (o.kind === r && ('static' === n || 'prototype' === n)) {
            var c = 'static' === n ? e : t;
    ...
    decorateClass: function (e, o) {
      ...
      if (
        ...
        e.forEach(function (e) {
          ...
          var o = this.decorateElement(e, n);
          t.push(o.element),
      ...
      return r.push.apply(r, c.finishers), (c.finishers = r), c;
    },
    ...
    decorateElement: function (e, o) {
      for (
        var t = [], r = [], n = e.decorators, c = n.length - 1;
        c >= 0;
        c--
      ) {
        var d = o[e.placement];
        ...
        var s = this.fromElementDescriptor(e),
          i = this.toElementFinisherExtras((0, n[c])(s) || s);
        (e = i.element),
          this.addElementPlacement(e, o),
          i.finisher && r.push(i.finisher);
        var a = i.extras;
        if (a) {
    ...
    decorateConstructor: function (e, o) {
      for (var t = [], r = o.length - 1; r >= 0; r--) {
        var n = this.fromClassDescriptor(e),
          c = this.toClassDescriptor((0, o[r])(n) || n);
        if (
          (void 0 !== c.finisher && t.push(c.finisher), void 0 !== c.elements)
        ) {
          e = c.elements;
          for (var d = 0; d < e.length - 1; d++)
            for (var s = d + 1; s < e.length; s++)
              if (e[d].key === e[s].key && e[d].placement === e[s].placement)
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return E(e, o);
  ...
  return (
    (j =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, o, t) {
            var r = (function (e, o) {
              for (; !{}.hasOwnProperty.call(e, o) && null !== (e = P(e)); );
              return e;
            })(e, o);
            if (r) {
...
const { prefix: C, stablePrefix: D } = r;
!(function (e, o, t, r) {
  var n = f();
  if (r) for (var c = 0; c < r.length; c++) n = r[c](n);
  var d = o(function (e) {
    ...
    s = n.decorateClass(
      (function (e) {
        for (
          ...
          var n,
            c = e[r];
          if ('method' === c.kind && (n = o.find(t)))
            if (_(c.descriptor) || _(n.descriptor)) {
              if (x(c) || x(n))
                throw new ReferenceError(
                  'Duplicated methods (' + c.key + ") can't be decorated."
                );
              n.descriptor = c.descriptor;
            } else {
              if (x(c)) {
                if (x(n))
                  throw new ReferenceError(
  ...
  n.initializeClassElements(d.F, s.elements),
    n.runClassFinishers(d.F, s.finishers);
})(
  [i(`${D}-logo-grid`)],
  function (r, d) {
    class s extends d {
      ...
      d: [
        {
          ...
          value: function () {
            const { _hasContent: e, _hasMedia: t, logoCount: r } = this;
            return o(
              m ||
                (m = h`
      <div
        ?hidden="${0}"
        class="${0}--content-block__children ${0}--content-layout__body"
        part="content-body">
        <div class="${0}" part="content">
          ${0}${0}
        </div>
      </div>
    `),
        ...
        },
        {
          ...
          key: '_renderFooter',
          value: function () {
            const { _hasFooter: e, _handleSlotChange: t } = this;
            return o(
              g ||
                (g = h`
      <div
        ?hidden="${0}"
        class="${0}--content-block__cta-row"
        part="footer-container">
        <div
          class="${0}--content-block__cta ${0}-content-block__cta-col"
          part="footer">
    ...
    `),
        ...
        },
        {
          kind: 'field',
          decorators: [
            t({ attribute: 'hide-border', reflect: !0, type: Boolean }),
          ],
          key: 'hideBorder',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'logo-count', reflect: !0 })],
          key: 'logoCount',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'logo-ratio', reflect: !0 })],
          key: 'logoRatio',
          value: void 0,
        },
        {
          ...
          key: 'updated',
          value: function (e) {
            const { logoRatio: o } = this;
            if (e.has('logoRatio'))
              if (o) {
                const e = c(o);
                if (2 === e.length) {
                  const [o, t] = e;
                  this.style.setProperty('--logo-ratio', `${o}/${t}`);
                }
              } else this.style.removeProperty('--logo-ratio');
          },
        },
        {
          kind: 'method',
          ...
          value: function () {
            return o(
              u ||
                (u = h`
      <div class="${0}--content-layout--logo-grid" part="content-wrapper">
    ...
    `),
              (function (e, o, t, r) {
                var n = j(P(1 & r ? e.prototype : e), o, t);
  ...
  console.warn(
    'The logo-grid component has been deprecated in favor of the content-section/block and image-group component. See content-section/block and image-group documentation for more information.'
  );
let A,
  T = (e) => e;
function O() {
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return B(e, o);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
  ...
  return (
    (M =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, o, t) {
            var r = (function (e, o) {
              for (; !{}.hasOwnProperty.call(e, o) && null !== (e = X(e)); );
              return e;
            })(e, o);
            if (r) {
              var n = Object.getOwnPropertyDescriptor(r, o);
...
!(function (e, o, t, r) {
      ...
      (function (e) {
        for (
          ...
          var n,
            c = e[r];
          if ('method' === c.kind && (n = o.find(t)))
            if (R(c.descriptor) || R(n.descriptor)) {
              if (F(c) || F(n))
                throw new ReferenceError(
                  'Duplicated methods (' + c.key + ") can't be decorated."
                );
        ...
        },
        {
          ...
          value: function () {
            return o(
              A ||
                (A = T`
      <div class="cds--logo-grid__logo" part="logo">${0}</div>
    `),
              (function (e, o, t, r) {
                var n = M(X(1 & r ? e.prototype : e), o, t);
                return 2 & r && 'function' == typeof n
                  ? function (e) {
                      return n.apply(t, e);
                    }
  ...
  console.warn(
    'The logo-grid-item component has been deprecated in favor of the content-section/block and image-group component. See content-section/block and image-group documentation for more information.'
  );
let N,
  U = (e) => e;
function L() {
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return Q(e, o);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
  ...
  return (
    (W =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, o, t) {
            var r = (function (e, o) {
              for (; !{}.hasOwnProperty.call(e, o) && null !== (e = ee(e)); );
              return e;
            })(e, o);
            if (r) {
              var n = Object.getOwnPropertyDescriptor(r, o);
...
!(function (e, o, t, r) {
      ...
      (function (e) {
        for (
          ...
          var n,
            c = e[r];
          if ('method' === c.kind && (n = o.find(t)))
            if (G(c.descriptor) || G(n.descriptor)) {
              if (V(c) || V(n))
                throw new ReferenceError(
                  'Duplicated methods (' + c.key + ") can't be decorated."
                );
  ...
  function (o, r) {
    ...
    `),
              (function (e, o, t, r) {
                var n = W(ee(1 & r ? e.prototype : e), o, t);
                return 2 & r && 'function' == typeof n
                  ? function (e) {
                      return n.apply(t, e);
                    }
  ...
  console.warn(
    'The logo-grid-link component has been deprecated in favor of the content-section/block and image-group component. See content-section/block and image-group documentation for more information.'
  );
