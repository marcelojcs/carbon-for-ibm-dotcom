...
import { _ as t, a as e } from './get.js';
import { i as p, a as s, n as c, x as r } from './query-assigned-elements.js';
import { p as n } from './settings.js';
import { H as d } from './host-listener.js';
import { H as i } from './host-listener2.js';
import { o as a } from './class-map.js';
import { i as v } from './query.js';
import { c as l } from './carbon-element.js';
import { a as h } from './objectSpread2.js';
/**
 * @license
 *
...
function S(o) {
  return ['top', 'bottom'].includes(_(o)) ? 'y' : 'x';
}
function R(o) {
  return T(S(o));
}
function L(o, t, e) {
  ...
  let r =
    'x' === s
      ...
      ? 'bottom'
      : 'top';
  return t.reference[c] > t.floating[c] && (r = A(r)), [r, A(r)];
}
function $(o) {
  return o.replace(/start|end/g, (o) => x[o]);
}
function A(o) {
  return o.replace(/left|right|bottom|top/g, (o) => y[o]);
}
function O(o) {
...
function D(o) {
  const { x: t, y: e, width: p, height: s } = o;
  return {
    width: p,
    height: s,
    top: e,
...
function P(o, t, e) {
  let { reference: p, floating: s } = o;
  const c = S(t),
    r = R(t),
    n = E(r),
    d = _(t),
    i = 'y' === c,
    a = p.x + p.width / 2 - s.width / 2,
    v = p.y + p.height / 2 - s.height / 2,
    l = p[n] / 2 - s[n] / 2;
  let h;
  switch (d) {
    case 'top':
      h = { x: a, y: p.y - s.height };
      break;
    case 'bottom':
      h = { x: a, y: p.y + p.height };
      break;
    case 'right':
      h = { x: p.x + p.width, y: v };
      break;
...
async function X(o, t) {
  var e;
  void 0 === t && (t = {});
  const { x: p, y: s, platform: c, rects: r, elements: n, strategy: d } = o,
    {
    ...
    g = O(h),
    u = n[l ? ('floating' === v ? 'reference' : 'floating') : v],
    f = D(
      await c.getClippingRect({
        element:
          null == (e = await (null == c.isElement ? void 0 : c.isElement(u))) ||
          e
            ? u
            : u.contextElement ||
              (await (null == c.getDocumentElement
                ? void 0
                : c.getDocumentElement(n.floating))),
        boundary: i,
        rootBoundary: a,
        strategy: d,
      })
    ...
    b =
      'floating' === v
        ? { x: p, y: s, width: r.floating.width, height: r.floating.height }
        : r.reference,
    m = await (null == c.getOffsetParent
      ? void 0
      : c.getOffsetParent(n.floating)),
    C = ((await (null == c.isElement ? void 0 : c.isElement(m))) &&
      (await (null == c.getScale ? void 0 : c.getScale(m)))) || { x: 1, y: 1 },
    y = D(
  ...
  return {
    top: (f.top - y.top + g.top) / C.y,
    bottom: (y.bottom - f.bottom + g.bottom) / C.y,
    left: (f.left - y.left + g.left) / C.x,
    right: (y.right - f.right + g.right) / C.x,
  };
}
function B(o) {
...
function H(o) {
  var t;
  return (
    (null == o || null == (t = o.ownerDocument) ? void 0 : t.defaultView) ||
    window
  );
}
function N(o) {
  var t;
  return null == (t = (F(o) ? o.ownerDocument : o.document) || window.document)
    ? void 0
    : t.documentElement;
}
function F(o) {
  return o instanceof Node || o instanceof H(o).Node;
}
function j(o) {
  return o instanceof Element || o instanceof H(o).Element;
}
function q(o) {
  return o instanceof HTMLElement || o instanceof H(o).HTMLElement;
}
function M(o) {
  return (
    'undefined' != typeof ShadowRoot &&
    (o instanceof ShadowRoot || o instanceof H(o).ShadowRoot)
  );
}
function W(o) {
  const { overflow: t, overflowX: e, overflowY: p, display: s } = K(o);
  return (
    /auto|scroll|overlay|hidden|clip/.test(t + p + e) &&
...
function G(o) {
  return ['html', 'body', '#document'].includes(B(o));
}
function K(o) {
...
function Q(o) {
  if ('html' === B(o)) return o;
  const t = o.assignedSlot || o.parentNode || (M(o) && o.host) || N(o);
  return M(t) ? t.host : t;
}
function Z(o) {
  const t = Q(o);
...
function oo(o, t, e) {
  ...
  const s = Z(o),
    c = s === (null == (p = o.ownerDocument) ? void 0 : p.body),
    r = H(s);
  return c
    ? t.concat(
        r,
        r.visualViewport || [],
        W(s) ? s : [],
        r.frameElement && e ? oo(r.frameElement) : []
      )
    : t.concat(s, oo(s, [], e));
}
function to(o) {
  ...
  let e = parseFloat(t.width) || 0,
    p = parseFloat(t.height) || 0;
  const s = q(o),
    c = s ? o.offsetWidth : e,
    r = s ? o.offsetHeight : p,
    n = b(e) !== c || b(p) !== r;
  return n && ((e = c), (p = r)), { width: e, height: p, $: n };
}
function eo(o) {
...
function po(o) {
  ...
  const e = t.getBoundingClientRect(),
    { width: p, height: s, $: c } = to(t);
  let r = (c ? b(e.width) : e.width) / p,
    n = (c ? b(e.height) : e.height) / s;
  return (
...
function ro(o, t, e, p) {
  ...
  const s = o.getBoundingClientRect(),
    c = eo(o);
  let r = C(1);
  t && (p ? j(p) && (r = po(p)) : (r = po(o)));
  const n = (function (o, t, e) {
    return void 0 === t && (t = !1), !(!e || (t && e !== H(o))) && t;
  })(c, e, p)
    ? co(c)
    : C(0);
  let d = (s.left + n.x) / r.x,
    i = (s.top + n.y) / r.y,
    a = s.width / r.x,
    v = s.height / r.y;
  if (c) {
    ...
    for (; s && p && t !== e; ) {
      const o = po(s),
        ...
        p = K(s),
        c = t.left + (s.clientLeft + parseFloat(p.paddingLeft)) * o.x,
        r = t.top + (s.clientTop + parseFloat(p.paddingTop)) * o.y;
      (d *= o.x),
        (i *= o.y),
        (a *= o.x),
        (v *= o.y),
  ...
  return D({ width: a, height: v, x: d, y: i });
}
function no(o) {
  return ro(N(o)).left + J(o).scrollLeft;
}
function io(o, t, e) {
  let p;
  if ('viewport' === t)
    p = (function (o, t) {
      ...
      let c = p.clientWidth,
        ...
        d = 0;
      if (s) {
        (c = s.width), (r = s.height);
        const o = U();
        (!o || (o && 'fixed' === t)) && ((n = s.offsetLeft), (d = s.offsetTop));
      }
      return { width: c, height: r, x: n, y: d };
    })(o, e);
  else if ('document' === t)
    p = (function (o) {
      const t = N(o),
        e = J(o),
        p = o.ownerDocument.body,
        s = f(t.scrollWidth, t.clientWidth, p.scrollWidth, p.clientWidth),
        c = f(t.scrollHeight, t.clientHeight, p.scrollHeight, p.clientHeight);
      let r = -e.scrollLeft + no(o);
      const n = -e.scrollTop;
      return (
        'rtl' === K(p).direction && (r += f(t.clientWidth, p.clientWidth) - s),
        { width: s, height: c, x: r, y: n }
      );
    })(N(o));
  else if (j(t))
    p = (function (o, t) {
      const e = ro(o, !0, 'fixed' === t),
        p = e.top + o.clientTop,
        s = e.left + o.clientLeft,
        c = q(o) ? po(o) : C(1);
      return {
        width: o.clientWidth * c.x,
        height: o.clientHeight * c.y,
        x: s * c.x,
        y: p * c.y,
      };
    })(t, e);
    ...
    const e = co(o);
    p = { ...t, x: t.x - e.x, y: t.y - e.y };
  }
  return D(p);
}
function ao(o, t) {
  const e = Q(o);
  return !(e === t || !j(e) || G(e)) && ('fixed' === K(e).position || ao(e, t));
}
function vo(o, t, e) {
  const p = q(t),
    s = N(t),
  ...
  const d = C(0);
  if (p || (!p && !c))
    if ((('body' !== B(t) || W(s)) && (n = J(t)), p)) {
      const o = ro(t, !0, c, t);
      (d.x = o.x + t.clientLeft), (d.y = o.y + t.clientTop);
    } else s && (d.x = no(s));
  return {
    x: r.left + n.scrollLeft - d.x,
    y: r.top + n.scrollTop - d.y,
    width: r.width,
    height: r.height,
  };
}
function lo(o) {
  return 'static' === K(o).position;
}
function ho(o, t) {
  return q(o) && 'fixed' !== K(o).position ? (t ? t(o) : o.offsetParent) : null;
}
function go(o, t) {
  const e = H(o);
  if (I(o)) return e;
  if (!q(o)) {
    let t = Q(o);
    for (; t && !G(t); ) {
      if (j(t) && !lo(t)) return t;
      t = Q(t);
    }
    return e;
  }
  let p = ho(o, t);
  for (; p && V(p) && lo(p); ) p = ho(p, t);
  return p && G(p) && lo(p) && !Y(p)
    ? e
    : p ||
        (function (o) {
          let t = Q(o);
...
const uo = {
  convertOffsetParentRelativeRectToViewportRelativeRect: function (o) {
    let { elements: t, rect: e, offsetParent: p, strategy: s } = o;
    const c = 'fixed' === s,
      r = N(p),
      n = !!t && I(t.floating);
    if (p === r || (n && c)) return e;
    ...
    const a = C(0),
      v = q(p);
    if ((v || (!v && !c)) && (('body' !== B(p) || W(r)) && (d = J(p)), q(p))) {
      const o = ro(p);
      (i = po(p)), (a.x = o.x + p.clientLeft), (a.y = o.y + p.clientTop);
    }
    return {
      width: e.width * i.x,
      height: e.height * i.y,
      x: e.x * i.x - d.scrollLeft * i.x + a.x,
      y: e.y * i.y - d.scrollTop * i.y + a.y,
    };
  },
  getDocumentElement: N,
  getClippingRect: function (o) {
    let { element: t, boundary: e, rootBoundary: p, strategy: s } = o;
    const c = [
        ...('clippingAncestors' === e
          ? I(t)
            ? []
            : (function (o, t) {
                const e = t.get(o);
                if (e) return e;
                let p = oo(o, [], !1).filter((o) => j(o) && 'body' !== B(o)),
                  s = null;
                const c = 'fixed' === K(o).position;
                let r = c ? Q(o) : o;
                for (; j(r) && !G(r); ) {
                  const t = K(r),
                    e = Y(r);
                  e || 'fixed' !== t.position || (s = null),
                    (
                      c
                        ? !e && !s
                        : (!e &&
      ...
      n = c.reduce((o, e) => {
        ...
        return (
          (o.top = f(p.top, o.top)),
          (o.right = u(p.right, o.right)),
          (o.bottom = u(p.bottom, o.bottom)),
          (o.left = f(p.left, o.left)),
          o
        );
      }, io(t, r, s));
    return {
  ...
  getOffsetParent: go,
  getElementRects: async function (o) {
    const t = this.getOffsetParent || go,
      e = this.getDimensions,
      p = await e(o.floating);
    return {
      reference: vo(o.reference, await t(o.floating), o.strategy),
      floating: { x: 0, y: 0, width: p.width, height: p.height },
    };
  },
  getClientRects: function (o) {
    return Array.from(o.getClientRects());
  },
  getDimensions: function (o) {
    const { width: t, height: e } = to(o);
    return { width: t, height: e };
  },
  getScale: po,
  isElement: j,
  isRTL: function (o) {
    return 'rtl' === K(o).direction;
  },
};
function fo(o, t, e, p) {
  void 0 === p && (p = {});
  const {
      ...
      layoutShift: n = 'function' == typeof IntersectionObserver,
      animationFrame: d = !1,
    } = p,
    i = eo(o),
    a = s || c ? [...(i ? oo(i) : []), ...oo(t)] : [];
  a.forEach((o) => {
    s && o.addEventListener('scroll', e, { passive: !0 }),
      c && o.addEventListener('resize', e);
  });
  const v =
    i && n
      ? (function (o, t) {
          ...
          function c() {
            var o;
            clearTimeout(e), null == (o = p) || o.disconnect(), (p = null);
          }
          return (
            (function r(n, d) {
              ...
              const h = {
                rootMargin:
                  ...
                  -m(s.clientWidth - (i + v)) +
                  'px ' +
                  -m(s.clientHeight - (a + l)) +
                  'px ' +
                  -m(i) +
                  'px',
                threshold: f(0, u(1, d)) || 1,
              };
              let g = !0;
              function b(o) {
              ...
              try {
                ...
                p = new IntersectionObserver(b, h);
              }
              p.observe(o);
            })(!0),
            c
      ...
      (function t() {
        ...
        !b ||
          (p.x === b.x &&
            ...
            p.height === b.height) ||
          e();
        (b = p), (l = requestAnimationFrame(t));
      })(),
    e(),
    () => {
      var o;
      a.forEach((o) => {
        s && o.removeEventListener('scroll', e),
          c && o.removeEventListener('resize', e);
      }),
        null == v || v(),
        null == (o = g) || o.disconnect(),
        (g = null),
...
const bo = function (o) {
    return (
      void 0 === o && (o = 0),
      {
        ...
        async fn(t) {
          var e, p;
          const { x: s, y: c, placement: r, middlewareData: n } = t,
            d = await (async function (o, t) {
              const { placement: e, platform: p, elements: s } = o,
                c = await (null == p.isRTL ? void 0 : p.isRTL(s.floating)),
                r = _(e),
                n = w(e),
                d = 'y' === S(e),
              ...
              return (
                n && 'number' == typeof g && (h = 'end' === n ? -1 * g : g),
                d ? { x: h * a, y: l * i } : { x: l * i, y: h * a }
              );
            })(t, o);
          return r === (null == (e = n.offset) ? void 0 : e.placement) &&
            null != (p = n.arrow) &&
            p.alignmentOffset
            ? {}
            : { x: s + d.x, y: c + d.y, data: { ...d, placement: r } };
        },
      }
    );
  },
    ...
    return (
      void 0 === o && (o = {}),
      {
        ...
        async fn(t) {
          ...
          if (null != (e = c.arrow) && e.alignmentOffset) return {};
          const b = _(s),
            m = S(n),
            C = _(n) === n,
            y = await (null == d.isRTL ? void 0 : d.isRTL(i.floating)),
            x =
              l ||
              (C || !u
                ? [A(n)]
          ...
          const T = [n, ...x],
            E = await X(t, f),
            R = [];
          let O = (null == (p = c.flip) ? void 0 : p.overflows) || [];
          if ((a && R.push(E[b]), v)) {
            const o = L(s, r, y);
            R.push(E[o[0]], E[o[1]]);
          }
          if (
            ((O = [...O, { placement: s, overflows: R }]),
            !R.every((o) => o <= 0))
          ) {
            var D, P;
            const o = ((null == (D = c.flip) ? void 0 : D.index) || 0) + 1,
              t = T[o];
            if (t)
              return {
                data: { index: o, overflows: O },
                reset: { placement: t },
              };
            let e =
              null ==
              (P = O.filter((o) => o.overflows[0] <= 0).sort(
            ...
            if (s !== e) return { reset: { placement: e } };
          }
          return {};
        },
      }
  ...
  Co = (o) => ({
    ...
    async fn(t) {
      const {
        ...
        { element: i, padding: a = 0 } = k(o, t) || {};
      if (null == i) return {};
      const v = O(a),
        l = { x: e, y: p },
        h = R(s),
        g = E(h),
        f = await r.getDimensions(i),
        b = 'y' === h,
        m = b ? 'top' : 'left',
        C = b ? 'bottom' : 'right',
        y = b ? 'clientHeight' : 'clientWidth',
        x = c.reference[g] + c.reference[h] - l[h] - c.floating[g],
        _ = l[h] - c.reference[h],
        T = await (null == r.getOffsetParent ? void 0 : r.getOffsetParent(i));
      let S = T ? T[y] : 0;
      (S && (await (null == r.isElement ? void 0 : r.isElement(T)))) ||
        (S = n.floating[y] || c.floating[g]);
      const L = x / 2 - _ / 2,
        $ = S / 2 - f[g] / 2 - 1,
        A = u(v[m], $),
        D = u(v[C], $),
        ...
        N =
          ...
          null != w(s) &&
          B !== H &&
          c.reference[g] / 2 - (B < P ? A : D) - f[g] / 2 < 0,
        F = N ? (B < P ? B - P : B - X) : 0;
      return {
        [h]: l[h] + F,
        data: {
  ...
  yo = (o, t, e) => {
    ...
    return (async (o, t, e) => {
      const {
        ...
        n = c.filter(Boolean),
        d = await (null == r.isRTL ? void 0 : r.isRTL(t));
      let i = await r.getElementRects({
          reference: o,
          floating: t,
          strategy: s,
        }),
        ...
        const { name: c, fn: u } = n[e],
          {
            ...
            rects: i,
            platform: r,
            elements: { reference: o, floating: t },
          });
        (a = null != f ? f : a),
          (v = null != b ? b : v),
          (h = { ...h, [c]: { ...h[c], ...m } }),
      ...
      return { x: a, y: v, placement: l, strategy: s, middlewareData: h };
    })(o, t, { ...s, platform: c });
  };
class xo {
  constructor(o) {
    h(this, 'updatePlacement', () => {
      this.computePlacement();
    }),
      (this.host = o).addController(this);
  }
  async setPlacement(o = this.options) {
    this.options = o;
    const { trigger: t, target: e } = o;
    this.cleanup = fo(t, e, this.updatePlacement);
  }
  async computePlacement() {
    ...
    const r = [
      mo({ fallbackAxisSideDirection: 'start' }),
      bo(e ? 10 : 0),
      ...(e && o ? [Co({ element: o, padding: 15 })] : []),
    ];
    if (this.host.hasAttribute('open')) {
      const {
        ...
        middlewareData: i,
        strategy: a,
      } = await yo(p, s, { strategy: 'fixed', middleware: r, placement: c });
      if (
        ((s.style.left = `${t}px`),
        (s.style.top = `${e}px`),
        (s.style.position = `${a}`),
        ...
        const { x: t, y: e } = i.arrow,
          p = { top: 'bottom', right: 'left', bottom: 'top', left: 'right' }[
            d.split('-')[0]
          ];
        (o.style.left = null != t ? `${t}px` : ''),
          (o.style.top = null != e ? `${e}px` : ''),
          (o.style.right = ''),
          (o.style.bottom = ''),
          (o.style[p] = -o.offsetWidth / 2 + 'px');
      }
      var n;
      if ('CDS-SLUG' === this.host.tagName)
        null === (n = this.host) ||
          void 0 === n ||
          n.setAttribute('alignment', d);
    }
  }
  hostUpdated() {
    var o;
    this.host.hasAttribute('open') ||
      (null === (o = this.cleanup) || void 0 === o || o.call(this),
      (this.cleanup = void 0));
  }
  hostDisconnected() {
    var o;
  ...
  To = o(
      ...
      return {
        ...
        d: [
          ...
          },
          {
            kind: 'field',
            decorators: [v('slot')],
            key: '_triggerSlotNode',
            value: void 0,
          },
          {
            kind: 'field',
            decorators: [v('slot[name="content"]')],
            key: '_contentSlotNode',
            value: void 0,
          },
          {
            kind: 'field',
            decorators: [c({ reflect: !0, type: String })],
            key: 'align',
            value: () => '',
          },
          {
            ...
            value: function ({ target: o }) {
              if (this.tabTip) {
                o.assignedNodes()
                  ...
                  .classList.add(`${n}--popover--tab-tip__button`);
              }
              this.requestUpdate();
            },
          },
          {
            ...
            key: 'updated',
            value: function (o) {
              const { selectorPopoverContent: t } = this.constructor;
              if (
                ([
                  'open',
                  'align',
                  ...
                  if (o.has(e)) {
                    const { [e]: o } = this;
                    this.querySelector(t) && (this.querySelector(t)[e] = o);
                  }
                }),
                this.autoalign && this.open)
              ) {
                var p, s;
                const o = this._triggerSlotNode.assignedElements()[0],
                  t = this._contentSlotNode.assignedElements()[0],
                  r =
                    null == t || null === (p = t.shadowRoot) || void 0 === p
                      ? void 0
                      : p.querySelector(e.selectorPopoverContentClass),
                  n =
                    null == t || null === (s = t.shadowRoot) || void 0 === s
                      ? void 0
                      : s.querySelector(e.selectorPopoverCaret);
                var c;
                if (o && r)
                  null === (c = this.popoverController) ||
                    void 0 === c ||
                    c.setPlacement({
                      trigger: o,
                      target: r,
                      arrowElement: this.caret && n ? n : void 0,
                      caret: this.caret,
                      flip: !0,
            ...
            value: function () {
              ...
              p && (this.caret = !p),
                (this.align = this.align
                  ...
                  : 'bottom');
              const c = a({
                [`${n}--popover-container`]: !0,
                [`${n}--popover--caret`]: this.caret,
                [`${n}--popover--drop-shadow`]: o,
                [`${n}--popover--high-contrast`]: t,
                [`${n}--popover--open`]: e,
                [`${n}--popover--${this.align}`]: !0,
                [`${n}--popover--tab-tip`]: p,
              });
              return r(
                zo ||
    ...
    `),
          ...
          },
          {
            kind: 'get',
            static: !0,
            key: 'selectorPopoverContentClass',
            value: function () {
              return `.${n}--popover-content`;
            },
          },
          {
            kind: 'get',
            static: !0,
            key: 'selectorPopoverCaret',
            value: function () {
              return `.${n}--popover-caret`;
            },
          },
          {
            kind: 'get',
...
let Lo,
  $o = (o) => o;
function Ao(o, p, s, c) {
  var r = t(e(1 & c ? o.prototype : o), p, s);
  return 2 & c
    ? function (o) {
        return r.apply(s, o);
      }
    ...
    return {
      ...
      d: [
        ...
        },
        {
          kind: 'field',
          decorators: [
            c({ type: Boolean, reflect: !0, attribute: 'data-table' }),
          ],
          key: 'dataTable',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [c({ reflect: !0, type: Boolean })],
        ...
        {
          kind: 'field',
          decorators: [c({ attribute: 'enter-delay-ms', type: Number })],
          key: 'enterDelayMs',
          value: () => 100,
        },
        {
          kind: 'field',
          decorators: [c({ attribute: 'leave-delay-ms', type: Number })],
          key: 'leaveDelayMs',
          value: () => 300,
        },
        {
        ...
        },
        {
          kind: 'field',
          decorators: [
            c({ reflect: !0, attribute: 'toolbar-action', type: Boolean }),
          ],
          key: 'toolbarAction',
          value: () => !1,
        },
            ...
            return async () => {
              window.clearTimeout(this.timeoutId),
                (this.timeoutId = window.setTimeout(async () => {
                  this.open = !0;
                  const { open: o, updateComplete: t } = this;
                  if (o) {
                    var e;
                    await t;
                    const { selectorTooltipContent: o } = this.constructor;
                    null === (e = this.querySelector(o)) ||
                      void 0 === e ||
                      e.focus();
                  }
                }, this.enterDelayMs));
        ...
        },
        {
          ...
          value() {
            return async () => {
              this.closeOnActivation && this._handleHoverOut();
            };
          },
        },
        {
          ...
          value() {
            return async (o) => {
              (' ' !== o.key && 'Enter' !== o.key && 'Escape' !== o.key) ||
        ...
        },
        {
          ...
          value: function ({ target: o }) {
            ...
            t[0] &&
              (t[0].addEventListener('focus', this._handleHover),
              t[0].addEventListener('focusout', this._handleHoverOut),
              t[0].addEventListener('mouseover', this._handleHover),
              t[0].addEventListener('mouseleave', this._handleHoverOut),
              this.requestUpdate());
          },
        },
        {
          ...
          value: function () {
            this.hasAttribute('highContrast') ||
              this.setAttribute('highContrast', ''),
              this.shadowRoot || this.attachShadow({ mode: 'open' }),
              Ao(e, 'connectedCallback', this, 3)([]);
          },
        },
        {
          kind: 'method',
          ...
          value: function (o) {
            var t;
            const { selectorTooltipContent: p } = this.constructor,
              s = this.querySelector(p);
            o.has('defaultOpen') && (this.open = this.defaultOpen),
              o.has('open') &&
                (this.open
                  ? null == s || s.setAttribute('open', '')
                  : null == s || s.removeAttribute('open')),
              ['align', 'caret', 'autoalign'].forEach((t) => {
                if (o.has(t)) {
                  const { [t]: o } = this;
                  s[t] = o;
                }
              ...
              null === (t = this.shadowRoot) ||
                void 0 === t ||
                null === (t = t.querySelector(`.${n}--popover-container`)) ||
                void 0 === t ||
                t.classList.add(`${n}--tooltip`),
              Ao(e, 'updated', this, 3)([o]);
          },
        },
        {
          kind: 'get',
