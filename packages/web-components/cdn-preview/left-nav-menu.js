...
import { s as a } from './masthead-container.js';
...
const { prefix: j, stablePrefix: w } = i;
  ...
  function (e, i) {
      ...
      d: [
        {
          ...
          value: function (e = !this.expanded, t = this.panelId) {
            const { eventBeforeToggle: r, eventToggle: i } = this.constructor,
              n = {
                bubbles: !0,
                cancelable: !0,
                composed: !0,
            ...
            this.dispatchEvent(new CustomEvent(r, n)) &&
              ((this.expanded = e), this.dispatchEvent(new CustomEvent(i, n)));
          },
        },
        {
          kind: 'method',
        ...
        {
          kind: 'field',
          decorators: [t({ type: String, attribute: 'panel-id' })],
          key: 'panelId',
          value: () => '',
        },
        ...
        },
        {
          ...
          value: function () {
            ...
            const {
              ...
              l = n({
                [`${j}--side-nav__submenu`]: !0,
                [`${j}--masthead__side-nav--submemu--selected`]: t,
              }),
              p =
    ...
    `),
        ...
        },
        {
          ...
          value: function () {
            return `${w}-left-nav-menu-beingtoggled`;
          },
        },
        {
          kind: 'get',
          ...
          key: 'eventToggle',
          value: function () {
            return `${w}-left-nav-menu-toggled`;
          },
        },
