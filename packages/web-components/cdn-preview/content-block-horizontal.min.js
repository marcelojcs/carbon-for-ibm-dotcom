...
import { i as c, n as e, x as d, s as t } from './query-assigned-elements.js';
import { c as s } from './carbon-element.js';
import { C as o } from './content-group.js';
import './horizontal-rule.js';
import './content-block-heading.js';
import './content-block-complementary.js';
import './content-item-row-media-featured.js';
import './content-item-row-media.js';
import './content-item-heading.js';
import './button-cta.js';
import './card-cta.js';
...
function k(c, e, d, t) {
  var s = _(y(1 & t ? c.prototype : c), e, d);
...
const { stablePrefix: x } = t;
!(function (c, e, d, t) {
  var s = p();
  if (t) for (var o = 0; o < t.length; o++) s = t[o](s);
  var i = e(function (c) {
      s.initializeInstanceElements(c, r.elements);
    }, d),
    r = s.decorateClass(
      (function (c) {
        for (
          ...
          if ('method' === o.kind && (s = e.find(d)))
            if (u(o.descriptor) || u(s.descriptor)) {
              if (h(o) || h(s))
  ...
  function (t, s) {
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [e({ type: Boolean, reflect: !0, attribute: 'border' })],
          key: 'border',
          value: () => !1,
        },
        {
    ...
    `),
              k(o, 'render', this, 3)([]),
              this.border ? d(a || (a = l` <c4d-hr part="hr"></c4d-hr> `)) : ''
            );
          },
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${x}--content-block-horizontal`;
          },
        },
        {
          kind: 'get',
  ...
  console.warn(
    'The content-block-horizontal component has been deprecated in favor of the content-section/block and content item horizontal component. See content-section/block and content item horizontal documentation for more information.'
  );
