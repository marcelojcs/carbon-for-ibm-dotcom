...
let process = { env: {} };
import { _ as _decorate$1, F as FocusMixin, g as s, n, x, p as prefix$1, l as _objectSpread2, B as styles, c as carbonElement, t as _get$1, u as _getPrototypeOf$1, q as o, s as styles$1, a as settings, D as svgResultCarbonIcon, E as svgResultCarbonIcon$1 } from './index-5becb925.js';
 ...
 */
let CDSSideNavMenuItem = _decorate$1([carbonElement(`${prefix$1}-side-nav-menu-item`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      value: function connectedCallback() {
        ...
        _superPropGet$1(CDSSideNavMenuItem, "connectedCallback", this, 3)([]);
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        ...
        const classes = o({
          [`${prefix$1}--side-nav__link`]: true,
          [`${prefix$1}--side-nav__link--current`]: active
        });
 ...
 */
let C4DLeftNavMenuItem = _decorate([carbonElement(`${c4dPrefix}-left-nav-menu-item`)], function (_initialize, _CDSSideNavMenuItem) {
  class C4DLeftNavMenuItem extends _CDSSideNavMenuItem {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
  ...
  return {
    ...
    d: [{
      ...
      value: function updated(changedProperties) {
        _superPropGet(C4DLeftNavMenuItem, "updated", this, 3)([changedProperties]);
      ...
      value: function render() {
        ...
        const Arrow = isRTL ? svgResultCarbonIcon : svgResultCarbonIcon$1;
        const linkClasses = o({
          [`${prefix}--side-nav__link`]: true,
          [`${prefix}--side-nav__link--current`]: active
        });
        return href ? x(_t || (_t = _`
          <a
            part="link"
            class="${0}"
            href="${0}"
        ...
        `), linkClasses, href, title, prefix, title, isHeading || isViewAll ? Arrow() : '') : x(_t2 || (_t2 = _`
          <span part="link" class="${0}">
            <span part="title" class="${0}--side-nav__link-text">
              <slot>${0}</slot>
            </span>
          </span>
        `), linkClasses, prefix, title);
      }
    }, {
      kind: "field",
      static: true,
...
export { C4DLeftNavMenuItem as default };
