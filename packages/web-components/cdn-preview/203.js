 ...
 */ const t = ({ children: t, ...r } = {}) =>
    e`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${s(
      r
    )}" aria-hidden="true" width="20" height="20" viewBox="0 0 32 32">${t}<path d="M20 24L10 16 20 8z"></path></svg>`,
  /**
   * @license
   *
   * Copyright IBM Corp. 2019, 2020
   ...
   */ r = ({ children: t, ...r } = {}) =>
    e`<svg focusable="false" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" fill="currentColor" ...="${s(
      r
    )}" aria-hidden="true" width="20" height="20" viewBox="0 0 32 32">${t}<path d="M12 8L22 16 12 24z"></path></svg>`;
export { r as a, t as s };
