...
let process = { env: {} };
import { H as HostListenerMixin, n, w as HostListener, y as C4DLeftNav, x, z as svgResultCarbonIcon, A as selectorTabbable, s as styles, c as carbonElement, a as settings, F as FocusMixin, g as s } from './index-5becb925.js';
 ...
 */
let C4DLeftNavMenuSection = _decorate([carbonElement(`${c4dPrefix}-left-nav-menu-section`)], function (_initialize, _HostListenerMixin) {
  ...
  return {
    ...
    d: [{
      ...
      async function _requestLeftNavMenuSectionUpdate() {
        ...
        return new Promise(resolve => {
          this.dispatchEvent(new CustomEvent(eventToggle, {
            bubbles: true,
            cancelable: true,
            composed: true,
            detail: {
        ...
        if (changedProperties.has('expanded')) {
          ...
          if (expanded) {
            ...
            if (isSubmenu) {
              ...
              tabbable = (_this$shadowRoot = this.shadowRoot) === null || _this$shadowRoot === void 0 ? void 0 : _this$shadowRoot.querySelector('button');
            } else {
              // set focus to first menu item of section
              tabbable = this.getRootNode().querySelector(C4DLeftNav.selectorNavItems);
            }
            if (tabbable) {
      ...
      value: function connectedCallback() {
        _superPropGet(C4DLeftNavMenuSection, "connectedCallback", this, 3)([]);
        if (document.dir) {
    ...
    `), showBackBtn ? x(_t2 || (_t2 = _`
            ...
            `), prefix, prefix, prefix, handleClickBack, prefix, svgResultCarbonIcon(), backButtonText) : undefined);
      }
      ...
      value: function () {
        return [selectorTabbable, `${c4dPrefix}-left-nav-menu`, `${c4dPrefix}-left-nav-menu-item`].join(',');
      }
    }, {
      kind: "field",
      static: true,
