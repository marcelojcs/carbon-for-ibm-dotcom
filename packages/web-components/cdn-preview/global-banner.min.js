...
import { b as c, a as i } from './index4.js';
import { S as a } from './stable-selector.js';
import { S as l } from './StickyHeader.js';
import { i as p } from './cta.js';
import { c as g } from './carbon-element.js';
import { t as m } from './state.js';
import { s as f } from './stripHTML.js';
import { C as u } from './markdown.js';
import { C as h } from './image.js';
import './button.js';
  ...
  var e = {
    ...
    initializeClassElements: function (e, t) {
      ...
      ['method', 'field'].forEach(function (s) {
        t.forEach(function (t) {
          var r = t.placement;
          if (t.kind === s && ('static' === r || 'prototype' === r)) {
            var d = 'static' === r ? e : o;
    ...
    decorateClass: function (e, t) {
      ...
      if (
        ...
        return { elements: o, finishers: s };
      var d = this.decorateConstructor(o, t);
      return s.push.apply(s, d.finishers), (d.finishers = s), d;
    },
    addElementPlacement: function (e, t, o) {
      var s = t[e.placement];
      if (!o && -1 !== s.indexOf(e.key))
        throw new TypeError('Duplicated element (' + e.key + ')');
      s.push(e.key);
    },
    decorateElement: function (e, t) {
      for (
        var o = [], s = [], r = e.decorators, d = r.length - 1;
        d >= 0;
        d--
      ) {
        var n = t[e.placement];
        ...
        var c = this.fromElementDescriptor(e),
          i = this.toElementFinisherExtras((0, r[d])(c) || c);
        (e = i.element),
          this.addElementPlacement(e, t),
          i.finisher && s.push(i.finisher);
        var a = i.extras;
        if (a) {
      ...
      return { element: e, finishers: s, extras: o };
    },
    decorateConstructor: function (e, t) {
      for (var o = [], s = t.length - 1; s >= 0; s--) {
        var r = this.fromClassDescriptor(e),
          d = this.toClassDescriptor((0, t[s])(r) || r);
        if (
          (void 0 !== d.finisher && o.push(d.finisher), void 0 !== d.elements)
        ) {
          e = d.elements;
...
function C(e, t) {
  ...
  for (var o = 0, s = Array(t); o < t; o++) s[o] = e[o];
  return s;
}
function D() {
  return (
...
const O = parseFloat(c.lg.width) * i,
  { prefix: q, stablePrefix: I } = s;
!(function (e, t, o, s) {
  var r = _();
    ...
    c = r.decorateClass(
      (function (e) {
        for (
          ...
          var r,
            d = e[s];
          if ('method' === d.kind && (r = t.find(o)))
            if (j(d.descriptor) || j(r.descriptor)) {
              if (S(d) || S(r))
  ...
  r.initializeClassElements(n.F, c.elements),
    r.runClassFinishers(n.F, c.finishers);
})(
  [g(`${I}-global-banner`)],
  function (e, s) {
    class r extends s {
    ...
    return {
      F: r,
      d: [
        { kind: 'field', decorators: [t()], key: 'buttonHref', value: void 0 },
        { kind: 'field', decorators: [t()], key: 'ctaType', value: void 0 },
        {
          kind: 'field',
          decorators: [
            t({ attribute: 'has-image', reflect: !0, type: Boolean }),
          ],
          key: 'hasImage',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [
            t({ attribute: 'image-width', reflect: !0, type: String }),
          ],
          key: 'imageWidth',
          value: void 0,
        },
        {
          ...
          key: '_shouldRenderAsLink',
          value: () => !1,
        },
        {
          kind: 'field',
          decorators: [n(`.${q}--global-banner-layout-container`)],
          key: '_linkWrapper',
          value: void 0,
        },
        {
          kind: 'method',
          key: '_handleImageSlotChange',
          value: function ({ target: e }) {
            (this.hasImage = e
              ...
              this.hasImage && !this.imageWidth && (this.imageWidth = '4-col');
          },
        },
        {
          kind: 'method',
          key: '_handleButtonSlotChange',
          value: function ({ target: e }) {
            var t, o;
            const s = e.assignedNodes().filter((e) => {
              var t, o;
              return null === (t = (o = e).matches) || void 0 === t
                ? void 0
                : t.call(o, this.constructor.ctaButton);
            });
            (this.buttonHref =
              null === (t = s[0]) || void 0 === t
                ? void 0
                : t.getAttribute('href')),
              (this.ctaType =
                null === (o = s[0]) || void 0 === o ? void 0 : o.ctaType);
          },
        },
        {
          kind: 'method',
          key: '_handleResize',
          value: function () {
            const { _breakpoint: e } = this;
            this._shouldRenderAsLink = !e.matches;
          },
        },
        {
          kind: 'method',
          key: 'firstUpdated',
          value: function () {
            (l.global.banner = this),
              (this._breakpoint = window.matchMedia(`(min-width: ${O}px)`)),
              this._breakpoint.addEventListener(
                'change',
        ...
        },
        {
          ...
          value: function () {
            this.hasAttribute('role') || this.setAttribute('role', 'banner'),
              (function (e, t, o, s) {
                var r = D(F(1 & s ? e.prototype : e), t, o);
        ...
        },
        {
          ...
          key: 'updated',
          value: function (e) {
            if (e.has('_shouldRenderAsLink')) {
              const { _shouldRenderAsLink: e, ctaType: t } = this;
              e &&
                'external' === t &&
                setTimeout(() => {
          ...
          value: function () {
            return o(
              b ||
                (b = z`
      <div
        class="${0}--global-banner-layout-container"
    ...
    `),
        ...
        },
        {
          ...
          key: '_renderIcon',
          value: function () {
            return o(x || (x = z` ${0} `), p[this.ctaType]());
          },
        },
        {
          kind: 'method',
          key: '_renderInnerContents',
          value: function () {
            return o(
              k ||
                (k = z`
      <div class="${0}--global-banner-content-wrapper" part="content">
        <div
          ?hidden="${0}"
          class="${0}--global-banner-image-container"
        ...
        <div
          class="${0}--global-banner-text-container"
          part="text-container">
        ...
        <div
          class="${0}--global-banner-cta-container"
          part="cta-container">
          <slot name="cta" @slotchange="${0}"></slot>
        </div>

        <div class="${0}--global-banner-icon" part="icon">
          ${0}
        </div>
      </div>
    `),
      ...
      (function (e) {
        for (
          ...
          var r,
            d = e[s];
          if ('method' === d.kind && (r = t.find(o)))
            if (L(d.descriptor) || L(r.descriptor)) {
              if (X(d) || X(r))
                throw new ReferenceError(
                  'Duplicated methods (' + d.key + ") can't be decorated."
                );
  ...
  function (e, s) {
    ...
    return {
      ...
      d: [
        ...
        { kind: 'field', decorators: [m()], key: 'content', value: () => '' },
        {
          kind: 'method',
          key: 'connectedCallback',
          value: function () {
            this.hasAttribute('role') || this.setAttribute('role', 'heading'),
              ...
              (function (e, t, o, s) {
                var r = Z(V(1 & s ? e.prototype : e), t, o);
                return 2 & s && 'function' == typeof r
                  ? function (e) {
                      return r.apply(o, e);
                    }
        ...
        },
        {
          ...
          key: 'firstUpdated',
          value: function () {
            (this.content = f(this.innerHTML)),
              d(o(M || (M = B` ${0} `), this.content), this);
          },
        },
        {
          kind: 'method',
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${G}-global-banner-heading`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => v },
      ],
      ...
      (function (e) {
        for (
          ...
          var r,
            d = e[s];
          if ('method' === d.kind && (r = t.find(o)))
            if (se(d.descriptor) || se(r.descriptor)) {
              if (oe(d) || oe(r))
                throw new ReferenceError(
                  'Duplicated methods (' + d.key + ") can't be decorated."
                );
  ...
  return (
    (be =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, t, o) {
            var s = (function (e, t) {
              for (; !{}.hasOwnProperty.call(e, t) && null !== (e = ye(e)); );
              return e;
            })(e, t);
            if (s) {
              var r = Object.getOwnPropertyDescriptor(s, t);
...
!(function (e, t, o, s) {
      ...
      (function (e) {
        for (
          ...
          var r,
            d = e[s];
          if ('method' === d.kind && (r = t.find(o)))
            if (fe(d.descriptor) || fe(r.descriptor)) {
              if (me(d) || me(r))
                throw new ReferenceError(
                  'Duplicated methods (' + d.key + ") can't be decorated."
                );
  ...
  function (o, s) {
    ...
    `),
              (function (e, t, o, s) {
                var r = be(ye(1 & s ? e.prototype : e), t, o);
                return 2 & s && 'function' == typeof r
                  ? function (e) {
                      return r.apply(o, e);
                    }
