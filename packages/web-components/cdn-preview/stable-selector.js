...
const e = (e) =>
  class extends e {
    constructor(...e) {
      super(...e), t(this, '_mutationObserver', null);
    }
    connectedCallback() {
      super.connectedCallback();
      const { stableSelector: t } = this.constructor;
      t && (this.dataset.autoid = t),
        this._cleanAndCreateMutationObserver({ create: !0 }),
        window.requestAnimationFrame(() => {
          this.linkNode || this.transposeAttributes();
        });
    }
    disconnectedCallback() {
      this._cleanAndCreateMutationObserver();
    }
    transposeAttributes(t, e) {
      var i;
      (this.linkNode = t),
        (this.altAttributes = e),
        this.linkNode ||
      ...
      [].filter
        .call(
          this.attributes,
          (t) =>
            (/^data-/.test(t.name) && 'data-autoid' !== t.name) ||
            (this.altAttributes && this.altAttributes.includes(t.name))
        )
        .forEach((t) => {
          var e;
          this.linkNode &&
            (null === (e = this.linkNode) ||
              void 0 === e ||
              e.setAttribute(t.name, t.value));
        });
    }
    _cleanAndCreateMutationObserver({ create: t } = {}) {
      var e;
