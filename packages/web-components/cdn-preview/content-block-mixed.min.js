...
import { i as c, s as e } from './query-assigned-elements.js';
import { c as t } from './carbon-element.js';
import { C as d } from './content-block.js';
import './card-heading.js';
import './content-block-copy.js';
import './content-block-heading.js';
import './content-group-heading.js';
import './content-group-copy.js';
import './content-item.js';
import './content-item-copy.js';
import './content-item-heading.js';
import './link-with-icon.js';
import './card-link-cta.js';
import './image.js';
import './link-list2.js';
import './link-list-item.js';
import './pictogram-item.js';
import './class-map.js';
import './directive.js';
import './state.js';
  ...
  var c = {
    ...
    initializeClassElements: function (c, e) {
      ...
      ['method', 'field'].forEach(function (d) {
        e.forEach(function (e) {
          var o = e.placement;
          if (e.kind === d && ('static' === o || 'prototype' === o)) {
            var s = 'static' === o ? c : t;
    ...
    defineClassElement: function (c, e) {
      ...
      if ('field' === e.kind) {
        ...
        t = {
          ...
          value: void 0 === d ? void 0 : d.call(c),
        };
      }
      Object.defineProperty(c, e.key, t);
    },
    decorateClass: function (c, e) {
      ...
      if (
        (c.forEach(function (c) {
          this.addElementPlacement(c, o);
        }, this),
        c.forEach(function (c) {
          if (!l(c)) return t.push(c);
          var e = this.decorateElement(c, o);
          t.push(e.element),
            t.push.apply(t, e.extras),
            d.push.apply(d, e.finishers);
        }, this),
        !e)
      )
        return { elements: t, finishers: d };
      var s = this.decorateConstructor(t, e);
      return d.push.apply(d, s.finishers), (s.finishers = d), s;
    },
    addElementPlacement: function (c, e, t) {
      var d = e[c.placement];
      if (!t && -1 !== d.indexOf(c.key))
        throw new TypeError('Duplicated element (' + c.key + ')');
      d.push(c.key);
    },
    decorateElement: function (c, e) {
      for (
        var t = [], d = [], o = c.decorators, s = o.length - 1;
        s >= 0;
        s--
      ) {
        var i = e[c.placement];
        i.splice(i.indexOf(c.key), 1);
        var r = this.fromElementDescriptor(c),
          a = this.toElementFinisherExtras((0, o[s])(r) || r);
        (c = a.element),
      ...
      return { element: c, finishers: d, extras: t };
    },
    decorateConstructor: function (c, e) {
      for (var t = [], d = e.length - 1; d >= 0; d--) {
        var o = this.fromClassDescriptor(c),
          s = this.toClassDescriptor((0, e[d])(o) || o);
        if (
          (void 0 !== s.finisher && t.push(s.finisher), void 0 !== s.elements)
        ) {
          c = s.elements;
          for (var i = 0; i < c.length - 1; i++)
            for (var r = i + 1; r < c.length; r++)
              if (c[i].key === c[r].key && c[i].placement === c[r].placement)
                throw new TypeError('Duplicated element (' + c[i].key + ')');
        }
      }
      return { elements: c, finishers: t };
    },
    ...
    toElementDescriptors: function (c) {
      if (void 0 !== c)
        ...
        (function (c) {
          ...
          (function (c, e) {
            if (c) {
              if ('string' == typeof c) return m(c, e);
    ...
    toClassDescriptor: function (c) {
      ...
      var t = g(c, 'finisher');
      return { elements: this.toElementDescriptors(c.elements), finisher: t };
    },
    ...
    disallowProperty: function (c, e, t) {
      if (void 0 !== c[e])
...
function a(c) {
  ...
  return (
    c.decorators && (d.decorators = c.decorators),
    'field' === c.kind && (d.initializer = c.value),
    d
  );
}
function n(c, e) {
...
function m(c, e) {
  ...
  for (var t = 0, d = Array(e); t < e; t++) d[t] = c[t];
  return d;
}
function u() {
  return (
    (u =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (c, e, t) {
            var d = (function (c, e) {
              for (; !{}.hasOwnProperty.call(c, e) && null !== (c = b(c)); );
              return c;
            })(c, e);
            if (d) {
              var o = Object.getOwnPropertyDescriptor(d, e);
              return o.get ? o.get.call(arguments.length < 3 ? c : t) : o.value;
            }
          }),
...
const { stablePrefix: v } = e;
!(function (c, e, t, d) {
  var o = r();
  if (d) for (var s = 0; s < d.length; s++) o = d[s](o);
  var i = e(function (c) {
      o.initializeInstanceElements(c, g.elements);
    }, t),
    g = o.decorateClass(
      (function (c) {
        for (
          ...
          var o,
            s = c[d];
          if ('method' === s.kind && (o = e.find(t)))
            if (p(s.descriptor) || p(o.descriptor)) {
              if (l(s) || l(o))
  ...
  o.initializeClassElements(i.F, g.elements),
    o.runClassFinishers(i.F, g.finishers);
})(
  [t(`${v}-content-block-mixed`)],
  function (e, t) {
    class d extends t {
      constructor(...c) {
        super(...c), e(this);
    ...
    `),
              ...
              (t = 'styles'),
              (r = this),
              (n = u(b(1 & a ? e.prototype : e), t, r)),
              2 & a && 'function' == typeof n
                ? function (c) {
                    return n.apply(r, c);
                  }
                : n),
  ...
  console.warn(
    'The content-block-mixed component has been deprecated in favor of the content-section/block, video-player/image, pictogram-items, and other content-group components. See content-block/section documentation for more information.'
  );
