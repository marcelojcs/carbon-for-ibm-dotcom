  ...
  w = e(
    ...
    function (e, t) {
      ...
      return {
        ...
        d: [
          ...
          { kind: 'field', decorators: [i()], key: 'href', value: () => '' },
          { kind: 'field', decorators: [i()], key: 'title', value: void 0 },
          {
            kind: 'method',
            key: 'shouldUpdate',
            value: function (e) {
          ...
          },
          {
            ...
            value: function () {
              this.hasAttribute('role') || this.setAttribute('role', 'button'),
                (function (e, t, r, i) {
                  var n = c(d(1 & i ? e.prototype : e), t, r);
                  return 2 & i
                    ? function (e) {
                        return n.apply(r, e);
                      }
          ...
          },
          {
            ...
            key: 'render',
            value: function () {
              const { active: e, href: t, title: r } = this,
                i = u({
                  [`${o}--side-nav__link`]: !0,
                  [`${o}--side-nav__link--current`]: e,
                });
              return n(
                v ||
                  (v = y`
    ...
    `),
          ...
          },
          {
            ...
            value: () =>
              s(s({}, r.shadowRootOptions), {}, { delegatesFocus: !0 }),
          },
...
const { prefix: j, stablePrefix: z } = p;
let F = (function (e, t, r, i) {
  var n = E();
  ...
  function (e, t) {
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [i({ attribute: 'is-heading' })],
          key: 'isHeading',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [i({ attribute: 'is-view-all' })],
          key: 'isViewAll',
          value: void 0,
        },
        {
          ...
          value: function (e) {
            !(function (e, t, r, i) {
              var n = O(T(1 & i ? e.prototype : e), t, r);
              ...
              e.has('isHeading') &&
                this.classList.toggle(
                  `${j}--side-nav__group-header`,
                  this.isHeading
                ),
              e.has('isViewAll') &&
                this.classList.toggle(
                  `${j}--side-nav__group-view-all`,
                  this.isViewAll
                );
          },
        },
        {
          ...
          value: function () {
            const {
              ...
              s = 'rtl' === document.dir.toLowerCase() ? h : m,
              a = u({
                [`${j}--side-nav__link`]: !0,
                [`${j}--side-nav__link--current`]: e,
              });
            return t
              ? n(
                  k ||
