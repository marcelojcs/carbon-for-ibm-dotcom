...
import { n as e, s as t } from './query-assigned-elements.js';
import { C as r, a as i } from './modal-heading.js';
import { s as n } from './expressive-modal.js';
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${m}--expressive-modal-header`;
          },
        },
      ...
      d: [
        {
          ...
          value: function () {
            ...
            this.hasAttribute('role') || this.setAttribute('role', 'heading'),
              ...
              (t = 'connectedCallback'),
              (i = this),
              (o = A(D(1 & (n = 3) ? e.prototype : e), t, i)),
              2 & n && 'function' == typeof o
                ? function (e) {
                    return o.apply(i, e);
                  }
                : o)([]);
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${C}--expressive-modal-heading`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => n },
      ],
