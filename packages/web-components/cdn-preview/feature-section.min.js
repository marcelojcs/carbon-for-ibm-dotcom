 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let r,a,t,m,g=function(d){return d.RIGHT="right",d.LEFT="left",d}({}),p=function(d){return d.REGULAR="regular",d.INVERSE="inverse",d.CYAN="cyan",d.PURPLE="purple",d}({}),u=d=>d;function x(){x=function(){return d};var d={elementsDefinitionOrder:[["method"],["field"]],initializeInstanceElements:function(d,s){["method","field"].forEach((function(n){s.forEach((function(s){s.kind===n&&"own"===s.placement&&this.defineClassElement(d,s)}),this)}),this)},initializeClassElements:function(d,s){var n=d.prototype;["method","field"].forEach((function(c){s.forEach((function(s){var i=s.placement;if(s.kind===c&&("static"===i||"prototype"===i)){var e="static"===i?d:n;this.defineClassElement(e,s)}}),this)}),this)},defineClassElement:function(d,s){var n=s.descriptor;if("field"===s.kind){var c=s.initializer;n={enumerable:n.enumerable,writable:n.writable,configurable:n.configurable,value:void 0===c?void 0:c.call(d)}}Object.defineProperty(d,s.key,n)},decorateClass:function(d,s){var n=[],c=[],i={static:[],prototype:[],own:[]};if(d.forEach((function(d){this.addElementPlacement(d,i)}),this),d.forEach((function(d){if(!h(d))return n.push(d);var s=this.decorateElement(d,i);n.push(s.element),n.push.apply(n,s.extras),c.push.apply(c,s.finishers)}),this),!s)return{elements:n,finishers:c};var e=this.decorateConstructor(n,s);return c.push.apply(c,e.finishers),e.finishers=c,e},addElementPlacement:function(d,s,n){var c=s[d.placement];if(!n&&-1!==c.indexOf(d.key))throw new TypeError("Duplicated element ("+d.key+")");c.push(d.key)},decorateElement:function(d,s){for(var n=[],c=[],i=d.decorators,e=i.length-1;e>=0;e--){var l=s[d.placement];l.splice(l.indexOf(d.key),1);var o=this.fromElementDescriptor(d),r=this.toElementFinisherExtras((0,i[e])(o)||o);d=r.element,this.addElementPlacement(d,s),r.finisher&&c.push(r.finisher);var a=r.extras;if(a){for(var t=0;t<a.length;t++)this.addElementPlacement(a[t],s);n.push.apply(n,a)}}return{element:d,finishers:c,extras:n}},decorateConstructor:function(d,s){for(var n=[],c=s.length-1;c>=0;c--){var i=this.fromClassDescriptor(d),e=this.toClassDescriptor((0,s[c])(i)||i);if(void 0!==e.finisher&&n.push(e.finisher),void 0!==e.elements){d=e.elements;for(var l=0;l<d.length-1;l++)for(var o=l+1;o<d.length;o++)if(d[l].key===d[o].key&&d[l].placement===d[o].placement)throw new TypeError("Duplicated element ("+d[l].key+")")}}return{elements:d,finishers:n}},fromElementDescriptor:function(d){var s={kind:d.kind,key:d.key,placement:d.placement,descriptor:d.descriptor};return Object.defineProperty(s,Symbol.toStringTag,{value:"Descriptor",configurable:!0}),"field"===d.kind&&(s.initializer=d.initializer),s},toElementDescriptors:function(d){if(void 0!==d)return(s=d,function(d){if(Array.isArray(d))return d}(s)||function(d){if("undefined"!=typeof Symbol&&null!=d[Symbol.iterator]||null!=d["@@iterator"])return Array.from(d)}(s)||function(d,s){if(d){if("string"==typeof d)return v(d,s);var n={}.toString.call(d).slice(8,-1);return"Object"===n&&d.constructor&&(n=d.constructor.name),"Map"===n||"Set"===n?Array.from(d):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?v(d,s):void 0}}(s)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()).map((function(d){var s=this.toElementDescriptor(d);return this.disallowProperty(d,"finisher","An element descriptor"),this.disallowProperty(d,"extras","An element descriptor"),s}),this);var s},toElementDescriptor:function(d){var s=d.kind+"";if("method"!==s&&"field"!==s)throw new TypeError('An element descriptor\'s .kind property must be either "method" or "field", but a decorator created an element descriptor with .kind "'+s+'"');var n=z(d.key),c=d.placement+"";if("static"!==c&&"prototype"!==c&&"own"!==c)throw new TypeError('An element descriptor\'s .placement property must be one of "static", "prototype" or "own", but a decorator created an element descriptor with .placement "'+c+'"');var i=d.descriptor;this.disallowProperty(d,"elements","An element descriptor");var e={kind:s,key:n,placement:c,descriptor:Object.assign({},i)};return"field"!==s?this.disallowProperty(d,"initializer","A method descriptor"):(this.disallowProperty(i,"get","The property descriptor of a field descriptor"),this.disallowProperty(i,"set","The property descriptor of a field descriptor"),this.disallowProperty(i,"value","The property descriptor of a field descriptor"),e.initializer=d.initializer),e},toElementFinisherExtras:function(d){return{element:this.toElementDescriptor(d),finisher:b(d,"finisher"),extras:this.toElementDescriptors(d.extras)}},fromClassDescriptor:function(d){var s={kind:"class",elements:d.map(this.fromElementDescriptor,this)};return Object.defineProperty(s,Symbol.toStringTag,{value:"Descriptor",configurable:!0}),s},toClassDescriptor:function(d){var s=d.kind+"";if("class"!==s)throw new TypeError('A class descriptor\'s .kind property must be "class", but a decorator created a class descriptor with .kind "'+s+'"');this.disallowProperty(d,"key","A class descriptor"),this.disallowProperty(d,"placement","A class descriptor"),this.disallowProperty(d,"descriptor","A class descriptor"),this.disallowProperty(d,"initializer","A class descriptor"),this.disallowProperty(d,"extras","A class descriptor");var n=b(d,"finisher");return{elements:this.toElementDescriptors(d.elements),finisher:n}},runClassFinishers:function(d,s){for(var n=0;n<s.length;n++){var c=(0,s[n])(d);if(void 0!==c){if("function"!=typeof c)throw new TypeError("Finishers must return a constructor.");d=c}}return d},disallowProperty:function(d,s,n){if(void 0!==d[s])throw new TypeError(n+" can't have a ."+s+" property.")}};return d}function f(d){var s,n=z(d.key);"method"===d.kind?s={value:d.value,writable:!0,configurable:!0,enumerable:!1}:"get"===d.kind?s={get:d.value,configurable:!0,enumerable:!1}:"set"===d.kind?s={set:d.value,configurable:!0,enumerable:!1}:"field"===d.kind&&(s={configurable:!0,writable:!0,enumerable:!0});var c={kind:"field"===d.kind?"field":"method",key:n,placement:d.static?"static":"field"===d.kind?"own":"prototype",descriptor:s};return d.decorators&&(c.decorators=d.decorators),"field"===d.kind&&(c.initializer=d.value),c}function y(d,s){void 0!==d.descriptor.get?s.descriptor.get=d.descriptor.get:s.descriptor.set=d.descriptor.set}function h(d){return d.decorators&&d.decorators.length}function w(d){return void 0!==d&&!(void 0===d.value&&void 0===d.writable)}function b(d,s){var n=d[s];if(void 0!==n&&"function"!=typeof n)throw new TypeError("Expected '"+s+"' to be a function");return n}function z(d){var s=function(d,s){if("object"!=typeof d||!d)return d;var n=d[Symbol.toPrimitive];if(void 0!==n){var c=n.call(d,s||"default");if("object"!=typeof c)return c;throw new TypeError("@@toPrimitive must return a primitive value.")}return("string"===s?String:Number)(d)}(d,"string");return"symbol"==typeof s?s:s+""}function v(d,s){(null==s||s>d.length)&&(s=d.length);for(var n=0,c=Array(s);n<s;n++)c[n]=d[n];return c}function k(){return k="undefined"!=typeof Reflect&&Reflect.get?Reflect.get.bind():function(d,s,n){var c=function(d,s){for(;!{}.hasOwnProperty.call(d,s)&&null!==(d=_(d)););return d}(d,s);if(c){var i=Object.getOwnPropertyDescriptor(c,s);return i.get?i.get.call(arguments.length<3?d:n):i.value}},k.apply(null,arguments)}function _(d){return _=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(d){return d.__proto__||Object.getPrototypeOf(d)},_(d)}const{prefix:j,stablePrefix:E}=c;!function(d,s,n,c){var i=x();if(c)for(var e=0;e<c.length;e++)i=c[e](i);var l=s((function(d){i.initializeInstanceElements(d,o.elements)}),n),o=i.decorateClass(function(d){for(var s=[],n=function(d){return"method"===d.kind&&d.key===e.key&&d.placement===e.placement},c=0;c<d.length;c++){var i,e=d[c];if("method"===e.kind&&(i=s.find(n)))if(w(e.descriptor)||w(i.descriptor)){if(h(e)||h(i))throw new ReferenceError("Duplicated methods ("+e.key+") can't be decorated.");i.descriptor=e.descriptor}else{if(h(e)){if(h(i))throw new ReferenceError("Decorators can't be placed on different accessors with for the same property ("+e.key+").");i.decorators=e.decorators}y(e,i)}else s.push(e)}return s}(l.d.map(f)),d);i.initializeClassElements(l.F,o.elements),i.runClassFinishers(l.F,o.finishers)}([l(`${E}-feature-section`)],(function(c,i){class e extends i{constructor(...d){super(...d),c(this)}}return{F:e,d:[{kind:"field",decorators:[s({attribute:"color-scheme",reflect:!0})],key:"colorScheme",value:()=>p.REGULAR},{kind:"field",decorators:[s({attribute:"media-alignment",reflect:!0})],key:"mediaAlignment",value:()=>g.RIGHT},{kind:"method",key:"render",value:function(){return n(r||(r=u`
      ${0}
    `),this.mediaAlignment===g.LEFT?n(a||(a=u`
            <div
          ...
          `),j,j,j,j,j,j,j,j,j,j,j,j,j,j,j,j,j):n(t||(t=u`
            <div
              class="${0}--grid ${0}--feature-section"
              part="grid grid--wrapper">
              <div
          ...
          `),j,j,j,j,j,j,j,j,j,j,j,j,j,j,j,j,j))}},{kind:"get",static:!0,key:"stableSelector",value:function(){return`${E}--feature-section`}},{kind:"get",static:!0,key:"styles",value:function(){return d(m||(m=u`
      ${0}${0}
    `),(s=e,n="styles",c=this,l=k(_(1&i?s.prototype:s),n,c),2&i&&"function"==typeof l?function(d){return l.apply(c,d)}:l),o);var s,n,c,i,l}}]}}),e(i));
