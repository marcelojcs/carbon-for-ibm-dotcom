...
const { prefix: E, stablePrefix: P } = c;
let D = (function (e, t, r, i) {
  ...
  [l(`${P}-left-nav-menu-category-heading`)],
  function (e, l) {
    return {
      F: class extends l {
        constructor(...t) {
      ...
      d: [
        ...
        { kind: 'field', decorators: [r()], key: 'boostSize', value: void 0 },
        {
          kind: 'method',
          key: 'updated',
          value: function (e) {
            e.has('boostSize') &&
              this.classList.toggle(
                `${E}--left-nav-menu-category__heading-large`,
                this.boostSize
              );
          },
        },
        {
          ...
          value: function () {
            const { headingText: e, url: t } = this,
              r = 'rtl' === document.dir.toLowerCase(),
              a = {
                [`${E}--side-nav__menu-section-title`]: this.boostSize || !1,
                [`${E}--side-nav__heading-title`]: !t,
              };
            return t
              ? i(
                  d ||
