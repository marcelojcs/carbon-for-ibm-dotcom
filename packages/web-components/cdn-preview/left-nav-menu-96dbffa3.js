...
let process = { env: {} };
import { F as FocusMixin, g as s, n, x, v as svgResultCarbonIcon, s as styles, c as carbonElement, a as settings, q as o } from './index-5becb925.js';
 ...
 */
let C4DLeftNavMenu = _decorate([carbonElement(`${c4dPrefix}-left-nav-menu`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
       ...
       */
      function _handleUserInitiatedToggle(expanded = !this.expanded, panelId = this.panelId) {
        const {
          eventBeforeToggle,
          eventToggle
        } = this.constructor;
      ...
      value: function render() {
        ...
        const isSubitem = ((_this$parentElement = this.parentElement) === null || _this$parentElement === void 0 ? void 0 : _this$parentElement.hasAttribute('is-submenu')) || false;
        return x(_t || (_t = _`
    ...
    `), prefix, expanded, buttonClasses, handleClickExpando, isSubitem ? 'TabHdline' : 'L0', title, prefix, prefix, title, prefix, prefix, prefix, svgResultCarbonIcon());
      }
