...
import { C as s } from './link-with-icon.js';
import { s as a } from './202.js';
import { s as l } from './card.js';
let c,
  d,
  f = (e) => e;
function u() {
...
const { prefix: E, stablePrefix: P } = r;
let _ = (function (e, t, r, i) {
  var n = u();
      ...
      (function (e) {
        for (
          ...
          if ('method' === o.kind && (n = t.find(r)))
            if (y(o.descriptor) || y(n.descriptor)) {
              if (m(o) || m(n))
  ...
  function (r, o) {
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [n(`.${P}-ce--card__footer--static`)],
          key: '_staticNode',
          value: void 0,
        },
        ...
        {
          kind: 'get',
          key: '_shouldUseParentLink',
          value: function () {
            const { href: e, parentHref: t } = this;
    ...
    `),
              this._renderContent(),
              this.disabled ? a() : this._renderIcon()
            );
          },
        },
        {
          kind: 'field',
          decorators: [t({ reflect: !1 })],
          key: 'altAriaLabel',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'color-scheme', reflect: !0 })],
          key: 'colorScheme',
          value: () => '',
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'parent-href', reflect: !0 })],
          key: 'parentHref',
          value: void 0,
        },
        {
        ...
        },
        {
          ...
          value: function (e) {
            var t, r;
            ((function (e, t, r, i) {
              var n = w(g(1 & i ? e.prototype : e), t, r);
            ...
            this._hasCopy)
              ...
              : null === (r = this.shadowRoot) ||
                void 0 === r ||
                null === (r = r.querySelector('a')) ||
                void 0 === r ||
                r.setAttribute(
                  'aria-label',
                  this.altAriaLabel ? this.altAriaLabel : ''
                );
            const { iconInline: i, _staticNode: n, _linkNode: o } = this,
              a = null != o ? o : n;
            a.classList.add(`${E}--card__footer`),
              a.classList.add(`${P}-ce--card__footer`),
              i && a.classList.add(`${E}--link-with-icon--inline-icon`),
