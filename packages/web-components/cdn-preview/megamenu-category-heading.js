...
import { s as t, a as i } from './20.js';
import { c as o, s as n } from './masthead-container.js';
      ...
      d: [
        {
          ...
          value: function () {
            return 'rtl' === document.dir.toLowerCase()
              ...
              : i({ part: 'l0-arrow-cat-heading' });
          },
        },
        {
          kind: 'field',
          decorators: [
            e({ reflect: !0, type: Number, attribute: 'heading-level' }),
          ],
          key: 'headingLevel',
          value: () => 3,
        },
