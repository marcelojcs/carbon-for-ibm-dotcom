...
import { _ as o, a as t } from './get.js';
...
import { S as p } from './stable-selector.js';
import { s as v } from './leadspace2.js';
import { C as f } from './link.js';
import './button-group.js';
import './button-group-item.js';
import { s as u, C as b } from './image.js';
import './leadspace.js';
      ...
      d: [
        {
          kind: 'field',
          decorators: [
            c({ type: Boolean, reflect: !0, attribute: 'no-trailing-slash' }),
          ],
          key: 'noTrailingSlash',
          value: () => !1,
        },
        {
          ...
          value: function () {
            this.hasAttribute('role') ||
              ...
              (function (e, r, s, n) {
                var c = o(t(1 & n ? e.prototype : e), r, s);
                return 2 & n
                  ? function (e) {
                      return c.apply(s, e);
                    }
        ...
        },
        {
          ...
          value: function () {
            const e = r({
              [`${a}--breadcrumb`]: !0,
              [`${a}--breadcrumb--no-trailing-slash`]: this.noTrailingSlash,
            });
            return i(
              h ||
                (h = g`
    ...
    decorateElement: function (e, o) {
      for (
        ...
        var i = this.fromElementDescriptor(e),
          d = this.toElementFinisherExtras((0, s[n])(i) || i);
        (e = d.element),
      ...
      for (var t = [], r = o.length - 1; r >= 0; r--) {
        ...
        if (
          ...
          for (var c = 0; c < e.length - 1; c++)
            for (var i = c + 1; i < e.length; i++)
              if (e[c].key === e[i].key && e[c].placement === e[i].placement)
...
!(function (e, o, t, r) {
      ...
      (function (e) {
        for (
          ...
          if ('method' === n.kind && (s = o.find(t)))
            if (_(n.descriptor) || _(s.descriptor)) {
              if (z(n) || z(s))
  ...
  s.initializeClassElements(c.F, i.elements),
    s.runClassFinishers(c.F, i.finishers);
})(
  [l(`${D}-breadcrumb`)],
  function (e, o) {
    return {
      ...
      d: [{ kind: 'field', static: !0, key: 'styles', value: () => v }],
    };
  },
  p(y)
);
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return H(e, o);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
  ...
  function (e, r) {
    ...
    `),
              this.href
                ...
                : i(
                    M || (M = N`<span class="${0}--link"><slot></slot></span>`),
                    a
                  )
            );
          },
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return ie(e, o);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
      ...
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = o.find(t)))
            if (K(n.descriptor) || K(s.descriptor)) {
              if (J(n) || J(s))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
      ...
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = o.find(t)))
            if (se(n.descriptor) || se(s.descriptor)) {
              if (re(n) || re(s))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
    ...
    toElementDescriptors: function (e) {
      if (void 0 !== e)
        ...
        (function (e) {
          ...
          (function (e, o) {
            if (e) {
              if ('string' == typeof e) return ge(e, o);
              var t = {}.toString.call(e).slice(8, -1);
              return (
                'Object' === t && e.constructor && (t = e.constructor.name),
                'Map' === t || 'Set' === t
  ...
  return (
    (ye =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, o, t) {
            var r = (function (e, o) {
              for (; !{}.hasOwnProperty.call(e, o) && null !== (e = we(e)); );
              return e;
            })(e, o);
            if (r) {
...
!(function (e, o, t, r) {
      ...
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = o.find(t)))
            if (be(n.descriptor) || be(s.descriptor)) {
              if (ue(n) || ue(s))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
  ...
  function (e, o) {
    ...
    `),
              (function (e, o, t, r) {
                var s = ye(we(1 & r ? e.prototype : e), o, t);
                return 2 & r && 'function' == typeof s
                  ? function (e) {
                      return s.apply(t, e);
                    }
                  : s;
