...
import { _ as s } from './decorate.js';
import { o as t } from './class-map.js';
import { l as i } from './if-defined.js';
import { i as o, x as d, n as c, a as r } from './query-assigned-elements.js';
import { t as n } from './state.js';
import { i as l } from './query.js';
import { p as a } from './settings.js';
import { s as b } from './163.js';
import { s as p, a as u, F as m } from './form.js';
import { F as _ } from './focus.js';
import { H as x } from './host-listener2.js';
import { V as g } from './validity.js';
import { H as v } from './host-listener.js';
import { f as h, i as f, a as y } from './collection-helpers2.js';
import { c as w } from './carbon-element.js';
/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */ const k = { Up: -1, ArrowUp: -1, Down: 1, ArrowDown: 1 };
let z, S, I, q;
!(function (e) {
  (e.NONE = 'none'),
    (e.CLOSING = 'closing'),
    (e.NAVIGATING = 'navigating'),
    (e.TRIGGERING = 'triggering');
})(z || (z = {})),
  (function (e) {
    (e.SMALL = 'sm'), (e.MEDIUM = 'md'), (e.LARGE = 'lg');
  })(S || (S = {})),
  (function (e) {
    (e.DEFAULT = ''), (e.INLINE = 'inline');
  })(I || (I = {})),
  (function (e) {
  ...
  L = s(
    ...
    function (s, o) {
      return {
        ...
        d: [
          ...
          { kind: 'field', key: '_selectedItemContent', value: () => null },
          { kind: 'field', key: '_shouldTriggerBeFocusable', value: () => !0 },
          {
            kind: 'field',
            decorators: [l(`.${a}--list-box`)],
            key: '_listBoxNode',
            value: void 0,
          },
          {
            kind: 'field',
            decorators: [l('slot[name="helper-text"]')],
            key: '_slotHelperTextNode',
            value: void 0,
          },
          {
            kind: 'field',
            decorators: [l('slot[name="title-text"]')],
          ...
          },
          {
            ...
            value: function (e) {
              e &&
                ((this.value = e.value),
                (this._activeDescendant = e.id),
                h(
                  this.querySelectorAll(this.constructor.selectorItemSelected),
                  (e) => {
                    (e.selected = !1), e.setAttribute('aria-selected', 'false');
                  }
                ),
                (e.selected = !0),
            ...
            value: function (e) {
              if (!this.readOnly)
                if (this.shadowRoot.contains(e.target))
                  ...
                  const s = e.target.closest(this.constructor.selectorItem);
                  this.contains(s) && this._handleUserInitiatedSelectItem(s);
                }
            },
          },
          {
            ...
            value: function (e) {
              const { key: s } = e,
                t = this.constructor.getAction(s);
              if (this.open)
                switch (t) {
                  case z.CLOSING:
                    this._handleUserInitiatedToggle(!1);
              ...
              else if (t === z.NAVIGATING)
                this._handleUserInitiatedToggle(!0), this._clearHighlight();
            },
          },
          {
            kind: 'method',
              ...
              if (this.open) {
                if (t === z.TRIGGERING) {
                  const e = this.constructor,
                    s = this.querySelector(e.selectorItemHighlighted);
                  s
                    ? this._handleUserInitiatedSelectItem(s)
                    : this._handleUserInitiatedToggle(!1);
                }
              } else if (t === z.TRIGGERING)
                this._handleUserInitiatedToggle(!0);
            },
          },
          {
            kind: 'method',
            decorators: [v('focusout')],
            key: '_handleFocusOut',
            value: function (e) {
          ...
          },
          {
            ...
            value: function ({ target: e }) {
              ...
              (this._hasSlug = Boolean(s)),
                s[0].setAttribute('size', 'mini'),
                this.requestUpdate();
            },
          },
          {
            ...
            value: function (s) {
              if (
                (null == s || !s.hasAttribute('disabled')) &&
                this._selectionShouldChange(s)
              ) {
                const t = { bubbles: !0, composed: !0, detail: { item: s } },
                  i = this.constructor,
                  o = new CustomEvent(
                    i.eventBeforeSelect,
                    e(e({}, t), {}, { cancelable: !0 })
                ...
                if (this.dispatchEvent(o)) {
                  this._selectionDidChange(s);
                  const e = new CustomEvent(i.eventSelect, t);
          ...
          },
          {
            ...
            value: function (e = !this.open) {
              const { eventBeforeToggle: s, eventToggle: t } = this.constructor,
                { disabled: i } = this,
                o = {
                  bubbles: !0,
                  cancelable: !0,
              ...
              i ||
                (this.dispatchEvent(new CustomEvent(s, o)) &&
                  ((this.open = e),
                  this.open ||
                    h(
                      this.querySelectorAll(
                        this.constructor.selectorItemHighlighted
                      ),
                      (e) => {
                        e.highlighted = !1;
                      }
                  ...
                  this.requestUpdate(),
                  this.dispatchEvent(new CustomEvent(t, o))));
            },
          },
          {
            kind: 'method',
            key: '_clearHighlight',
            value: function () {
              h(this.querySelectorAll(this.constructor.selectorItem), (e) => {
                e.highlighted = !1;
              });
            },
          },
          {
            ...
            value: function (e) {
              ...
              const t = this.constructor,
                i = this.querySelectorAll(t.selectorItem),
                o = this.querySelector(t.selectorItemHighlighted);
              let d = f(i, o) + e;
              null !== (s = i[d]) &&
                void 0 !== s &&
          ...
          },
          {
            ...
            key: '_renderLabel',
            value: function () {
              const { label: e, _selectedItemContent: s } = this;
              return d(
                $ ||
                  ($ = F`
          ...
          },
          {
            ...
            value: function () {
              const {
                  ...
                  hideLabel: s,
                  titleText: i,
                  _slotTitleTextNode: o,
                  _handleSlotchangeLabelText: c,
                } = this,
                r = t({
                  [`${a}--label`]: !0,
                  [`${a}--label--disabled`]: e,
                ...
                n = i || (o && o.assignedNodes().length > 0);
              return d(
                B ||
                  (B = F`
      <label
    ...
    `),
          ...
          },
          {
            ...
            value: function (e) {
              const { formData: s } = e,
                { disabled: t, name: i, value: o } = this;
              t || s.append(i, o);
            },
          },
          {
            kind: 'field',
            decorators: [
              c({ type: String, reflect: !0, attribute: 'aria-label' }),
            ],
            key: 'ariaLabel',
            value: () => '',
          },
          {
            kind: 'field',
            decorators: [c({ type: String, reflect: !0 })],
            key: 'direction',
            value: () => q.BOTTOM,
          },
          {
          ...
          {
            kind: 'field',
            decorators: [c({ attribute: 'helper-text' })],
            key: 'helperText',
            value: () => '',
          },
          {
            kind: 'field',
            decorators: [
              c({ type: Boolean, reflect: !0, attribute: 'hide-label' }),
            ],
            key: 'hideLabel',
            value: () => !1,
          },
          ...
          {
            kind: 'field',
            decorators: [c({ attribute: 'invalid-text' })],
            key: 'invalidText',
            value: () => '',
          },
          {
            kind: 'field',
            decorators: [c({ attribute: 'title-text' })],
            key: 'titleText',
            value: () => '',
          },
          { kind: 'field', decorators: [c()], key: 'name', value: () => '' },
          {
            kind: 'field',
            decorators: [c({ type: Boolean, reflect: !0 })],
            key: 'open',
          ...
          },
          {
            kind: 'field',
            decorators: [
              c({ type: Boolean, reflect: !0, attribute: 'read-only' }),
            ],
            key: 'readOnly',
            value: () => !1,
          },
          ...
          {
            kind: 'field',
            decorators: [c({ attribute: 'toggle-label-closed' })],
            key: 'toggleLabelClosed',
            value: () => '',
          },
          {
            kind: 'field',
            decorators: [c({ attribute: 'toggle-label-open' })],
            key: 'toggleLabelOpen',
            value: () => '',
          },
          {
            kind: 'field',
            decorators: [c({ attribute: 'label' })],
            key: 'label',
            value: () => '',
          },
          {
          ...
          {
            kind: 'field',
            decorators: [c({ attribute: 'warn-text' })],
            key: 'warnText',
            value: () => '',
          },
          {
            ...
            key: 'shouldUpdate',
            value: function (e) {
              const { selectorItem: s } = this.constructor;
              if (
                (e.has('size') &&
                  h(this.querySelectorAll(s), (e) => {
                    e.size = this.size;
                  }),
                e.has('disabled') && this.disabled)
              ) {
                const { disabled: e } = this;
                h(this.querySelectorAll(s), (s) => {
                  e ? (s.disabled = e) : s.removeAttribute('disabled');
                });
              }
              if (e.has('value')) {
                h(this.querySelectorAll(s), (e) => {
                ...
                const e = y(
                  this.querySelectorAll(s),
                  (e) => e.value === this.value
                );
                if (e) {
                  const s = this.ownerDocument.createRange();
                  s.selectNodeContents(e),
                    (this._selectedItemContent = s.cloneContents());
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this._hasSlug
                ...
                null === (s = this.shadowRoot) ||
                  void 0 === s ||
                  null === (s = s.querySelector("slot[name='slug']")) ||
                  void 0 === s ||
                  s.classList.toggle(
                    `${a}--slug--revert`,
                    null === (t = this.querySelector(`${a}-slug`)) ||
                      void 0 === t
                      ? void 0
            ...
            value: function () {
              const {
                ...
                n = this.querySelectorAll(
                  this.constructor.selectorItemSelected
                ).length;
              return t({
                [`${a}--dropdown`]: !0,
                [`${a}--list-box`]: !0,
                [`${a}--list-box--disabled`]: e,
                [`${a}--list-box--inline`]: r,
                [`${a}--list-box--expanded`]: d,
                [`${a}--list-box--${s}`]: s,
                [`${a}--dropdown--invalid`]: o,
                [`${a}--dropdown--warn`]: c,
                [`${a}--dropdown--inline`]: r,
                [`${a}--dropdown--selected`]: n > 0,
              });
            },
          },
          {
            ...
            value: function () {
              const {
                  ...
                  warnText: v,
                  _activeDescendant: h,
                  _shouldTriggerBeFocusable: f,
                  _handleClickInner: y,
                  _handleKeydownInner: w,
                  _handleKeypressInner: k,
                  _handleSlotchangeHelperText: z,
                  _handleSlugSlotChange: S,
                  _slotHelperTextNode: q,
                } = this,
                T = x === I.INLINE;
              let $;
              if (l && !h) {
                ...
                const e = this.constructor;
                $ =
                  null === (B = this.querySelectorAll(e.selectorItem)[0]) ||
                  void 0 === B
                    ? void 0
                    : B.id;
              }
              const L = t({
                  [`${a}--form__helper-text`]: !0,
                  [`${a}--form__helper-text--disabled`]: o,
                }),
                A = t({
                  [`${a}--list-box__menu-icon`]: !0,
                  [`${a}--list-box__menu-icon--open`]: l,
                }),
                j = (l ? _ : m) || void 0,
                R = c || n || v || (q && q.assignedNodes().length > 0),
                C = r
                  ? p({
                      class: `${a}--list-box__invalid-icon`,
                      'aria-label': j,
                    })
                  : void 0,
                E =
                  !g || (r && g)
                    ? void 0
                    : u({
                        class: `${a}--list-box__invalid-icon ${a}--list-box__invalid-icon--warning`,
                        'aria-label': j,
                      }),
                G = r ? n : g ? v : c,
                U = d(
    ...
    `),
                ...
                w,
                k,
                i(f ? 'trigger-button' : void 0),
                a,
                i(f ? '0' : void 0),
                i(f ? 'combobox' : void 0),
                i(f ? 'dropdown-label' : void 0),
                i(f ? String(l) : void 0),
                i(f ? 'listbox' : void 0),
                i(f ? 'menu-body' : void 0),
                i(f ? (l ? (null != h ? h : $) : '') : void 0),
                this._renderPrecedingLabel(),
                this._renderLabel(),
                C,
                E,
                this._renderFollowingLabel(),
                A,
                b({ 'aria-label': j }),
                S,
                U,
          ...
          },
          {
            ...
            value: function () {
              return `${a}-dropdown-item[highlighted]`;
            },
          },
          {
            kind: 'get',
          ...
          },
          {
            ...
            value: function () {
              return `${a}-dropdown-item[selected]`;
            },
          },
          {
            kind: 'get',
            ...
            value: function () {
              return `${a}-dropdown-beingselected`;
            },
          },
          {
            kind: 'get',
          ...
          },
          {
            ...
            value: function () {
              return `${a}-dropdown-beingtoggled`;
            },
          },
          {
            kind: 'get',
...
export { L as C, z as D, S as a, T as s };
