  ...
  var e = {
    ...
    initializeClassElements: function (e, o) {
      ...
      ['method', 'field'].forEach(function (t) {
        o.forEach(function (o) {
          var r = o.placement;
          if (o.kind === t && ('static' === r || 'prototype' === r)) {
            var c = 'static' === r ? e : d;
    ...
    defineClassElement: function (e, o) {
      ...
      if ('field' === o.kind) {
        ...
        d = {
          ...
          value: void 0 === t ? void 0 : t.call(e),
        };
      }
      Object.defineProperty(e, o.key, d);
    },
    decorateClass: function (e, o) {
      ...
      if (
        ...
        e.forEach(function (e) {
          if (!z(e)) return d.push(e);
          var o = this.decorateElement(e, r);
          d.push(o.element),
            d.push.apply(d, o.extras),
            t.push.apply(t, o.finishers);
        }, this),
        !o)
      )
        return { elements: d, finishers: t };
      var c = this.decorateConstructor(d, o);
      return t.push.apply(t, c.finishers), (c.finishers = t), c;
    },
    addElementPlacement: function (e, o, d) {
      var t = o[e.placement];
      if (!d && -1 !== t.indexOf(e.key))
        throw new TypeError('Duplicated element (' + e.key + ')');
      t.push(e.key);
    },
    decorateElement: function (e, o) {
      for (
        var d = [], t = [], r = e.decorators, c = r.length - 1;
        c >= 0;
        c--
      ) {
        var s = o[e.placement];
        ...
        var i = this.fromElementDescriptor(e),
          n = this.toElementFinisherExtras((0, r[c])(i) || i);
        (e = n.element),
          this.addElementPlacement(e, o),
          n.finisher && t.push(n.finisher);
        var a = n.extras;
        if (a) {
      ...
      return { element: e, finishers: t, extras: d };
    },
    decorateConstructor: function (e, o) {
      for (var d = [], t = o.length - 1; t >= 0; t--) {
        var r = this.fromClassDescriptor(e),
          c = this.toClassDescriptor((0, o[t])(r) || r);
        if (
          (void 0 !== c.finisher && d.push(c.finisher), void 0 !== c.elements)
        ) {
          e = c.elements;
          for (var s = 0; s < e.length - 1; s++)
            for (var i = s + 1; i < e.length; i++)
              if (e[s].key === e[i].key && e[s].placement === e[i].placement)
                throw new TypeError('Duplicated element (' + e[s].key + ')');
        }
      }
      return { elements: e, finishers: d };
    },
          ...
          return (
            ...
            (function (e, o) {
              if (e) {
                ...
                return (
                  'Object' === d && e.constructor && (d = e.constructor.name),
                  'Map' === d || 'Set' === d
                    ? Array.from(e)
                    : 'Arguments' === d ||
    ...
    toClassDescriptor: function (e) {
      ...
      var d = P(e, 'finisher');
      return { elements: this.toElementDescriptors(e.elements), finisher: d };
    },
    ...
    disallowProperty: function (e, o, d) {
      if (void 0 !== e[o])
        throw new TypeError(d + " can't have a ." + o + ' property.');
    },
  };
  return e;
}
...
function j(e, o) {
  ...
  for (var d = 0, t = Array(o); d < o; d++) t[d] = e[d];
  return t;
}
function T() {
  return (
    (T =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, o, d) {
            var t = (function (e, o) {
              for (; !{}.hasOwnProperty.call(e, o) && null !== (e = D(e)); );
              return e;
            })(e, o);
            if (t) {
              var r = Object.getOwnPropertyDescriptor(t, o);
              return r.get ? r.get.call(arguments.length < 3 ? e : d) : r.value;
            }
          }),
...
const { stablePrefix: S } = t;
let $ = (function (e, o, d, t) {
  var r = _();
  if (t) for (var c = 0; c < t.length; c++) r = t[c](r);
  var s = o(function (e) {
      r.initializeInstanceElements(e, i.elements);
    }, d),
    i = r.decorateClass(
      (function (e) {
        for (
          ...
          var r,
            c = e[t];
          if ('method' === c.kind && (r = o.find(d)))
            if (E(c.descriptor) || E(r.descriptor)) {
              if (z(c) || z(r))
  ...
  return (
    r.initializeClassElements(s.F, i.elements),
    r.runClassFinishers(s.F, i.finishers)
  );
})(
  [i(`${S}-lightbox-image-viewer`)],
  function (e, o) {
    class t extends o {
      constructor(...o) {
        super(...o), e(this);
      ...
      d: [
        {
          ...
          value: function () {
            ...
            return d(b || (b = x` <slot name="description">${0}</slot> `), e);
          },
        },
        {
          kind: 'method',
    ...
    `),
        ...
        },
        {
          ...
          value: function () {
            const { title: e } = this;
            return d(f || (f = x` <slot name="title">${0}</slot> `), e);
          },
        },
        {
          kind: 'method',
          ...
          value: function () {
            return d(
              y || (y = x` <slot name="cta">${0}</slot> `),
              this._ctaContents
            );
          },
        },
        { kind: 'field', decorators: [r()], key: 'alt', value: () => '' },
        {
          kind: 'field',
          decorators: [r({ attribute: 'default-src' })],
          key: 'defaultSrc',
          value: () => '',
        },
        {
        ...
        { kind: 'field', decorators: [r()], key: 'title', value: () => '' },
        {
          ...
          value: function () {
            !(function (e, o, d, t) {
              var r = T(D(1 & t ? e.prototype : e), o, d);
              return 2 & t && 'function' == typeof r
                ? function (e) {
                    return r.apply(d, e);
                  }
                : r;
              ...
              (this._ctaContents =
                this.querySelector('[slot="cta"]') || void 0);
          },
        },
      ],
    };
