  ...
  E = e(
    ...
    `)
              ...
              if (e.has('selected') || e.has('target')) {
                ...
                if (t) {
                  const r = this.getRootNode(),
                    i = null == r ? void 0 : r.getElementById(t);
                  null == i || i.toggleAttribute('hidden', !e);
                }
              }
              return !0;
            },
          },
          {
            ...
            key: 'render',
            value: function () {
              const { disabled: e, selected: t, target: r } = this,
                i = d({
      ...
      <span class="${0}--content-switcher__label"><slot></slot></span>
        ...
        ${0} ${0}
          ...
          },
          {
            ...
            value: () =>
              a(a({}, r.shadowRootOptions), {}, { delegatesFocus: !0 }),
          },
          ...
          },
          {
            ...
            value: function () {
              this.hasAttribute('role') ||
                ...
                (function (e, t, r, i) {
                  var n = p(h(1 & i ? e.prototype : e), t, r);
                  return 2 & i
                    ? function (e) {
                        return n.apply(r, e);
                      }
      ...
      (function (e) {
        for (
          ...
          if ('method' === o.kind && (n = t.find(r)))
            if (S(o.descriptor) || S(n.descriptor)) {
              if (T(o) || T(n))
      ...
      d: [
        {
          ...
          value: function () {
            !(function (e, t, r, i) {
              var n = F(R(1 & i ? e.prototype : e), t, r);
        ...
        },
        {
          ...
          key: 'render',
          value: function () {
            const { disabled: e, selected: t, value: r } = this;
            return o(
              P ||
                (P = A`
      <button
