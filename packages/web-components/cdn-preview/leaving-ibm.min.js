...
import { b as n, C as d, s as i } from './store.js';
import { l as c } from './translateAPI.js';
import { s as a } from './localeAPI.js';
import { M as l, C as p } from './modal.js';
import { H as m } from './host-listener2.js';
import { H as u } from './host-listener.js';
import { S as f } from './stable-selector.js';
import { c as g } from './carbon-element.js';
import { C as v } from './modal-body.js';
import { l as h } from './if-defined.js';
import './link.js';
import { a as b } from './modal-heading.js';
import { M as y } from './modal-render.js';
  ...
  var e = {
    ...
    initializeClassElements: function (e, t) {
      ...
      ['method', 'field'].forEach(function (r) {
        t.forEach(function (t) {
          var s = t.placement;
          if (t.kind === r && ('static' === s || 'prototype' === s)) {
            var n = 'static' === s ? e : o;
    ...
    decorateElement: function (e, t) {
      for (
        var o = [], r = [], s = e.decorators, n = s.length - 1;
        n >= 0;
        n--
      ) {
        var d = t[e.placement];
        ...
        var i = this.fromElementDescriptor(e),
          c = this.toElementFinisherExtras((0, s[n])(i) || i);
        (e = c.element),
    ...
    decorateConstructor: function (e, t) {
      for (var o = [], r = t.length - 1; r >= 0; r--) {
        var s = this.fromClassDescriptor(e),
          n = this.toClassDescriptor((0, t[r])(s) || s);
        if (
          (void 0 !== n.finisher && o.push(n.finisher), void 0 !== n.elements)
        ) {
          e = n.elements;
          for (var d = 0; d < e.length - 1; d++)
            for (var i = d + 1; i < e.length; i++)
              if (e[d].key === e[i].key && e[d].placement === e[i].placement)
      ...
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, t, o) {
            ...
            if (r) {
              ...
              return s.get ? s.get.call(arguments.length < 3 ? e : o) : s.value;
            }
          }),
...
const { stablePrefix: j } = o;
!(function (e, t, o, r) {
  var s = x();
  if (r) for (var n = 0; n < r.length; n++) s = r[n](s);
  var d = t(function (e) {
    ...
    i = s.decorateClass(
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = t.find(o)))
            if (E(n.descriptor) || E(s.descriptor)) {
              if (_(n) || _(s))
  ...
  s.initializeClassElements(d.F, i.elements),
    s.runClassFinishers(d.F, i.finishers);
})(
  [g(`${j}-leaving-ibm-modal`)],
  function (e, o) {
    class r extends o {
      constructor(...t) {
        super(...t), e(this);
      ...
      d: [
        {
          ...
          key: '_uniqueId',
          value: () =>
            `__${j}-leaving-ibm-modal__${Math.random().toString(36).slice(2)}`,
        },
        {
          kind: 'field',
          decorators: [u('shadowRoot:slotchange')],
          key: '_handleShadowRootSlotChange',
          value() {
            return (e) => {
              const { selectorHeading: t } = this.constructor;
              if (!this.hasAttribute('aria-labelledby')) {
                const o = e.target.assignedNodes().reduce((e, o) => {
                  var r, s, n, d, i;
                  null !== (r = (s = o).matches) && void 0 !== r && r.call(s, t)
                    ? e.push(o)
                    : e.push(
                        ...(null !==
                          (n =
                            null === (d = (i = o).querySelectorAll) ||
                            void 0 === d
                              ? void 0
                              : d.call(i, t)) && void 0 !== n
                          ? n
                ...
                if (o) {
                  if (!o.id) {
                    const { id: e, _uniqueId: t } = this;
                    o.id = e || t;
                  }
                  o.id && this.setAttribute('aria-labelledby', o.id);
                }
              }
            };
          },
        ...
        },
        {
          ...
          value: function () {
            ...
            this.hasAttribute('role') || this.setAttribute('role', 'dialog'),
              ...
              (t = 'connectedCallback'),
              (o = this),
              (n = C(T(1 & (s = 3) ? e.prototype : e), t, o)),
              2 & s && 'function' == typeof n
                ? function (e) {
                    return n.apply(o, e);
                  }
                : n)([]);
        ...
        },
        {
          ...
          key: 'selectorHeading',
          value: function () {
            return `${j}-leaving-ibm-modal-heading`;
          },
        },
...
!(function (e, t, o, r) {
      ...
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = t.find(o)))
            if (L(n.descriptor) || L(s.descriptor)) {
              if (R(n) || R(s))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
  ...
  function (e, o) {
    return {
      ...
      <cds-link size="lg" href="${0}" part="supplemental-link"
        >${0}</cds-link
      >
    `),
              h(e),
              e ? new URL(e).hostname : e
            );
          },
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${B}--leaving-ibm-modal-body`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => k },
      ],
      ...
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = t.find(o)))
            if (V(n.descriptor) || V(s.descriptor)) {
              if (G(n) || G(s))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${W}--leaving-ibm-modal-heading`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => k },
      ],
...
!(function (e, t, o, r) {
      ...
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = t.find(o)))
            if (de(n.descriptor) || de(s.descriptor)) {
              if (ne(n) || ne(s))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
  ...
  [g(`${le}-leaving-ibm-modal-supplemental`)],
  function (e, o) {
    return {
      F: class extends o {
        constructor(...t) {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${le}--leaving-ibm-modal-supplemental`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => k },
      ],
...
const { stablePrefix: xe } = o;
let we = (function (e, t, o, r) {
  var s = ue();
  if (r) for (var n = 0; n < r.length; n++) s = r[n](s);
  var d = t(function (e) {
      s.initializeInstanceElements(e, i.elements);
      ...
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = t.find(o)))
            if (he(n.descriptor) || he(s.descriptor)) {
              if (ve(n) || ve(s))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
  ...
  function (e, o) {
      ...
      d: [
        {
          ...
          key: 'leavingIbmCopy',
          value: () => ({ LEAVING001: '', LEAVING002: '', LEAVING003: '' }),
        },
        {
          kind: 'field',
          decorators: [t({ attribute: !1 })],
          key: 'leavingIbmButtonLabel',
          value: () => '',
        },
        { kind: 'field', decorators: [t()], key: 'language', value: void 0 },
        {
          kind: 'field',
        ...
        {
          kind: 'field',
          decorators: [u('document:click')],
          key: '_handleDocumentClick',
          value() {
            return (e) => {
              const { attributeLeaving: t } = this.constructor;
              if (!this.open) {
                const { target: o } = e,
                  r =
                ...
                if (r) {
                  const s = r.hasAttribute(t),
                    n = o instanceof Element && o.hasAttribute(t);
                  (s || n) &&
                    (e.preventDefault(),
                    (this.href = r.href),
                    (this.open = !0));
        ...
        {
          kind: 'field',
          decorators: [u(`document:${p.eventClose}`)],
          key: 'handleEventClose',
          value() {
            return () => {
              (this.open = !1), (this.href = '');
            };
          },
        },
        {
          ...
          value: function () {
            ...
            var o;
            t &&
              (null === (o = this._setLanguage) ||
                void 0 === o ||
                o.call(this, t));
            null === (e = this._loadTranslation) ||
              void 0 === e ||
              e.call(this, t).catch(() => {});
          },
        },
        ...
        },
        {
          ...
          value: function () {
            const {
              open: e,
              leavingIbmCopy: t,
              leavingIbmButtonLabel: o,
              href: s,
            } = this;
            return r(
              pe ||
                (pe = me`
      <c4d-leaving-ibm-modal ?open="${0}" part="modal">
        <cds-modal-header part="header">
          ...
          <c4d-leaving-ibm-modal-heading part="heading"
            >${0}</c4d-leaving-ibm-modal-heading
          >
        </cds-modal-header>
        <c4d-leaving-ibm-modal-body part="body" href="${0}">
          <p>${0}</p>
          <c4d-leaving-ibm-modal-supplemental part="supplemental"
            >${0}</c4d-leaving-ibm-modal-supplemental
          >
        </c4d-leaving-ibm-modal-body>
        <cds-modal-footer part="footer">
          <cds-button
            part="footer-button"
            data-autoid="${0}--leaving-ibm-cta"
            href="${0}"
            kind="primary"
            >${0}</cds-button
          >
    ...
    `),
              e,
              null == t ? void 0 : t.LEAVING001,
              s,
              null == t ? void 0 : t.LEAVING002,
              null == t ? void 0 : t.LEAVING003,
              xe,
              s,
              o
            );
...
!(function (e, t, o, r) {
      ...
      (function (e) {
        for (
          ...
          var s,
            n = e[r];
          if ('method' === n.kind && (s = t.find(o)))
            if (Ae(n.descriptor) || Ae(s.descriptor)) {
              if (Pe(n) || Pe(s))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
  ...
  d(
    ...
    function (e) {
      var t, o;
      const { localeAPI: r, translateAPI: s } = e,
        { language: n } = null != r ? r : {},
        { translations: d } = null != s ? s : {};
      return {
        leavingIbmCopy: n
          ? null == d || null === (t = d[n]) || void 0 === t
            ? void 0
            : t.leaving
          : void 0,
        leavingIbmButtonLabel: n
          ? null == d ||
            null === (o = d[n]) ||
            void 0 === o ||
            null === (o = o.misc) ||
    ...
    function (e) {
      return n({ _setLanguage: a, _loadTranslation: c }, e);
    }
  )(we)
);
