...
const { stablePrefix: m } = s;
let y = (function (e, r, t, i) {
  var n = a();
      ...
      d: [
        {
          ...
          value: function () {
            return 'rtl' === document.dir.toLowerCase()
              ? r({ part: 'l0-arrow-cat-heading' })
              : t({ part: 'l0-arrow-cat-heading' });
          },
        },
        {
          kind: 'field',
          decorators: [
            i({ reflect: !0, type: Number, attribute: 'heading-level' }),
          ],
          key: 'headingLevel',
          value: () => 3,
        },
