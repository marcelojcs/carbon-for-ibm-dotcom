...
import { L as s } from './Locale.js';
import { M as a, a as l, b as c } from './media-query.js';
...
const { stablePrefix: E } = i,
  D = { second: 1e3, minute: 6e4, hour: 36e5, day: 864e5 },
  P = Object.keys(D),
  j = (e, t) => {
    const r = `${e.lc}-${e.cc}`;
    return (
      ...
      Object.fromEntries(
        P.map((e) => [
          ...
          new Intl.NumberFormat(r, {
            ...
            unit: e,
            unitDisplay: t,
            minimumIntegerDigits: 'day' === e ? 1 : 2,
  ...
  function (e, i) {
    ...
    return {
      ...
      d: [
        ...
        { kind: 'field', decorators: [n()], key: 'timeDiff', value: void 0 },
        {
          kind: 'field',
          decorators: [n()],
          key: 'targetDateTime',
        ...
        {
          kind: 'field',
          decorators: [t({ attribute: 'target' })],
          key: 'targetInput',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'separator' })],
          key: 'separator',
          value: void 0,
        },
        {
          kind: 'field',
          decorators: [t({ attribute: 'label-type' })],
          key: 'labelType',
          value: () => 'long',
        },
        {
          ...
          key: '_formatters',
          value() {
            return j(this.locale, this.labelType);
          },
        },
        {
          kind: 'method',
          key: 'calculateDiff',
          value: function () {
            const { targetDateTime: e } = this;
            let t = (null != e ? e : 0) - Date.now();
            if (t < 0)
              return (
            ...
            const r = Math.floor(t / D.day);
            t -= r * D.day;
            const i = Math.floor(t / D.hour);
            t -= i * D.hour;
            const n = Math.floor(t / D.minute);
            t -= n * D.minute;
            const o = Math.floor(t / D.second);
            this.timeDiff = { days: r, hours: i, minutes: n, seconds: o };
          },
        },
        {
          kind: 'method',
        ...
        },
        {
          ...
          value: function () {
            ...
            if (void 0 === t) return '';
            const { days: s, hours: a, minutes: l, seconds: c } = t;
            let d;
            if ('none' === i) d = [s, a, l, c].join(null != r ? r : '');
            else {
              const {
                to_days: t,
                to_hours: i,
              ...
              d = n
                ? [t.format(s), i.format(a), f.format(l), u.format(c)].join(
                    null != r ? r : ''
                  )
                : `${t.format(s)} ${o(a, 2)}:${o(l, 2)}:${o(c, 2)}`;
            }
            return d;
          },
        },
        ...
        },
        {
          ...
          key: 'updated',
          value: function (e) {
            if (e.has('targetInput')) {
              let e = new Date(this.targetInput);
              const t = parseInt(this.targetInput);
              isNaN(e.valueOf()) && !isNaN(t) && (e = new Date(t)),
                isNaN(e.valueOf()) || (this.targetDateTime = e.getTime());
            }
            e.has('targetDateTime') &&
              (clearInterval(this._clock),
              (this._clock = setInterval(this.calculateDiff.bind(this), 1e3))),
              (e.has('locale') || e.has('labelType')) &&
        ...
        },
        {
          ...
          key: 'render',
          value: function () {
            return r(d || (d = f` ${0} `), this.formatOutput());
          },
        },
      ],
    };
