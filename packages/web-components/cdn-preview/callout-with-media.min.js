...
import { n as e, s as t, i as r } from './query-assigned-elements.js';
import { s as i } from './callout-with-media.js';
import { C as o } from './callout.js';
import { C as n } from './content-block.js';
import { S as s } from './stable-selector.js';
import { c as a } from './carbon-element.js';
import { C as l } from './defs2.js';
import { C as c } from './content-block-copy.js';
import './callout-with-media-image.min.js';
import './callout-with-media-video.min.js';
  ...
  function (t, r) {
    ...
    return {
      ...
      d: [
        {
          kind: 'field',
          decorators: [e({ reflect: !0, attribute: 'color-scheme' })],
          key: 'colorScheme',
          value: () => l.REGULAR,
        },
        {
          ...
          value: function (e) {
            ...
            (r = 'updated'),
            (i = this),
            (s = b(w(1 & (n = 3) ? t.prototype : t), r, i)),
            2 & n && 'function' == typeof s
              ? function (e) {
                  return s.apply(i, e);
                }
              : s)([e]);
            const a = this.querySelector(this.constructor.selectorCopy),
              l = this.querySelector(this.constructor.selectorImage),
              c = this.querySelector(this.constructor.selectorVideo);
            a && (a.colorScheme = this.colorScheme),
              l && (l.colorScheme = this.colorScheme),
              c && (c.colorScheme = this.colorScheme);
          },
        },
        {
          kind: 'get',
          ...
          key: 'selectorImage',
          value: function () {
            return `${k}-callout-with-media-image`;
          },
        },
        {
          kind: 'get',
          ...
          key: 'selectorVideo',
          value: function () {
            return `${k}-callout-with-media-video`;
          },
        },
        {
          kind: 'get',
          ...
          key: 'selectorCopy',
          value: function () {
            return `${k}-callout-with-media-copy`;
          },
        },
        {
          kind: 'get',
  ...
  return (
    (T =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, t, r) {
            var i = (function (e, t) {
              for (; !{}.hasOwnProperty.call(e, t) && null !== (e = z(e)); );
              return e;
            })(e, t);
            if (i) {
              var o = Object.getOwnPropertyDescriptor(i, t);
...
!(function (e, t, r, i) {
      ...
      (function (e) {
        for (
          ...
          var o,
            n = e[i];
          if ('method' === n.kind && (o = t.find(r)))
            if (C(n.descriptor) || C(o.descriptor)) {
              if (A(n) || A(o))
                throw new ReferenceError(
                  'Duplicated methods (' + n.key + ") can't be decorated."
                );
  ...
  function (t, o) {
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${F}--callout-with-media-copy`;
          },
        },
        {
          kind: 'get',
    ...
    `),
              ...
              (t = 'styles'),
              (o = this),
              (a = T(z(1 & s ? e.prototype : e), t, o)),
              2 & s && 'function' == typeof a
                ? function (e) {
                    return a.apply(o, e);
                  }
                : a),
