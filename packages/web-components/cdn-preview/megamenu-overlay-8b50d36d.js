 ...
 */
let C4DMegaMenuOverlay = _decorate([carbonElement(`${c4dPrefix}-megamenu-overlay`)], function (_initialize, _LitElement) {
  class C4DMegaMenuOverlay extends _LitElement {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
...
export { C4DMegaMenuOverlay as default };
