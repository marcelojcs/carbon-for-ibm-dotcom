...
import { C as t } from './modal-close-button.js';
import { E as i, s as n } from './expressive-modal.js';
...
!(function (e, r, t, i) {
      ...
      (function (e) {
        for (
          ...
          if ('method' === o.kind && (n = r.find(t)))
            if (f(o.descriptor) || f(n.descriptor)) {
              if (d(o) || d(n))
  ...
  n.initializeClassElements(s.F, p.elements),
    n.runClassFinishers(s.F, p.finishers);
})(
  [s(`${h}-expressive-modal-close-button`)],
  function (r, t) {
    return {
      F: class extends t {
        constructor(...e) {
      ...
      d: [
        {
          kind: 'field',
          decorators: [e({ reflect: !0, attribute: 'size' })],
          key: 'size',
          value: () => i.REGULAR,
        },
        {
          ...
          key: 'stableSelector',
          value: function () {
            return `${h}--expressive-modal-close-button`;
          },
        },
