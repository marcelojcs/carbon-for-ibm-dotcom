...
let process = { env: {} };
import { _ as _decorate$1, F as FocusMixin, g as s, n, p as prefix$1, x, l as _objectSpread2, m as styles, c as carbonElement, o as l, q as o, T as TABS_TYPE, r as styles$1, t as _get$1, u as _getPrototypeOf$1, s as styles$2, a as settings } from './index-5becb925.js';
 ...
 */
let CDSContentSwitcherItem = _decorate$1([carbonElement(`${prefix$1}-content-switcher-item`)], function (_initialize, _FocusMixin) {
  ...
  return {
    ...
    d: [{
      ...
      function updated(changedProperties) {
        if (changedProperties) {
          ...
          (_this$shadowRoot = this.shadowRoot) === null || _this$shadowRoot === void 0 || (_this$shadowRoot = _this$shadowRoot.querySelector(`${prefix$1}-tooltip`)) === null || _this$shadowRoot === void 0 || (_this$shadowRoot = _this$shadowRoot.shadowRoot) === null || _this$shadowRoot === void 0 || (_this$shadowRoot = _this$shadowRoot.querySelector(`.${prefix$1}--tooltip`)) === null || _this$shadowRoot === void 0 || _this$shadowRoot.classList.add(`${prefix$1}--icon-tooltip`);
        }
      }
    ...
    `));
      ...
      value: function render() {
        ...
        const switcherItem = x(_t2 || (_t2 = _$2`<button
      type="button"
      role="tab"
      class="${0}"
      ?disabled="${0}"
    ...
    </button>`), className, disabled, selected ? '0' : '-1', l(target), Boolean(selected), prefix$1);
        if (this.icon) {
          const {
            align,
            closeOnActivation,
          ...
          return x(_t3 || (_t3 = _$2`<cds-tooltip
        align=${0}
      ...
      value() {
        return _objectSpread2(_objectSpread2({}, s.shadowRootOptions), {}, {
          delegatesFocus: true
        });
      }
    }, {
 ...
 * @element cds-tab
 */
let CDSTab = _decorate$1([carbonElement(`${prefix$1}-tab`)], function (_initialize, _CDSContentSwitcherIt) {
  ...
  return {
    ...
    `), prefix$1, tabTitle, selected ? 0 : -1, disabled, Boolean(selected), handleSlotChange);
      }
    }, {
      kind: "field",
      static: true,
 ...
 */
let C4DMegaMenuTab = _decorate([carbonElement(`${c4dPrefix}-megamenu-tab`)], function (_initialize, _CDSTab) {
  ...
  return {
    ...
    `), prefix, disabled, Boolean(selected), value, safariTabIndex);
      }
    }, {
      kind: "field",
      static: true,
