...
import { C as s } from './content-block.js';
import { c as o } from './carbon-element.js';
import { M as i, a, b as r } from './media-query.js';
import './content-block-heading.js';
import './card.js';
import './card-eyebrow.js';
import './card-footer.js';
import './card-heading.js';
import './image-logo.js';
import './card-group-item.js';
import './card-group-card-link-item.js';
import './card-cta-footer.js';
import './card-link-heading.js';
import './video-cta-container.min.js';
import './class-map.js';
import './directive.js';
...
import './cta2.js';
import './store.js';
import './video-player-container.js';
import './hybrid-render.js';
import './205.js';
import './if-non-empty.js';
import './Locale.js';
import './lightbox-video-player-composite.js';
var n = c([
  ...
  var c = {
    ...
    decorateElement: function (c, e) {
      for (
        ...
        var a = this.fromElementDescriptor(c),
          r = this.toElementFinisherExtras((0, s[o])(a) || a);
        (c = r.element),
      ...
      for (var d = [], t = e.length - 1; t >= 0; t--) {
        ...
        if (
          ...
          for (var i = 0; i < c.length - 1; i++)
            for (var a = i + 1; a < c.length; a++)
              if (c[i].key === c[a].key && c[i].placement === c[a].placement)
    ...
    toElementDescriptors: function (c) {
      if (void 0 !== c)
        ...
        (function (c) {
          ...
          (function (c, e) {
            if (c) {
              if ('string' == typeof c) return y(c, e);
...
function k(c, e, d, t) {
  var s = _(x(1 & t ? c.prototype : c), e, d);
  ...
  return (
    (_ =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (c, e, d) {
            var t = (function (c, e) {
              for (; !{}.hasOwnProperty.call(c, e) && null !== (c = x(c)); );
              return c;
            })(c, e);
            if (t) {
...
const { prefix: w, stablePrefix: z } = e;
!(function (c, e, d, t) {
  var s = g();
  if (t) for (var o = 0; o < t.length; o++) s = t[o](s);
  var i = e(function (c) {
      s.initializeInstanceElements(c, a.elements);
    }, d),
    a = s.decorateClass(
      (function (c) {
        for (
  ...
  s.initializeClassElements(i.F, a.elements),
    s.runClassFinishers(i.F, a.finishers);
})(
  [o(`${z}-content-block-cards`)],
  function (e, t) {
    class s extends t {
      constructor(...c) {
        super(...c), e(this);
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            return `${w}--content-layout ${w}--content-layout--card-group`;
          },
        },
        {
          kind: 'get',
        ...
        },
        {
          ...
          value: function () {
            requestAnimationFrame(() => {
              let c = 0,
                e = 0;
              const d = this.querySelectorAll(`${z}-card-group-item`);
              d.forEach((d) => {
                var t;
                const s = d.querySelector('c4d-card-heading'),
                  o =
                    d.querySelector('p') ||
                    (null == d || null === (t = d.shadowRoot) || void 0 === t
                      ? void 0
                      : t.querySelector('div.cds--card__copy'));
                let i = 0,
                  a = 0;
                s &&
                  o &&
                  ((i = null == s ? void 0 : s.getBoundingClientRect().height),
                  (a = null == o ? void 0 : o.getBoundingClientRect().height)),
                  (c = c > i ? c : i),
                  (e = e > a ? e : a);
              });
              for (const s of d) {
                var t;
                const d = s.querySelector('c4d-card-heading'),
                  o =
                    s.querySelector('p') ||
                    (null == s || null === (t = s.shadowRoot) || void 0 === t
                      ? void 0
                      : t.querySelector('div.cds--card__copy'));
                d &&
                  o &&
                  (d.setAttribute('style', `height: ${c}px; display: block;`),
                  o.setAttribute('style', `height: ${e}px; display: block;`));
              }
            });
          },
        },
        {
          ...
          value: function () {
            window.addEventListener('load', () => {
              this._isMobileOrMedium && this.setSameHeightOnMobile();
            });
          },
        },
        {
          ...
          value: function () {
            k(s, 'connectedCallback', this, 3)([]),
              (window.onload = () => {
                var c;
                const e = this.classList.contains('media-type__logo'),
                  d =
                    null === (c = this.shadowRoot) || void 0 === c
                      ? void 0
                      : c.querySelector('slot:not([name])');
                d &&
                  e &&
                  (null == d ||
                    d.assignedElements().forEach((c) => {
                      c.classList.add('media-type-block-cards__logo');
                    }));
              });
          },
        },
  ...
  console.warn(
    'The content-block-cards component has been deprecated in favor of the content-section/block and card-group component. See content-section/block and card-group documentation for more information.'
  );
