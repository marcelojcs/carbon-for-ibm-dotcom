...
let process = { env: {} };
import {
  C as C4DMegaMenuRightNavigation,
  s as styles,
  c as carbonElement,
  a as settings,
 ...
 */
let C4DMegaMenuLeftNavigation = _decorate(
  [carbonElement(`${c4dPrefix}-megamenu-left-navigation`)],
  function (_initialize, _C4DMegaMenuRightNavi) {
