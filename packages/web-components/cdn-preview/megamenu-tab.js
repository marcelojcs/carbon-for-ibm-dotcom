...
import { x as e, s as t } from './query-assigned-elements.js';
import { C as r } from './tab.js';
...
const { prefix: v } = t,
  { stablePrefix: b } = t;
let j = (function (e, t, r, i) {
  var o = a();
  if (i) for (var n = 0; n < i.length; n++) o = i[n](o);
  var s = t(function (e) {
      o.initializeInstanceElements(e, f.elements);
    }, r),
    f = o.decorateClass(
      (function (e) {
        for (
  ...
  return (
    o.initializeClassElements(s.F, f.elements),
    o.runClassFinishers(s.F, f.finishers)
  );
})(
  [o(`${b}-megamenu-tab`)],
  function (t, r) {
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          key: 'render',
          value: function () {
            const { disabled: t, selected: r, value: i } = this;
            return e(
              n ||
                (n = s`
      <button
