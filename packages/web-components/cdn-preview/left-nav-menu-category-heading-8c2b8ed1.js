...
let process = { env: {} };
import { g as s, n, G as t, x, q as o, j as svgResultCarbonIcon, k as svgResultCarbonIcon$1, s as styles, c as carbonElement, a as settings } from './index-5becb925.js';
 ...
 */
let C4DLeftNavMenuCategoryHeading = _decorate([carbonElement(`${c4dPrefix}-left-nav-menu-category-heading`)], function (_initialize, _LitElement) {
  class C4DLeftNavMenuCategoryHeading extends _LitElement {
    constructor(...args) {
      super(...args);
      _initialize(this);
    }
  ...
  return {
    F: C4DLeftNavMenuCategoryHeading,
    d: [{
      kind: "field",
      decorators: [n({
        attribute: 'title'
      ...
      value: function _renderHeading() {
        ...
        `), o(headingClasses), url, prefix, headingText, headingText, isRTL ? svgResultCarbonIcon() : svgResultCarbonIcon$1()) : x(_t2 || (_t2 = _`
          <h2 part="heading" class="${0}">
            ${0}
          </h2>
        `), o(headingClasses), headingText);
      }
    }, {
      kind: "method",
      key: "render",
    ...
    `), prefix, this._renderHeading(), prefix);
      }
    }, {
      kind: "field",
      static: true,
...
export { C4DLeftNavMenuCategoryHeading as default };
