 ...
 */ let c,
  ...
  m,
  y = (function (e) {
    return (e.SMALL = 'small'), (e.LEFT = 'left'), (e.CENTERED = 'centered'), e;
  })({}),
  v = (function (e) {
    return (e.NONE = ''), (e.WITH_GRADIENT = 'with-gradient'), e;
  })({}),
  g = (function (e) {
    return (
      (e.NONE = ''),
...
const { prefix: P, stablePrefix: O } = i;
let x = (function (e, t, r, i) {
  var n = E();
      ...
      (function (e) {
        for (
          ...
          if ('method' === o.kind && (n = t.find(r)))
            if (C(o.descriptor) || C(n.descriptor)) {
              if (_(o) || _(n))
  ...
  function (i, n) {
      ...
      d: [
        {
          ...
          value: function (e) {
            e.target.assignedNodes().filter((e) => {
              var t, r;
              return (
                (null === (t = (r = e).matches) || void 0 === t
                  ? void 0
                  : t.call(r, this.constructor.tagGroupSelector)) ||
                this.constructor.breadcrumbSelector
              );
            });
          },
        },
        {
          kind: 'method',
          key: '_getGradientClass',
          value: function () {
            return o({
              [`${O}--leadspace--gradient`]: this.defaultSrc,
              [`${O}--leadspace__overlay`]: !0,
            });
          },
        },
        {
          ...
          value: function () {
            return o({
              [`${O}--leadspace--centered`]: this.type === y.CENTERED,
              [`${O}--leadspace--centered__image`]:
                this.type === y.CENTERED && this.defaultSrc,
              [`${O}--leadspace--productive`]: this.type === y.SMALL,
              [`${O}--leadspace__section`]: !0,
            });
          },
        },
        {
    ...
    `),
        ...
        },
        {
          ...
          value: function () {
            const { title: t } = this;
            return e(d || (d = k` <slot name="heading">${0}</slot> `), t);
          },
        },
        ...
        {
          kind: 'field',
          decorators: [t({ reflect: !0, attribute: 'gradient-style-scheme' })],
          key: 'gradientStyleScheme',
          value: () => v.WITH_GRADIENT,
        },
        { kind: 'field', decorators: [t()], key: 'title', value: () => '' },
        {
          kind: 'field',
        ...
        },
        {
          ...
          value: function () {
            ...
            (Array.from(this.children).forEach((e) => {
              ('C4D-BACKGROUND-MEDIA' !== e.tagName &&
                'C4D-LEADSPACE-IMAGE' !== e.tagName) ||
                '' !== e.slot ||
                (e.slot = 'image');
            }),
            'short' === this.size) &&
              (null === (e = this.querySelector('c4d-leadspace-heading')) ||
                void 0 === e ||
                e.setAttribute('type-style', 'fluid-heading-05'));
          },
        },
        {
          kind: 'method',
          key: 'render',
          value: function () {
            const { gradientStyleScheme: t, type: i, size: n } = this;
            return e(
              p ||
                (p = k`
    ...
    `),
        ...
        },
        {
          kind: 'get',
          static: !0,
          key: 'tagGroupSelector',
          value: function () {
            return 'div';
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => s },
      ],
    };
  },
  a(n)
