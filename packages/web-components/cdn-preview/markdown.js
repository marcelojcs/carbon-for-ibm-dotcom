...
import { o as e } from './unsafe-html.js';
import {
  i as t,
  a as r,
  n as i,
...
import './link.js';
import { _ as l } from './decorate.js';
import { o as d } from './class-map.js';
import { p as c } from './settings.js';
import { _ as a, a as u } from './get.js';
import { c as f } from './carbon-element.js';
import { m as p } from './markdownToHtml.js';
/**
 * @license
 *
      ...
      return {
        ...
        d: [
          ...
          },
          {
            ...
            value: function () {
              this.closest(this.constructor.selectorListItem)
                ? this.setAttribute('slot', 'nested')
                : this.removeAttribute('slot'),
                (function (e, t, r, i) {
                  var s = a(u(1 & i ? e.prototype : e), t, r);
                  return 2 & i
                    ? function (e) {
                        return s.apply(r, e);
                      }
          ...
          },
          {
            ...
            value: function () {
              const e = d({
                [`${c}--list--unordered`]: !0,
                [`${c}--list--nested`]: 'nested' === this.getAttribute('slot'),
                [`${c}--list--expressive`]: this.isExpressive,
              });
              return s(
                h ||
                  (h = y`
    ...
    return {
      ...
      d: [
        ...
        },
        {
          ...
          value: function () {
            const e = d({
              [`${c}--list--ordered`]: !this.native,
              [`${c}--list--ordered--native`]: this.native,
              [`${c}--list--nested`]: 'nested' === this.getAttribute('slot'),
              [`${c}--list--expressive`]: this.isExpressive,
            });
            return s(
...
l(
  ...
  function (e, t) {
    ...
    return {
      F: r,
      d: [
        { kind: 'field', key: '_hasNestedChild', value: () => !1 },
        {
          kind: 'method',
          key: '_handleSlotChangeNested',
          value: function ({ target: e }) {
            (this._hasNestedChild = e.assignedNodes().length > 0),
              this.requestUpdate();
          },
        },
        {
        ...
        },
        {
          ...
          value: function () {
            this.toggleAttribute(
              'nested',
              Boolean(this.closest(this.constructor.selectorNestedList))
            ),
        ...
        },
        {
          ...
          key: 'render',
          value: function () {
            const { _hasNestedChild: e, _handleSlotChangeNested: t } = this;
            return s(
              g ||
                (g = w`
      <slot></slot>
    ...
    `),
        ...
        },
        {
          ...
          value: function () {
            return `${c}-ordered-list[slot="nested"],${c}-unordered-list[slot="nested"]`;
          },
        },
        { kind: 'field', static: !0, key: 'styles', value: () => m },
      ],
  ...
  var e = {
    ...
    initializeClassElements: function (e, t) {
      ...
      ['method', 'field'].forEach(function (i) {
        t.forEach(function (t) {
          var s = t.placement;
          if (t.kind === i && ('static' === s || 'prototype' === s)) {
            var n = 'static' === s ? e : r;
    ...
    decorateElement: function (e, t) {
      for (
        var r = [], i = [], s = e.decorators, n = s.length - 1;
        n >= 0;
        n--
      ) {
        var o = t[e.placement];
        ...
        var l = this.fromElementDescriptor(e),
          d = this.toElementFinisherExtras((0, s[n])(l) || l);
        (e = d.element),
          this.addElementPlacement(e, t),
          d.finisher && i.push(d.finisher);
        var c = d.extras;
        if (c) {
          for (var a = 0; a < c.length; a++) this.addElementPlacement(c[a], t);
          r.push.apply(r, c);
        }
      }
    ...
    decorateConstructor: function (e, t) {
      for (var r = [], i = t.length - 1; i >= 0; i--) {
        var s = this.fromClassDescriptor(e),
          n = this.toClassDescriptor((0, t[i])(s) || s);
        if (
          ...
          for (var o = 0; o < e.length - 1; o++)
            for (var l = o + 1; l < e.length; l++)
              if (e[o].key === e[l].key && e[o].placement === e[l].placement)
...
const { prefix: N, stablePrefix: R } = o;
let I = (function (e, t, r, i) {
  var s = A();
  if (i) for (var n = 0; n < i.length; n++) s = i[n](s);
  var o = t(function (e) {
      s.initializeInstanceElements(e, l.elements);
    }, r),
    l = s.decorateClass(
      (function (e) {
        for (
          ...
          var s,
            n = e[i];
          if ('method' === n.kind && (s = t.find(r)))
            if (D(n.descriptor) || D(s.descriptor)) {
              if (j(n) || j(s))
  ...
  return (
    s.initializeClassElements(o.F, l.elements),
    s.runClassFinishers(o.F, l.finishers)
  );
})(
  [f(`${R}-markdown`)],
  function (t, r) {
    ...
    return {
      F: o,
      d: [
        { kind: 'field', key: '_hasRendered', value: () => !1 },
        {
          kind: 'get',
          key: '_customTags',
          value: function () {
        ...
        },
        {
          ...
          value: function () {
            return {
              link: (e, t, r) =>
                `<${N}-link href="${e}" size="lg" ${
                  t ? `title="${t}"` : ''
                } part="link">${r}</${N}-link>`,
              list(e, t) {
                const r = `${N}-${t ? 'ordered' : 'unordered'}-list`;
                return `<${r} part="${
                  t ? 'list ordered-list' : 'list unordered-list'
                }">${e}</${r}>`;
              },
              listitem: (e) =>
                `<${N}-list-item part="list-item">${e}</${N}-list-item>`,
            };
          },
        },
        {
        ...
        },
        {
          ...
          value: function (t) {
            !(function (e, t, r, i) {
              var s = S(F(1 & i ? e.prototype : e), t, r);
              return 2 & i && 'function' == typeof s
                ? function (e) {
                    return s.apply(r, e);
                  }
                : s;
            ...
            if (!d && !this.firstElementChild) {
              const t = s(
                $ ||
                  ($ = x`
        ${0}
      `),
                e(p(null != r ? r : d ? '' : l, { customTags: i, renderer: c }))
              );
              (this._hasRendered = !0), (this.innerText = ''), n(t, this);
            }
            this.querySelectorAll(
              'cds-ordered-list, cds-unordered-list'
            ).forEach((e) => {
