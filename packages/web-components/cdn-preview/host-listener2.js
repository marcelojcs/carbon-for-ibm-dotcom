...
import { a as e } from './objectSpread2.js';
function t(e, ...t) {
  return (
    e.addEventListener(...t),
    { release: () => (e.removeEventListener(...t), null) }
  );
}
const o = /^((document|window|parentRoot|shadowRoot):)?([\w-]+)$/,
  s = (s) => {
    class n extends s {
      constructor(...t) {
        super(...t), e(this, '_handles', new Set());
      }
      connectedCallback() {
        ...
        Object.keys(e).forEach((s) => {
          Object.keys(e[s]).forEach((n) => {
            var r;
            const c = o.exec(n);
            if (!c) throw new Error(`Could not parse the event name: ${s}`);
            const [, , a, d] = c,
              h =
                {
            ...
            this._handles.add(
              t(
                h,
                null !== (r = this.constructor[d]) && void 0 !== r ? r : d,
                this[s],
                i
              )
            );
    ...
    return e(n, '_hostListeners', {}), n;
  };
export { s as H, t as o };
