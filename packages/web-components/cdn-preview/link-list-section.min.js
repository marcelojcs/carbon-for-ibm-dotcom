...
import { i as e, x as s, s as d } from './query-assigned-elements.js';
  ...
  var e = {
    ...
    initializeClassElements: function (e, s) {
      ...
      ['method', 'field'].forEach(function (c) {
        s.forEach(function (s) {
          var t = s.placement;
          if (s.kind === c && ('static' === t || 'prototype' === t)) {
            var i = 'static' === t ? e : d;
    ...
    decorateClass: function (e, s) {
      ...
      if (
        ...
        e.forEach(function (e) {
          if (!p(e)) return d.push(e);
          var s = this.decorateElement(e, t);
          d.push(s.element),
            d.push.apply(d, s.extras),
            c.push.apply(c, s.finishers);
        }, this),
        !s)
      )
        return { elements: d, finishers: c };
      var i = this.decorateConstructor(d, s);
      return c.push.apply(c, i.finishers), (i.finishers = c), i;
    },
    addElementPlacement: function (e, s, d) {
      var c = s[e.placement];
      if (!d && -1 !== c.indexOf(e.key))
        throw new TypeError('Duplicated element (' + e.key + ')');
      c.push(e.key);
    },
    decorateElement: function (e, s) {
      for (
        var d = [], c = [], t = e.decorators, i = t.length - 1;
        i >= 0;
        i--
      ) {
        var n = s[e.placement];
        ...
        var a = this.fromElementDescriptor(e),
          r = this.toElementFinisherExtras((0, t[i])(a) || a);
        (e = r.element),
          this.addElementPlacement(e, s),
          r.finisher && c.push(r.finisher);
        var o = r.extras;
        if (o) {
          for (var l = 0; l < o.length; l++) this.addElementPlacement(o[l], s);
          d.push.apply(d, o);
        }
      }
      return { element: e, finishers: c, extras: d };
    },
    decorateConstructor: function (e, s) {
      for (var d = [], c = s.length - 1; c >= 0; c--) {
        var t = this.fromClassDescriptor(e),
          i = this.toClassDescriptor((0, s[c])(t) || t);
        if (
          ...
          for (var n = 0; n < e.length - 1; n++)
            for (var a = n + 1; a < e.length; a++)
              if (e[n].key === e[a].key && e[n].placement === e[a].placement)
...
function u(e, s) {
  ...
  for (var d = 0, c = Array(s); d < s; d++) c[d] = e[d];
  return c;
}
const { prefix: y, stablePrefix: b } = d;
!(function (e, s, d, c) {
  var t = o();
  if (c) for (var i = 0; i < c.length; i++) t = c[i](t);
  var n = s(function (e) {
      t.initializeInstanceElements(e, a.elements);
    }, d),
    a = t.decorateClass(
      (function (e) {
        for (
          ...
          var t,
            i = e[c];
          if ('method' === i.kind && (t = s.find(d)))
            if (h(i.descriptor) || h(t.descriptor)) {
              if (p(i) || p(t))
                throw new ReferenceError(
                  'Duplicated methods (' + i.key + ") can't be decorated."
                );
              t.descriptor = i.descriptor;
            } else {
              if (p(i)) {
                if (p(t))
                  throw new ReferenceError(
  ...
  t.initializeClassElements(n.F, a.elements),
    t.runClassFinishers(n.F, a.finishers);
})(
  [i(`${b}-link-list-section`)],
  function (e, d) {
    return {
      F: class extends d {
        constructor(...s) {
          ...
          value() {
            return (e) => {
              const s = e.target
                .assignedElements()
                .filter(
                  (e) => e.localName === this.constructor.linkListSelector
                )[0];
              !s ||
                (s.hasAttribute('type') && 'end' === s.getAttribute('type')) ||
                s.setAttribute('type', 'end');
            };
          },
        },
        {
  ...
  console.warn(
    'The link-list-section component has been deprecated in favor of the content-section/block and link-list end of section variant components. See content-section/block and link-list documentation for more information.'
  );
