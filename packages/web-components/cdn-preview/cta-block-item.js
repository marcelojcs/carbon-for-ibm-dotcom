  ...
  var e = {
    ...
    initializeClassElements: function (e, t) {
      ...
      ['method', 'field'].forEach(function (c) {
        t.forEach(function (t) {
          var d = t.placement;
          if (t.kind === c && ('static' === d || 'prototype' === d)) {
            var s = 'static' === d ? e : o;
    ...
    defineClassElement: function (e, t) {
      ...
      if ('field' === t.kind) {
        ...
        o = {
          ...
          value: void 0 === c ? void 0 : c.call(e),
        };
      }
    ...
    decorateClass: function (e, t) {
      var o = [],
        c = [],
        d = { static: [], prototype: [], own: [] };
      if (
        (e.forEach(function (e) {
          this.addElementPlacement(e, d);
        }, this),
        e.forEach(function (e) {
          if (!w(e)) return o.push(e);
          var t = this.decorateElement(e, d);
          o.push(t.element),
            o.push.apply(o, t.extras),
            c.push.apply(c, t.finishers);
        }, this),
        !t)
      )
        return { elements: o, finishers: c };
      var s = this.decorateConstructor(o, t);
      return c.push.apply(c, s.finishers), (s.finishers = c), s;
    },
    addElementPlacement: function (e, t, o) {
      var c = t[e.placement];
      if (!o && -1 !== c.indexOf(e.key))
        throw new TypeError('Duplicated element (' + e.key + ')');
      c.push(e.key);
    },
    decorateElement: function (e, t) {
      for (
        var o = [], c = [], d = e.decorators, s = d.length - 1;
        s >= 0;
        s--
      ) {
        var i = t[e.placement];
        ...
        var n = this.fromElementDescriptor(e),
          r = this.toElementFinisherExtras((0, d[s])(n) || n);
        (e = r.element),
          this.addElementPlacement(e, t),
          r.finisher && c.push(r.finisher);
        var a = r.extras;
        if (a) {
      ...
      return { element: e, finishers: c, extras: o };
    },
    decorateConstructor: function (e, t) {
      for (var o = [], c = t.length - 1; c >= 0; c--) {
        var d = this.fromClassDescriptor(e),
          s = this.toClassDescriptor((0, t[c])(d) || d);
        if (
          (void 0 !== s.finisher && o.push(s.finisher), void 0 !== s.elements)
        ) {
          e = s.elements;
          for (var i = 0; i < e.length - 1; i++)
            for (var n = i + 1; n < e.length; n++)
              if (e[i].key === e[n].key && e[i].placement === e[n].placement)
...
function k(e) {
  ...
  return (
    e.decorators && (c.decorators = e.decorators),
    'field' === e.kind && (c.initializer = e.value),
    c
  );
}
function x(e, t) {
...
function S(e, t) {
  ...
  for (var o = 0, c = Array(t); o < t; o++) c[o] = e[o];
  return c;
}
function P(e, t, o, c) {
  var d = C(T(1 & c ? e.prototype : e), t, o);
  return 2 & c && 'function' == typeof d
    ? function (e) {
        return d.apply(o, e);
      }
    : d;
    ...
    (C =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, t, o) {
            ...
            if (c) {
              var d = Object.getOwnPropertyDescriptor(c, t);
              return d.get ? d.get.call(arguments.length < 3 ? e : o) : d.value;
            }
          }),
...
const { prefix: q, stablePrefix: A } = c,
  F = { action: '_hasAction', 'link-list': '_hasLinkList' };
!(function (e, t, o, c) {
  var d = y();
  if (c) for (var s = 0; s < c.length; s++) d = c[s](d);
  var i = t(function (e) {
      d.initializeInstanceElements(e, n.elements);
    }, o),
    n = d.decorateClass(
      (function (e) {
        for (
          ...
          var d,
            s = e[c];
          if ('method' === s.kind && (d = t.find(o)))
            if (_(s.descriptor) || _(d.descriptor)) {
              if (w(s) || w(d))
  ...
  d.initializeClassElements(i.F, n.elements),
    d.runClassFinishers(i.F, n.finishers);
})(
  [a(`${A}-cta-block`)],
  function (e, c) {
    class d extends c {
      ...
      d: [
        {
          kind: 'field',
          decorators: [
            t({ type: Boolean, attribute: 'no-border', reflect: !0 }),
          ],
          key: '_noBorder',
          value: () => !1,
        },
        ...
        },
        {
          ...
          value: function (e) {
            if (e.has('_noBorder')) {
              const e = this.shadowRoot.querySelector(`.${q}--content-layout`);
              null == e ||
                e.classList.toggle(
                  `${q}--content-layout--border`,
                  !this._noBorder
                );
            }
          },
        },
        {
          ...
          key: '_hasBodyContent',
          value: function () {
            const { _hasLinkList: e, _hasAction: t } = this;
            return e || t || P(d, '_hasBodyContent', this, 3)([]);
          },
        },
        {
          kind: 'method',
          ...
          value: function (e) {
            const { target: t } = e,
              { name: o } = t;
            if (!F[o]) return void P(d, '_handleSlotChange', this, 3)([e]);
            const c = t
              .assignedNodes()
              .some(
        ...
        },
        {
          ...
          key: '_renderActions',
          value: function () {
            const { _hasAction: e, _handleSlotChange: t } = this;
            return o(
              h ||
                (h = v`
      <div
        ?hidden="${0}"
        class="${0}--content-layout__cta"
        part="cta">
        ...
        },
        {
          ...
          value: function () {
            const {
              ...
              n = i({
                [`${q}--helper-wrapper`]: !0,
                [`${q}--helper-wrapper--less-space`]: !e && !t && !c,
              });
            return o(
              g ||
                (g = v`
      <div ?hidden="${0}" class="${0}" part="helper-wrapper">
        <div
          class="${0}--content-item-wrapper"
        ...
        },
        {
          ...
          value: function () {
            const {
              ...
              s = i({
                [`${q}--content-layout__body`]: !0,
                [`${q}--content-layout__body--tight`]: !e && !t && (c || d),
              });
            return o(
              m ||
                (m = v`
      <div ?hidden="${0}" class="${0}" part="body">
        ${0}${0}
      </div>
    `),
              !this._hasBodyContent(),
              s,
              this._renderCopy(),
        ...
        },
        {
          ...
          key: '_renderCopy',
          value: function () {
            const { _hasCopy: e, _handleSlotChange: t } = this;
            return o(
              b ||
                (b = v`
      <div
        ?hidden="${0}"
        class="${0}--content-layout__copy"
        part="copy">
    ...
    `),
        ...
        },
        {
          ...
          key: '_renderLinkList',
          value: function () {
            const { _hasLinkList: e, _handleSlotChange: t } = this;
            return o(
              u ||
                (u = v`
      <div
  ...
  console.warn(
    'The cta-block component has been deprecated in favor of the content-section/block and content-item components. See content-section/block and content-items documentation for more information.'
  );
let D,
  M,
  B = (e) => e;
...
const { prefix: H, stablePrefix: U } = c;
!(function (e, t, o, c) {
  var d = j();
  if (c) for (var s = 0; s < c.length; s++) d = c[s](d);
  var i = t(function (e) {
      ...
      (function (e) {
        for (
          ...
          var d,
            s = e[c];
          if ('method' === s.kind && (d = t.find(o)))
            if (R(s.descriptor) || R(d.descriptor)) {
              if (I(s) || I(d))
                throw new ReferenceError(
                  'Duplicated methods (' + s.key + ") can't be decorated."
                );
      ...
      d: [
        {
          kind: 'field',
          decorators: [
            t({ type: Boolean, reflect: !0, attribute: 'no-border' }),
          ],
          key: '_noBorder',
          value: () => !1,
        },
        ...
        },
        {
          ...
          value: function () {
            const e = Array.from(this.children).filter(
              (e) =>
                e instanceof l &&
                (null == e ? void 0 : e._hasMedia) &&
                !(null != e && e._hasPictogram)
            );
            (this._hasChildWithMedia = e.length > 0), this.render();
          },
        },
        {
          kind: 'method',
          key: 'render',
          value: function () {
            const { _hasChildWithMedia: e } = this;
            return o(
              e
                ? D ||
                    (D = B`<div class="scroll-container"><slot></slot></div>`)
                : M || (M = B`<slot></slot>`)
            );
          },
        },
  ...
  console.warn(
    'The cta-block-item-row component has been deprecated in favor of the content-section/block and content-item components. See content-section/block and content-items documentation for more information.'
  );
let W,
  Z,
  Y,
...
function se(e, t, o, c) {
  var d = ie(ne(1 & c ? e.prototype : e), t, o);
  return 2 & c && 'function' == typeof d
    ? function (e) {
        return d.apply(o, e);
      }
  ...
  return (
    (ie =
      'undefined' != typeof Reflect && Reflect.get
        ...
        : function (e, t, o) {
            var c = (function (e, t) {
              for (; !{}.hasOwnProperty.call(e, t) && null !== (e = ne(e)); );
              return e;
            })(e, t);
            if (c) {
              var d = Object.getOwnPropertyDescriptor(c, t);
...
const { prefix: re, stablePrefix: ae } = c,
  le = { media: '_hasMedia', statistic: '_hasStatistic', footer: '_hasFooter' };
!(function (e, t, o, c) {
  var d = K();
  if (c) for (var s = 0; s < c.length; s++) d = c[s](d);
  var i = t(function (e) {
      ...
      (function (e) {
        for (
          ...
          var d,
            s = e[c];
          if ('method' === s.kind && (d = t.find(o)))
            if (te(s.descriptor) || te(d.descriptor)) {
              if (ee(s) || ee(d))
                throw new ReferenceError(
                  'Duplicated methods (' + s.key + ") can't be decorated."
                );
  ...
  function (t, c) {
    ...
    return {
      F: d,
      d: [
        { kind: 'field', decorators: [s()], key: '_hasMedia', value: () => !1 },
        {
          kind: 'field',
          decorators: [s()],
          key: '_hasStatistic',
        ...
        },
        {
          ...
          value: function ({ target: e }) {
            ...
            if (
              ((this[le[t] || '_hasStatistic'] = o),
              'media' == e.getAttribute('name'))
            ) {
              const t = e
                .assignedNodes()
                .some((e) => 'svg' == e.tagName.toLowerCase());
              this._hasPictogram = t;
            }
          },
        },
        {
          kind: 'method',
          key: '_renderStatistic',
          value: function () {
            const { _hasStatistic: e, _handleSlotChange: t } = this;
            return o(
              W ||
                (W = J`
      <div
    ...
    `),
        ...
        },
        {
          ...
          key: '_renderMedia',
          value: function () {
            const { _hasMedia: e, _handleSlotChange: t } = this;
            return o(
              Z ||
                (Z = J`
      <div
        ?hidden="${0}"
        class="${0}--cta-block-item__media"
        part="media">
    ...
    `),
              ...
              this._renderMedia(),
              se(d, '_renderBody', this, 3)([]),
              se(d, '_renderFooter', this, 3)([])
            );
          },
        },
        {
  ...
  console.warn(
    'The cta-block-item component has been deprecated in favor of the content-section/block and content-item components. See content-section/block and content-items documentation for more information.'
  );
